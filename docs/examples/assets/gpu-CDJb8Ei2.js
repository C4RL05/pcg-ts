import{$i as e,Ai as t,Ci as n,Ei as r,Hr as i,Oi as a,Si as o,Ti as s,Xi as c,Yi as l,Zi as u,_i as d,aa as f,ai as p,bi as m,ca as h,di as g,ea as _,ia as v,ji as y,ki as b,la as x,na as S,oa as C,ra as w,ta as T,xi as E,yi as D}from"./mobile-DHy7-48l.js";var O=class extends Error{constructor(e){super(e),this.name=`GpuCompileError`}};function k(e,t){let n=Math.fround(e);if(!Number.isFinite(n))throw new O(`${t}: value ${e} is not representable as a finite f32 (WGSL kernels compute in f32; keep magnitudes within ~3.4e38)`);return Object.is(n,-0)?`-0f`:`${String(n)}f`}function A(e){return`${e>>>0}u`}function j(e){return`0x${(e>>>0).toString(16).padStart(8,`0`)}u`}var M=j,ee=k(34028234663852886e22,`internal f32 max`);function te(e,t){let n=M(e);for(let e of t)n=`pcg_hash_mix(${n}, ${e})`;return`pcg_hash_finalize(${n})`}function ne(){let e=[];for(let t=0;t<12;t++){let n=e=>k(b[t*3+e],`internal GRAD3`);e.push(`  vec3<f32>(${n(0)}, ${n(1)}, ${n(2)}),`)}return`var<private> PCG_GRAD3: array<vec3<f32>, 12> = array<vec3<f32>, 12>(
${e.join(`
`)}
  ...
  return ${N(`internal PERLIN_SCALE`)(r)} * pcg_mix(
  ...
  let t = ${N(`internal simplex R2`)(o)} - x * x - y * y - z * z;
  if (t <= 0f) {
    return 0f;
  }
  ...
  let s = (p.x + p.y + p.z) * ${N(`internal simplex F3`)(m)};
...
${h.join(`
`)}`,...ie(a.libRoots),...a.helperBlocks(),`@compute @workgroup_size(${ae})
...
`))}var We={"+x":`f, u, -r`,"-x":`-f, u, r`,"+y":`-r, f, u`,"-y":`r, -f, u`,"+z":`r, u, f`,"-z":`-r, u, -f`};function Ge(e,t,n){let r=new J,i=e.kind===`column`?r.add(`direction`,`read`,e.type,`direction column ${Z(e)}`):``,a=r.add(`rot`,`read_write`,`f32`,`attribute rot: f32 tupleSize 4`),o=k(1e-12,`internal ORIENT_PARALLEL_EPS`),s=`  let d = vec3<f32>(${[0,1,2].map(t=>q(i,e,t)).join(`, `)});
  ...
  ${f}[co + 1u] = ${d}[cs + 1u];
  ${f}[co + 2u] = ${d}[cs + 2u];
  ${f}[co + 3u] = 0f;`:``}`;return X(`spawnInstances|rot=${+!!e}|scl=${+!!t}${n?`|perm`:``}${i?`|color=${r}`:``}`,0,a.items,[],g,n)}var qe=`webgpu`,Je=class{backend=qe;byteLength;detached;label;constructor(e,t,n){this.detached=e,this.byteLength=t,this.label=n}get disposed(){return this.detached.destroyed}get resource(){if(this.detached.destroyed)throw Error(`device transforms handle (${this.label}) was disposed; its GPU buffer is destroyed and cannot be bound. Dispose a handle only after the last frame that reads it, and re-cook to obtain a fresh one (device-resident outputs are never memoized, so every cook produces a new handle)`);return this.detached.buffer}dispose(){this.detached.destroy()}};function Ye(e,t,n){return new Je(e,t,n)}var Xe=65535;function Ze(e,t){let n=Xe*e;return Math.max(e,Math.floor(Math.min(t??n,n)/e)*e)}var Qe=16,$e=`pcg-resident-run/5`;function et(e){return e.format===$e?e:null}var tt={reason:`run-plan-failed`},nt=[`+x`,`-x`,`+y`,`-y`,`+z`,`-z`];function rt(e){if(typeof e!=`object`||!e||Array.isArray(e))return!1;let t=e;if(t.fn===`randomField`)return!0;let n=t.args;if(Array.isArray(n)){for(let e of n)if(rt(e))return!0}let r=t.opts;return!!(typeof r==`object`&&r&&rt(r.position))}function it(e){return Array.isArray(e)&&e.length===3&&e.every(e=>typeof e==`number`&&Number.isFinite(e))}var $=class extends Error{},at=[];function ot(t,n,r,i){let a=n.count,o=new Map(Object.entries(n.attributes)),s=[],l=new Map,u=[],d=new Map,f=[],p=[],m=null,h=()=>Object.fromEntries(o),g=e=>{let t=l.get(e);if(t!==void 0)return t;let n=o.get(e);if(n===void 0||n.type===`string`)throw new $(e);let r=s.length;return s.push({bytes:a*n.tupleSize*4,init:`attr`,name:e}),l.set(e,r),r},_=(e,t,n)=>{let r=s.length;return s.push({bytes:a*t*4,init:n,name:e}),l.set(e,r),r},v=(e,t,n)=>{let r=o.get(e);if(r===void 0||r.type!==t||r.tupleSize!==n)throw new $(e)},y=(e,t,n)=>{let r=t.length/4;if(r>=4)throw Error(`resident run: "${n}" needs more than 4 uniform constant slots for its constant params; raise MAX_APPLY_CONST_SLOTS in applyKernels.ts (each slot costs 16 bytes of the per-chunk uniform and nothing else)`);for(let n=0;n<4;n++)t.push(n<e.length?e[n]:0);return{kind:`const`,tupleSize:e.length,slot:r}},b=(t,n,r,o,s,l)=>{let f;if(e(t)){let e=c(t,i);if(e===void 0)throw new $(`no spec`);if(d.has(`P`)&&rt(e))throw new $(`identity after P write`);f=e}else if(typeof t==`number`||Array.isArray(t)&&t.every(e=>typeof e==`number`)){let e=typeof t==`number`?[t]:t;if(e.length<1||e.length>4||o!==null&&!o.includes(e.length))throw new $(`tuple`);for(let t of e)if(!Number.isFinite(Math.fround(t)))throw new $(`f32 range`);return{param:y(e,s,l),ref:null}}else throw new $(`bad param value`);let p;try{p=ke(f,{attributes:h()})}catch{throw new $(`compile`)}if(p.inputs.length+1>8)throw new $(`buffers`);if(o!==null&&!o.includes(p.outTupleSize))throw new $(`tuple`);let m=u.length;return u.push(a*p.outTupleSize*4),r.push({key:p.key,wgsl:p.wgsl,entryPoint:p.entryPoint,workgroupSize:p.workgroupSize,seed:n,uniformsBinding:p.bindings.uniforms,uniformBytes:12,consts:at,perBatch:!1,bindings:[...p.inputs.map(e=>({binding:e.binding,ref:{kind:`slot`,index:g(e.name)}})),{binding:p.bindings.output,ref:{kind:`col`,index:m}}]}),{param:{kind:`column`,type:p.outType,tupleSize:p.outTupleSize},ref:{kind:`col`,index:m}}},x=(e,t,n,r,i=!1)=>{if(e.constSlots*4!==r.length)throw Error(`resident run: apply kernel "${e.key}" declares ${e.constSlots} constant slots but the planner allocated ${r.length/4}`);return{key:e.key,wgsl:e.wgsl,entryPoint:e.entryPoint,workgroupSize:e.workgroupSize,seed:t,uniformsBinding:0,uniformBytes:e.uniformBytes,consts:r,perBatch:i,bindings:e.bindings.map(e=>{let t=n[e.role];if(t===void 0)throw new $(`unmapped role ${e.role}`);return{binding:e.binding,ref:t}})}};try{for(let e of t){let n=e===t[t.length-1],r=[],i=[],s=e.params;switch(e.kind){case`setAttribute`:{let t=s.name,n=s.type,a=s.tupleSize;if(typeof t!=`string`)throw new $(`name`);if(n!==`f32`&&n!==`i32`&&n!==`u32`&&n!==`bool`)throw new $(`type`);if(typeof a!=`number`||!Number.isInteger(a)||a<1||a>4)throw new $(`tupleSize`);let c=typeof s.seed==`number`?s.seed:NaN,l=c===0?e.seed:C(e.seed,c),{param:u,ref:p}=b(s.value,l,r,a===1?[1]:[1,a],i,e.kind),m=_(t,a,`none`);o.set(t,{type:n,tupleSize:a}),d.set(t,m),f.push({op:`replace`,name:t,type:n,tupleSize:a});let h={target:{kind:`slot`,index:m}};p!==null&&(h.value=p),r.push(x(Ve(u,n,a),0,h,i));break}case`transformPoints`:{v(`P`,`f32`,3);let t=b(s.translate,e.seed,r,[1,3],i,e.kind),n=b(s.rotateEuler,e.seed,r,[1,3],i,e.kind),a=b(s.scale,e.seed,r,[1,3],i,e.kind),c=o.get(`rot`),l=c!==void 0&&c.type===`f32`&&c.tupleSize===4,u=o.get(`scale`),f=u!==void 0&&u.type===`f32`&&u.tupleSize===3,p=g(`P`);d.set(`P`,p);let m={P:{kind:`slot`,index:p}};if(t.ref!==null&&(m.translate=t.ref),n.ref!==null&&(m.rotateEuler=n.ref),a.ref!==null&&(m.scale=a.ref),l){let e=g(`rot`);d.set(`rot`,e),m.rot={kind:`slot`,index:e}}if(f){let e=g(`scale`);d.set(`scale`,e),m.scaleAttr={kind:`slot`,index:e}}r.push(x(He(t.param,n.param,a.param,l,f),0,m,i));break}case`jitterPoints`:{if(v(`P`,`f32`,3),d.has(`P`))throw new $(`identity after P write`);let t=typeof s.seed==`number`?s.seed:NaN,n=C(e.seed,t),a=b(s.amount,n,r,[1,3],i,e.kind),c=o.get(`seed`),l=c!==void 0;if(l&&(c.type!==`u32`||c.tupleSize!==1))throw new $(`seed attribute shape`);let u=g(`P`);d.set(`P`,u);let f={P:{kind:`slot`,index:u}};a.ref!==null&&(f.amount=a.ref),l&&(f.seed={kind:`slot`,index:g(`seed`)}),r.push(x(Ue(a.param,l),n,f,i));break}case`orientAlongVector`:{let t=s.axis;if(!nt.includes(t))throw new $(`axis`);if(!it(s.up))throw new $(`up`);let n=b(s.direction,e.seed,r,[1,3],i,e.kind),a=s.up,c=a[0]*a[0]+a[1]*a[1]+a[2]*a[2],l=c>0?1/Math.sqrt(c):0,u=[a[0]*l,a[1]*l,a[2]*l];for(let e of u)if(!Number.isFinite(Math.fround(e)))throw new $(`up range`);let p=y(u,i,e.kind),m=o.get(`rot`),h=m!==void 0&&m.type===`f32`&&m.tupleSize===4?g(`rot`):_(`rot`,4,`quat-default`);o.set(`rot`,{type:`f32`,tupleSize:4}),d.set(`rot`,h),f.push({op:`ensure-rot`});let v={rot:{kind:`slot`,index:h}};n.ref!==null&&(v.direction=n.ref),r.push(x(Ge(n.param,t,p),0,v,i));break}case`spawnInstances`:{if(!n)throw new $(`spawnInstances must be the run's last member`);let e=s.assetId;if(typeof e!=`string`||e===``)throw new $(`assetId`);if(v(`P`,`f32`,3),a>1048576)throw new $(`${a} instances over MAX_INSTANCES`);let t=s.assetAttr;if(t!==void 0&&typeof t!=`string`)throw new $(`assetAttr`);let c=t===void 0?``:t;if(c!==``){let e=o.get(c);if(e===void 0)throw new $(`assetAttr "${c}" not on the point domain`);if(e.type!==`string`)throw new $(`assetAttr "${c}" is ${e.type}, not string`)}let l=s.colorAttr;if(l!==void 0&&typeof l!=`string`)throw new $(`colorAttr`);let u=l===void 0?``:l,d=0;if(u!==``){let e=o.get(u);if(e===void 0)throw new $(`colorAttr "${u}" not on the point domain`);if(e.type!==`f32`||e.tupleSize<3)throw new $(`colorAttr "${u}" is ${e.type}x${e.tupleSize}`);d=e.tupleSize}let f=o.get(`rot`),p=f!==void 0&&f.type===`f32`&&f.tupleSize===4,h=o.get(`scale`),_=h!==void 0&&h.type===`f32`&&h.tupleSize===3,y={P:{kind:`slot`,index:g(`P`)},transforms:{kind:`out`}};p&&(y.rot={kind:`slot`,index:g(`rot`)}),_&&(y.scaleAttr={kind:`slot`,index:g(`scale`)});let b=c!==``;b&&(y.perm={kind:`perm`}),d>0&&(y.color={kind:`slot`,index:g(u)},y.colors={kind:`colorOut`}),r.push(x(Ke(p,_,b,d),0,y,i,b)),m={assetId:e,assetAttr:c,colorAttr:u,colorTupleSize:d,count:a,bytes:a*64,colorBytes:d>0?a*Qe:0,permBytes:b?a*4:0};break}default:throw new $(`unknown kind ${e.kind}`)}p.push({id:e.id,type:e.type,steps:r})}}catch(e){if(e instanceof $)return tt;throw e}let S=[...d].map(([e,t])=>({name:e,slot:t})),w=n.needsGeometry||m===null,T=s.reduce((e,t)=>e+t.bytes,0),E=u.reduce((e,t)=>e+t,0),D=w?S.reduce((e,t)=>e+s[t.slot].bytes,0):0,O=T+E+D+(m?.bytes??0)+(m?.colorBytes??0)+(m?.permBytes??0);return O>r?{reason:`run-too-large`}:{plan:{format:$e,count:a,members:p,slots:s,cols:u,written:S,layoutOps:f,materialize:w,instances:m,totalBytes:O}}}var st={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function ct(){return new Promise(e=>setTimeout(e,0))}async function lt(e,t,n,r){let{device:a,pool:o}=e,{geo:s,signal:c,budgetMs:l}=n,u=t.count;if(s.attrs.point.count!==u)throw Error(`resident run: plan was built for ${u} points but the input geometry has ${s.attrs.point.count}; plans are single-cook artifacts — re-plan for new inputs`);let f=()=>{if(c?.aborted)throw new d},p=[],m=(e,t)=>{let n=o.acquire(e,t);return p.push(n),n},h=new Set,_=[];try{let n=s.attrs.point,c=t.slots.map(e=>{let t=m(e.bytes,K.STORAGE|K.COPY_DST|K.COPY_SRC);if(e.init===`attr`){let r=n.require(e.name),i=e.bytes/4;if(r.data instanceof Uint8Array){let e=new Uint32Array(i);for(let t=0;t<i;t++)e[t]=r.data[t];a.queue.writeBuffer(t,0,e)}else a.queue.writeBuffer(t,0,r.data.subarray(0,i))}else if(e.init===`quat-default`){let n=new Float32Array(e.bytes/4);for(let e=3;e<n.length;e+=4)n[e]=1;a.queue.writeBuffer(t,0,n)}return t}),d=t.cols.map(e=>m(e,K.STORAGE|K.COPY_DST|K.COPY_SRC)),p=t.instances===null?void 0:i(s,{defaultAssetId:t.instances.assetId,...t.instances.assetAttr===``?{}:{assetAttr:t.instances.assetAttr}}),v=t.instances!==null&&t.instances.permBytes>0?m(t.instances.permBytes,K.STORAGE|K.COPY_DST):void 0;v!==void 0&&p!==void 0&&a.queue.writeBuffer(v,0,p.perm);let y=K.STORAGE|K.COPY_DST|K.COPY_SRC|K.VERTEX,b=p===void 0?[]:Array.from(p.counts,e=>m(e*64,y)),x=p===void 0||t.instances===null||t.instances.colorBytes===0?[]:Array.from(p.counts,e=>m(e*Qe,y)),S=(e,t)=>{if(e.kind===`slot`)return c[e.index];if(e.kind===`col`)return d[e.index];if(e.kind===`colorOut`){let e=x[t];if(e===void 0)throw Error(`resident run: a kernel binds a retained instance-colour buffer but the plan declares no colour output (plan and kernels disagree)`);return e}if(e.kind===`perm`){if(v===void 0)throw Error(`resident run: a kernel binds the grouping permutation but the plan declares no per-point asset attribute (plan and kernels disagree)`);return v}let n=b[t];if(n===void 0)throw Error(`resident run: a kernel binds a retained instance-transform buffer but the plan declares no instances output (plan and kernels disagree)`);return n},C=a.createCommandEncoder(),w=C.beginComputePass(),T=performance.now();for(let n of t.members){f();for(let t of n.steps){let n=e.getPipeline(t.key,t.wgsl,t.entryPoint,r);w.setPipeline(n);let i=Ze(t.workgroupSize,e.maxElementsPerDispatch),o=t.perBatch&&p!==void 0?Array.from(p.counts,(e,t)=>({batch:t,elements:e,base:p.offsets[t]})):[{batch:0,elements:u,base:0}];for(let e of o){r!==void 0&&r.dispatches++;let o=new ArrayBuffer(t.uniformBytes),s=new Uint8Array(o),c=new Uint32Array(o,0,t.uniformBytes>=16?4:3);c[0]=e.elements,c[1]=t.seed>>>0,t.perBatch&&(c[3]=e.base),t.consts.length>0&&new Float32Array(o,16,t.consts.length).set(t.consts);let l=Math.ceil(e.elements/i);for(let r=0;r<l;r++){let o=m(t.uniformBytes,K.UNIFORM|K.COPY_DST);c[2]=r*i,a.queue.writeBuffer(o,0,s);let l=a.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:t.uniformsBinding,resource:{buffer:o}},...t.bindings.map(t=>({binding:t.binding,resource:{buffer:S(t.ref,e.batch)}}))]}),u=Math.min(i,e.elements-r*i);w.setBindGroup(0,l),w.dispatchWorkgroups(Math.ceil(u/t.workgroupSize))}}}l!==void 0&&performance.now()-T>l&&(await ct(),f(),T=performance.now())}w.end();let E=[],D,O=t.materialize?t.written.reduce((e,n)=>e+t.slots[n.slot].bytes,0):0;if(O>0){D=m(O,K.COPY_DST|K.MAP_READ);let e=0;for(let n of t.written){let r=t.slots[n.slot].bytes;C.copyBufferToBuffer(c[n.slot],0,D,e,r),E.push(e),e+=r}}a.queue.submit([C.finish()]);let k;if(t.materialize){let e;if(D!==void 0){await D.mapAsync(Ae.READ,0,O);try{e=D.getMappedRange(0,O).slice(0)}finally{D.unmap()}}f(),k=g(s);let n=k.attrs.point;for(let e of t.layoutOps)if(e.op===`replace`)n.replace(e.name,e.type,e.tupleSize);else{let e=n.get(`rot`);(!e||e.type!==`f32`||e.tupleSize!==4)&&(e&&n.remove(`rot`),n.add(`rot`,`f32`,4,[0,0,0,1]))}t.written.forEach((t,r)=>{let i=n.require(t.name),a=u*i.tupleSize;if(e===void 0)throw Error(`resident run: readback missing for a written attribute`);if(i.data instanceof Uint8Array){let t=new Uint32Array(e,E[r],a);for(let e=0;e<a;e++)i.data[e]=t[e]}else{let n=st[i.type];if(n===void 0)throw Error(`resident run: cannot materialize attribute "${t.name}" of type ${i.type}`);i.data.set(new n(e,E[r],a))}})}else f();let A;if(t.instances!==null){let e=t.instances.colorBytes>0;if(p===void 0||b.length!==p.order.length||x.length!==(e?p.order.length:0))throw Error(`resident run: the plan declares an instances output but the acquired transform buffers do not match the grouping (library bug: plan.instances, the grouping, and the acquired buffers must agree)`);let n=(e,t,n)=>{let r=o.detach(e);h.add(e);try{return Ye(r,t,n)}catch(e){throw r.destroy(),e}},r=[];for(let t=0;t<p.order.length;t++){let i=p.order[t],a=p.counts[t],o=n(b[t],a*64,`${a} instances of "${i}"`);if(_.push(o),!e){r.push({residency:`device`,assetId:i,count:a,transforms:o});continue}let s=n(x[t],a*Qe,`${a} instance colours of "${i}"`);_.push(s),r.push({residency:`device`,assetId:i,count:a,transforms:o,colors:s})}A=r}r!==void 0&&(r.residentRuns++,r.fusedNodes+=t.members.length,r.readbacksSaved+=t.members.length-+!!t.materialize);let j={};return k!==void 0&&(j.geo=k),A!==void 0&&(j.deviceBatches=A),j}catch(e){for(let e of _)e.dispose();throw e instanceof d?e:Error(`GpuFieldEvaluator: resident run failed (${t.members.length} fused nodes [${t.members.map(e=>`"${e.id}"`).join(`, `)}], ${u} points): ${e instanceof Error?e.message:String(e)}`,{cause:e})}finally{for(let e of p)h.has(e)||o.release(e)}}var ut=`gpu2`,dt=268435456,ft=[`spawnInstances`],pt={f32:Float32Array,i32:Int32Array,u32:Uint32Array},mt={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function ht(e){let t=e=>e!==void 0&&e!==``?e:`?`;return[ut,t(e?.vendor),t(e?.architecture),t(e?.device),t(e?.description)].join(`|`)}function gt(e,t){return e!==void 0&&(e.fallbacks[t]=(e.fallbacks[t]??0)+1),null}var _t=class{cacheSalt;residentTerminals;acceptDerivedSpecs;device;kernels=new Map;pipelines=new Map;pool;maxElementsPerDispatch;maxResidentBytes;constructor(e,t={}){if(t.maxElementsPerDispatch!==void 0&&!Number.isFinite(t.maxElementsPerDispatch))throw Error(`GpuFieldEvaluator: maxElementsPerDispatch must be a finite number, got ${t.maxElementsPerDispatch}; leave it unset to use the device maximum`);this.device=e,this.cacheSalt=ht(t.adapterInfo??e.adapterInfo),this.pool=new Ne(e,t.maxPooledBytes??dt),this.maxElementsPerDispatch=t.maxElementsPerDispatch,this.maxResidentBytes=t.maxResidentBytes??536870912,this.residentTerminals=t.deviceInstances===!0?ft:[],this.acceptDerivedSpecs=l(t)}get pipelineCacheSize(){return this.pipelines.size}get poolStats(){return this.pool.stats}dispose(){this.pool.dispose()}chunkElements(e){let t=Xe*e.workgroupSize,n=Math.min(this.maxElementsPerDispatch??t,t);return Math.max(e.workgroupSize,Math.floor(n/e.workgroupSize)*e.workgroupSize)}resolveField(e,t,n){let r=c(e,this.acceptDerivedSpecs);if(r===void 0)return gt(n,u(e));let i=t.geo.attrs[t.domain],a={},o=[];for(let e of i.names().sort()){let t=i.get(e);t!==void 0&&(a[e]={type:t.type,tupleSize:t.tupleSize},o.push(`${JSON.stringify(e)}:${t.type}x${t.tupleSize}`))}let s=`${e.key.length}#${e.key}|${o.join(`,`)}`,l=this.kernels.get(s);if(l===void 0){try{l=ke(r,{attributes:a})}catch(e){l=e instanceof Error?e:Error(String(e))}this.kernels.set(s,l)}if(l instanceof Error)return gt(n,`compile-error`);if(l.inputs.length+1>8)return gt(n,`too-many-buffers`);let d=i.count;if(d===0)return Promise.resolve({data:new mt[l.outType](0),tupleSize:l.outTupleSize});let f=this.getPipeline(l.key,l.wgsl,l.entryPoint,n);return n!==void 0&&n.dispatches++,this.dispatch(e,t,l,f,d)}getPipeline(e,t,n,r){let i=this.pipelines.get(e);if(i!==void 0)return r!==void 0&&r.pipelineCacheHits++,i;let a=this.device.createShaderModule({code:t}),o=this.device.createComputePipeline({layout:`auto`,compute:{module:a,entryPoint:n}});return this.pipelines.set(e,o),r!==void 0&&r.pipelinesCompiled++,o}planRun(e,t,n){let r=ot(e,t,this.maxResidentBytes,this.acceptDerivedSpecs);return`plan`in r?r.plan:(n!==void 0&&(n.fallbacks[r.reason]=(n.fallbacks[r.reason]??0)+1),null)}executeRun(e,t,n){let r=et(e);return r===null?Promise.reject(Error(`GpuFieldEvaluator.executeRun: plan was not produced by this library's planRun; pass the object returned by planRun on the same resolver`)):lt({device:this.device,pool:this.pool,maxElementsPerDispatch:this.maxElementsPerDispatch,getPipeline:(e,t,n,r)=>this.getPipeline(e,t,n,r)},r,t,n)}async dispatch(e,t,n,r,i){let a=this.device,o=[],s=(e,t)=>{let n=this.pool.acquire(e,t);return o.push(n),n};try{let e=this.chunkElements(n),o=Math.ceil(i/e),c=[],l=t.geo.attrs[t.domain];for(let e of n.inputs){let t=l.require(e.name),n=i*e.tupleSize,r;if(t.data instanceof Uint8Array){let e=new Uint32Array(n);for(let r=0;r<n;r++)e[r]=t.data[r];r=e}else r=t.data.subarray(0,n);let o=s(n*4,K.STORAGE|K.COPY_DST);a.queue.writeBuffer(o,0,r),c.push({binding:e.binding,resource:{buffer:o}})}let u=i*n.outTupleSize*4,d=s(u,K.STORAGE|K.COPY_SRC);c.push({binding:n.bindings.output,resource:{buffer:d}});let f=s(u,K.COPY_DST|K.MAP_READ),p=[];for(let l=0;l<o;l++){let o=s(12,K.UNIFORM|K.COPY_DST);a.queue.writeBuffer(o,0,new Uint32Array([i,t.seed>>>0,l*e])),p.push(a.createBindGroup({layout:r.getBindGroupLayout(0),entries:[{binding:n.bindings.uniforms,resource:{buffer:o}},...c]}))}let m=a.createCommandEncoder(),h=m.beginComputePass();h.setPipeline(r);for(let t=0;t<o;t++){let r=Math.min(e,i-t*e);h.setBindGroup(0,p[t]),h.dispatchWorkgroups(Math.ceil(r/n.workgroupSize))}h.end(),m.copyBufferToBuffer(d,0,f,0,u),a.queue.submit([m.finish()]),await f.mapAsync(Ae.READ,0,u);let g;try{g=f.getMappedRange(0,u).slice(0)}finally{f.unmap()}return{data:new pt[n.outType](g),tupleSize:n.outTupleSize}}catch(n){throw Error(`GpuFieldEvaluator: dispatch failed for field ${e.key} (${i} elements on the ${t.domain} domain): ${n instanceof Error?n.message:String(n)}`,{cause:n})}finally{for(let e of o)this.pool.release(e)}}};export{_t as t};