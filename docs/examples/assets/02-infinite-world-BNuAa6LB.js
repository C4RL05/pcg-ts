import{Ai as e,Ca as t,Ct as n,Fi as r,G as i,Hr as a,Ht as ee,Ii as te,K as o,Mt as s,N as c,Pi as ne,Vr as l,Wi as u,Y as d,_i as re,da as ie,ei as ae,ga as oe,ka as f,li as se,oa as ce,qi as le,r as p,ra as m,sa as ue,ta as de,vi as fe}from"./mobile-Cji3YAPF.js";import{t as h}from"./scene-DZrGYZyM.js";import{n as g}from"./debug-D6QUlNrf.js";import{t as pe}from"./worldBinding-CzrSUm3o.js";import{t as me}from"./overlay-CK61A9p7.js";var he=.35,ge=777;function _e(){let e=new oe,n=e.add(re,{count:170,boundsMin:[-800,0,-800],boundsMax:[800,0,800]}),r=e.add(te,{name:`scale`,tupleSize:3,value:(()=>{let e=m(ie(`mega`),0,1,5,13);return ce(e,de(e,1.6),e)})()}),i=e.add(a,{assetId:`megarock`});return e.connect(n,`out`,r,`in`),e.connect(r,`out`,i,`in`),e.output(i,`instances`,`instances`),{name:`landmarks`,cellSize:`unbounded`,generationRadius:1/0,graph:e,bind(e,i){e.setParam(n,`seed`,i.seed),e.setParam(r,`seed`,t(i.seed,9))}}}function ve(n){let{cellSize:i,generationRadius:ee,anchored:o}=n,s=n.halo?4:0,c=new oe,l=o?c.add(fe,{density:he,cellSize:7,latticeMode:`xz`,height:0}):c.add(re,{count:Math.round(he*(i+2*s)**2)}),u=c.add(te,{name:`density`,tupleSize:1,value:m(ae(se,{seed:ge,frequency:.02,octaves:3}),-1,1,0,1)}),d=c.add(r,{mode:`probabilistic`}),f=c.add(e,{radius:4,countAttr:`nbrCount`}),p=c.add(ne,{mode:`inside`}),h=c.add(te,{name:`scale`,tupleSize:3,value:(()=>{let e=m(le(ue(`nbrCount`),2,16),2,16,.4,1.35),t=de(e,m(ie(`rock`),0,1,.85,1.15));return ce(t,t,t)})()}),g=c.add(a,{assetId:`rock`});return c.connect(l,`out`,u,`in`),c.connect(u,`out`,d,`in`),c.connect(d,`out`,f,`in`),c.connect(f,`out`,p,`in`),c.connect(p,`out`,h,`in`),c.connect(h,`out`,g,`in`),c.output(g,`instances`,`instances`),{name:`rocks`,cellSize:i,generationRadius:ee,graph:c,bind(e,n){e.setParam(l,`boundsMin`,[n.min[0]-s,0,n.min[1]-s]),e.setParam(l,`boundsMax`,[n.max[0]+s,0,n.max[1]+s]);let r=o?n.worldSeed:n.seed;e.setParam(l,`seed`,r),e.setParam(d,`seed`,t(r,1)),e.setParam(h,`seed`,t(r,2)),e.setParam(p,`boundsMin`,[n.min[0],-1,n.min[1]]),e.setParam(p,`boundsMax`,[n.max[0],1,n.max[1]])}}}function ye(e){return e instanceof Error?e.message:String(e)}function be(e){let t=(e?.description??``)===``?e?.device:e?.description;return[e?.vendor,e?.architecture,t].filter(e=>typeof e==`string`&&e!==``).join(` · `)||`adapter (no info exposed)`}async function xe(e){let t=navigator.gpu;if(t===void 0)return{error:`navigator.gpu is missing — this browser has no WebGPU.`};try{let n=await t.requestAdapter();if(n===null)return{error:`navigator.gpu.requestAdapter() returned null — no compatible GPU adapter.`};let r=n.info,i=await n.requestDevice(),a=i.lost;return a!==void 0&&a.then(t=>{e(`${t?.reason??`unknown`}: ${t?.message??`no detail`}`)}),{device:i,info:r,label:be(r)}}catch(e){return{error:`requestDevice() failed: ${ye(e)}`}}}function Se(e){let t=e.info===void 0?{}:{adapterInfo:e.info};return{derived:new g(e.device,{...t,acceptDerivedSpecs:!0}),strict:new g(e.device,t)}}var Ce=class{cacheSalt;residentTerminals;acceptDerivedSpecs;base;seen=new Set;constructor(e){this.base=e,this.cacheSalt=e.cacheSalt,this.residentTerminals=e.residentTerminals,this.acceptDerivedSpecs=e.acceptDerivedSpecs}resolveField(e,t,n){return n!==void 0&&this.seen.add(n),this.base.resolveField(e,t,n)}planRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.planRun(e,t,n)}executeRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.executeRun(e,t,n)}drain(){if(this.seen.size===0)return;let e=u();for(let t of this.seen){e.dispatches+=t.dispatches,e.pipelinesCompiled+=t.pipelinesCompiled,e.pipelineCacheHits+=t.pipelineCacheHits,e.residentRuns+=t.residentRuns,e.fusedNodes+=t.fusedNodes,e.readbacksSaved+=t.readbacksSaved;for(let[n,r]of Object.entries(t.fallbacks))e.fallbacks[n]=(e.fallbacks[n]??0)+r}return this.seen.clear(),e}};function we(e){let t=Object.entries(e).sort(([e],[t])=>e.localeCompare(t));return t.length===0?`none`:t.map(([e,t])=>`${e} ×${t}`).join(`, `)}var Te=1,_=18,v=140,y=`gpu`,b=!0,x=20,S=!0,C=!0,w=!0,Ee=7,De=12,Oe=8,ke=5e3;function Ae(e){return e instanceof Error?e.message:String(e)}var{scene:T,camera:E,start:je}=h({cameraPosition:[0,26,0],orbit:!1,fog:{near:140,far:640},far:1600}),D=new n(new ee(4e3,4e3),new s({color:1449515,roughness:1}));D.rotation.x=-Math.PI/2,D.position.y=-.03,T.add(D);var Me=40,O;function Ne(){O&&(T.remove(O),O.geometry.dispose(),O.material.dispose());let e=new i(x*Me,Me,4158656,2903936),t=e.material;t.transparent=!0,t.opacity=.45,t.depthWrite=!1,e.position.y=.02,e.visible=w,T.add(e),O=e}function Pe(){!O||!O.visible||(O.position.x=Math.round(E.position.x/x)*x,O.position.z=Math.round(E.position.z/x)*x)}var Fe=new s({color:8028816,roughness:.95,flatShading:!0}),Ie=new s({color:6121077,roughness:1,flatShading:!0}),Le={megarock:{geometry:new c(1).translate(0,.62,0),material:Ie},rock:{geometry:new d(.55).translate(0,.33,0),material:Fe}},Re,ze,k=`requesting…`,A,j=!1,Be=``,M;function N(){return Re!==void 0&&!j}function Ve(){if(!(y===`cpu`||!N()))return b?Re:ze}function He(e,t){let n=e*1.25/t+1.5;return Math.max(256,Math.ceil(Math.PI*n*n))}function Ue(e){let t=0;for(let n of Object.keys(e))for(let r of e[n])if(r.kind===`instances`)for(let e of r.batches)t+=e.count;return t}var P,F=0,I,We=0,L=!1,Ge=0;function R(){P&&(P.disposed=!0,P.abort.abort(),P.binding.dispose(),T.remove(P.group));let e=new o;T.add(e);let t=new pe({group:e,assets:Le}),n=new Map,r=Ve(),i={world:void 0,group:e,binding:t,cellInstances:n,tap:r===void 0?void 0:new Ce(r),abort:new AbortController,disposed:!1};i.world=new l({seed:Te,levels:[_e(),ve({cellSize:x,generationRadius:v,anchored:S,halo:C})],maxCellsPerLevel:He(v,x),...i.tap===void 0?{}:{gpu:i.tap},onCellReady:(e,r,a)=>{i.disposed||(t.cellReady(e,r,a),n.set(`${e}|${r[0]},${r[1]}`,Ue(a)))},onCellEvicted:(e,r)=>{i.disposed||(t.cellEvicted(e,r),n.delete(`${e}|${r[0]},${r[1]}`))}}),P=i,F=0,M=void 0,I=void 0,dt(),Ke(i,De)}function Ke(e,t){let n=++Ge;$=!0,We=performance.now(),e.world.update([E.position.x,0,E.position.z],{budgetMs:t,maxCooksPerUpdate:Oe,signal:e.abort.signal,...e.tap===void 0?{}:{gpu:e.tap}}).then(t=>{if(e.disposed)return;F=t.pending,I=t.elapsedMs;let n=e.tap?.drain();n!==void 0&&(M=n),dt(),L&&(L=!1,Z(ut()))}).catch(t=>{t instanceof f||(console.error(t),e.disposed||Z(`update failed: ${Ae(t)}`))}).finally(()=>{n===Ge&&($=!1)})}var z=0,qe=0,B=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(t===`g`){J(y===`gpu`?`cpu`:`gpu`);return}B.add(t)}),window.addEventListener(`keyup`,e=>B.delete(e.key.toLowerCase())),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&(We=performance.now())});var V=me({title:`02 · infinite world`,info:`Unbounded landmark level + world-anchored rock cells streamed around a flying camera. Steer with A/D or arrow keys.`}),Je=document.createElement(`style`);Je.textContent=`
