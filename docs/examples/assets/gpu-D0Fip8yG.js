...
`)}
  ...
  let t = ${M(`internal simplex R2`)(x)} - x * x - y * y - z * z;
  if (t <= 0f) {
    return 0f;
  }
  ...
  let t = f32(i + j + k) * ${M(`internal simplex G3`)(S)};
  let x0 = p.x - (f32(i) - t);
  let y0 = p.y - (f32(j) - t);
  let z0 = p.z - (f32(k) - t);
  var i1: i32;
  ...
  let x1 = x0 - f32(i1) + ${M(`internal simplex G3`)(S)};
  let y1 = y0 - f32(j1) + ${M(`internal simplex G3`)(S)};
  let z1 = z0 - f32(k1) + ${M(`internal simplex G3`)(S)};
  let x2 = x0 - f32(i2) + ${M(`internal simplex 2*G3`)(2*S)};
  let y2 = y0 - f32(j2) + ${M(`internal simplex 2*G3`)(2*S)};
  let z2 = z0 - f32(k2) + ${M(`internal simplex 2*G3`)(2*S)};
  let x3 = x0 - 1f + ${M(`internal simplex 3*G3`)(3*S)};
  let y3 = y0 - 1f + ${M(`internal simplex 3*G3`)(3*S)};
  let z3 = z0 - 1f + ${M(`internal simplex 3*G3`)(3*S)};
