import{$ as e,Bt as t,Ft as n,G as r,Ht as i,Kt as a,Lt as o,Nt as s,Pt as c,Q as l,R as u,Rt as d,Ut as f,Vt as p,Wt as m,X as h,at as g,ct as _,et as v,it as y,lt as b,nt as x,qt as S,s as C,st as w,tt as T,ut as E,zt as D}from"./mobile-CAlugUcx.js";var O=class extends Error{constructor(e){super(e),this.name=`GpuCompileError`}};function k(e,t){let n=Math.fround(e);if(!Number.isFinite(n))throw new O(`${t}: value ${e} is not representable as a finite f32 (WGSL kernels compute in f32; keep magnitudes within ~3.4e38)`);return Object.is(n,-0)?`-0f`:`${String(n)}f`}function A(e){return`${e>>>0}u`}function j(e){return`0x${(e>>>0).toString(16).padStart(8,`0`)}u`}var M=j,ee=k(34028234663852886e22,`internal f32 max`);function te(e,t){let n=M(e);for(let e of t)n=`pcg_hash_mix(${n}, ${e})`;return`pcg_hash_finalize(${n})`}function ne(){let e=[];for(let t=0;t<12;t++){let n=e=>k(_[t*3+e],`internal GRAD3`);e.push(`  vec3<f32>(${n(0)}, ${n(1)}, ${n(2)}),`)}return`var<private> PCG_GRAD3: array<vec3<f32>, 12> = array<vec3<f32>, 12>(
${e.join(`
`)}
  ...
  return ${N(`internal PERLIN_SCALE`)(g)} * pcg_mix(
  ...
  let t = f32(i + j + k) * ${N(`internal simplex G3`)(v)};
  let x0 = p.x - (f32(i) - t);
  let y0 = p.y - (f32(j) - t);
  let z0 = p.z - (f32(k) - t);
  var i1: i32;
  ...
  let x1 = x0 - f32(i1) + ${N(`internal simplex G3`)(v)};
  let y1 = y0 - f32(j1) + ${N(`internal simplex G3`)(v)};
  let z1 = z0 - f32(k1) + ${N(`internal simplex G3`)(v)};
  let x2 = x0 - f32(i2) + ${N(`internal simplex 2*G3`)(2*v)};
  let y2 = y0 - f32(j2) + ${N(`internal simplex 2*G3`)(2*v)};
  let z2 = z0 - f32(k2) + ${N(`internal simplex 2*G3`)(2*v)};
  let x3 = x0 - 1f + ${N(`internal simplex 3*G3`)(3*v)};
  let y3 = y0 - 1f + ${N(`internal simplex 3*G3`)(3*v)};
  let z3 = z0 - 1f + ${N(`internal simplex 3*G3`)(3*v)};
...
`)}var _e={valueNoise:w,perlinNoise:y,simplexNoise:x,worleyNoise:l},W={valueNoise:`pcg_value_noise`,perlinNoise:`pcg_perlin_noise`,simplexNoise:`pcg_simplex_noise`};function G(e){return e.opts??{}}function ve(e,t,n,r){let i=G(t),a=i.position===void 0?n:`${n}.opts.position`,o=i.position===void 0?R(r,n,`P`,3,`${e} position reads `):V(i.position,a,r);if(o.size!==3)throw new O(`${a}: ${e}: position field must have tupleSize 3, got ${o.size}`);let s=k(i.frequency??1,`${n}.opts.frequency`),[c,l,u]=i.offset??[0,0,0],d=`vec3<f32>(${k(c,`${n}.opts.offset`)}, ${k(l,`${n}.opts.offset`)}, ${k(u,`${n}.opts.offset`)})`;return r.emit(`${o.ref} * ${s} + ${d}`,3)}function ye(e,t){return E(_e[e],(t??0)>>>0)}function be(e,t,n,r){let[i,a]=n,o=a-i;return e.emit(`(${t.ref} - ${k(i,r)}) / ${k(o,r)}`,1)}for(let e of[`valueNoise`,`perlinNoise`,`simplexNoise`])B.set(e,(t,n,r)=>{let i=G(t),a=ve(e,t,n,r);r.libRoots.add(W[e]);let o=r.emit(`${W[e]}(${j(ye(e,i.seed))}, ${a.ref})`,1);return i.normalized===!0?be(r,o,b[e],`${n}.opts.normalized`):o});B.set(`worleyNoise`,(e,t,n)=>{let r=G(e),i=r.output??`f1`,a=r.exact===!0,o=ve(`worleyNoise`,e,t,n);n.libRoots.add(`pcg_worley`);let s=i!==`f1`,c=n.emit(`pcg_worley(${j(ye(`worleyNoise`,r.seed))}, ${o.ref}, ${a}, ${s})`,2),l=i===`f1`?n.emit(`${c.ref}.x`,1):i===`f2`?n.emit(`${c.ref}.y`,1):n.emit(`${c.ref}.y - ${c.ref}.x`,1);return r.normalized===!0?be(n,l,b.worleyNoise[i],`${t}.opts.normalized`):l});function xe(e){return e===`worleyNoise`?b.worleyNoise.f1:b[e]}function Se(e,t,n){return e===`worleyNoise`?`pcg_worley(${t}, ${n}, false, false).x`:`${W[e]}(${t}, ${n})`}B.set(`fbm`,(e,t,n)=>{let r=e.base,i=G(e),a=i.octaves??4,o=i.lacunarity??2,s=i.gain??.5,c=i.seed??0,l=i.frequency??1,[u,d,f]=i.offset??[0,0,0],p=i.position===void 0?t:`${t}.opts.position`,h=i.position===void 0?R(n,t,`P`,3,`fbm position reads `):V(i.position,p,n);if(h.size!==3)throw new O(`${p}: fbm: position field must have tupleSize 3, got ${h.size}`);let g=xe(r),_=[],v=[],y=[],b=1,x=l,S=0,C=0;for(let e=0;e<a;e++)_.push(j(ye(r,m(c,e)))),v.push(k(x,`${t}.opts.frequency`)),y.push(k(b,`${t}.opts.gain`)),S+=b>=0?b*g[0]:b*g[1],C+=b>=0?b*g[1]:b*g[0],b*=s,x*=o;n.libRoots.add(r===`worleyNoise`?`pcg_worley`:W[r]);let w=`vec3<f32>(${k(u,`${t}.opts.offset`)}, ${k(d,`${t}.opts.offset`)}, ${k(f,`${t}.opts.offset`)})`,T=`fn @NAME@(p: vec3<f32>) -> f32 {
...
`))}var We={"+x":`f, u, -r`,"-x":`-f, u, r`,"+y":`-r, f, u`,"-y":`r, -f, u`,"+z":`r, u, f`,"-z":`-r, u, -f`};function Ge(e,t,n){let r=new J,i=e.kind===`column`?r.add(`direction`,`read`,e.type,`direction column ${Z(e)}`):``,a=r.add(`rot`,`read_write`,`f32`,`attribute rot: f32 tupleSize 4`),o=k(1e-12,`internal ORIENT_PARALLEL_EPS`),s=`  let d = vec3<f32>(${[0,1,2].map(t=>q(i,e,t)).join(`, `)});
  ...
  ${f}[co + 1u] = ${d}[cs + 1u];
  ${f}[co + 2u] = ${d}[cs + 2u];
  ${f}[co + 3u] = 0f;`:``}`;return X(`spawnInstances|rot=${+!!e}|scl=${+!!t}${n?`|perm`:``}${i?`|color=${r}`:``}`,0,a.items,[],g,n)}var qe=`webgpu`,Je=class{backend=qe;byteLength;detached;label;constructor(e,t,n){this.detached=e,this.byteLength=t,this.label=n}get disposed(){return this.detached.destroyed}get resource(){if(this.detached.destroyed)throw Error(`device transforms handle (${this.label}) was disposed; its GPU buffer is destroyed and cannot be bound. Dispose a handle only after the last frame that reads it, and re-cook to obtain a fresh one (device-resident outputs are never memoized, so every cook produces a new handle)`);return this.detached.buffer}dispose(){this.detached.destroy()}};function Ye(e,t,n){return new Je(e,t,n)}var Xe=65535;function Ze(e,t){let n=Xe*e;return Math.max(e,Math.floor(Math.min(t??n,n)/e)*e)}var Qe=16,$e=`pcg-resident-run/5`;function et(e){return e.format===$e?e:null}var tt={reason:`run-plan-failed`},nt=[`+x`,`-x`,`+y`,`-y`,`+z`,`-z`];function rt(e){if(typeof e!=`object`||!e||Array.isArray(e))return!1;let t=e;if(t.fn===`randomField`)return!0;let n=t.args;if(Array.isArray(n)){for(let e of n)if(rt(e))return!0}let r=t.opts;return!!(typeof r==`object`&&r&&rt(r.position))}function it(e){return Array.isArray(e)&&e.length===3&&e.every(e=>typeof e==`number`&&Number.isFinite(e))}var $=class extends Error{},at=[];function ot(e,t,n,r,i){let a=[...e].map(([e,t])=>({name:e,slot:t})),o=i||r===null,s=t.reduce((e,t)=>e+t.bytes,0),c=n.reduce((e,t)=>e+t,0),l=o?a.reduce((e,n)=>e+t[n.slot].bytes,0):0;return{writtenList:a,materialize:o,totalBytes:s+c+l+(r?.bytes??0)+(r?.colorBytes??0)+(r?.permBytes??0)}}function st(e,t,n,r){let i=t.count,a=new Map(Object.entries(t.attributes)),s=[],l=new Map,u=[],d=new Map,f=[],p=[],h=null,g=()=>Object.fromEntries(a),_=e=>{let t=l.get(e);if(t!==void 0)return t;let n=a.get(e);if(n===void 0||n.type===`string`)throw new $(e);let r=s.length;return s.push({bytes:i*n.tupleSize*4,init:`attr`,name:e}),l.set(e,r),r},v=(e,t,n)=>{let r=s.length;return s.push({bytes:i*t*4,init:n,name:e}),l.set(e,r),r},y=(e,t,n)=>{let r=a.get(e);if(r===void 0||r.type!==t||r.tupleSize!==n)throw new $(e)},b=(e,t,n)=>{let r=t.length/4;if(r>=4)throw Error(`resident run: "${n}" needs more than 4 uniform constant slots for its constant params; raise MAX_APPLY_CONST_SLOTS in applyKernels.ts (each slot costs 16 bytes of the per-chunk uniform and nothing else)`);for(let n=0;n<4;n++)t.push(n<e.length?e[n]:0);return{kind:`const`,tupleSize:e.length,slot:r}},x=(e,t,n,a,s,l)=>{let f;if(o(e)){let t=c(e,r);if(t===void 0)throw new $(`no spec`);if(d.has(`P`)&&rt(t))throw new $(`identity after P write`);f=t}else if(typeof e==`number`||Array.isArray(e)&&e.every(e=>typeof e==`number`)){let t=typeof e==`number`?[e]:e;if(t.length<1||t.length>4||a!==null&&!a.includes(t.length))throw new $(`tuple`);for(let e of t)if(!Number.isFinite(Math.fround(e)))throw new $(`f32 range`);return{param:b(t,s,l),ref:null}}else throw new $(`bad param value`);let p;try{p=ke(f,{attributes:g()})}catch{throw new $(`compile`)}if(p.inputs.length+1>8)throw new $(`buffers`);if(a!==null&&!a.includes(p.outTupleSize))throw new $(`tuple`);let m=u.length;return u.push(i*p.outTupleSize*4),n.push({key:p.key,wgsl:p.wgsl,entryPoint:p.entryPoint,workgroupSize:p.workgroupSize,seed:t,uniformsBinding:p.bindings.uniforms,uniformBytes:12,consts:at,perBatch:!1,bindings:[...p.inputs.map(e=>({binding:e.binding,ref:{kind:`slot`,index:_(e.name)}})),{binding:p.bindings.output,ref:{kind:`col`,index:m}}]}),{param:{kind:`column`,type:p.outType,tupleSize:p.outTupleSize},ref:{kind:`col`,index:m}}},S=(e,t,n,r,i=!1)=>{if(e.constSlots*4!==r.length)throw Error(`resident run: apply kernel "${e.key}" declares ${e.constSlots} constant slots but the planner allocated ${r.length/4}`);return{key:e.key,wgsl:e.wgsl,entryPoint:e.entryPoint,workgroupSize:e.workgroupSize,seed:t,uniformsBinding:0,uniformBytes:e.uniformBytes,consts:r,perBatch:i,bindings:e.bindings.map(e=>{let t=n[e.role];if(t===void 0)throw new $(`unmapped role ${e.role}`);return{binding:e.binding,ref:t}})}};try{for(let t of e){let n=t===e[e.length-1],r=[],o=[],s=t.params;switch(t.kind){case`setAttribute`:{let e=s.name,n=s.type,i=s.tupleSize;if(typeof e!=`string`)throw new $(`name`);if(n!==`f32`&&n!==`i32`&&n!==`u32`&&n!==`bool`)throw new $(`type`);if(typeof i!=`number`||!Number.isInteger(i)||i<1||i>4)throw new $(`tupleSize`);let c=typeof s.seed==`number`?s.seed:NaN,l=c===0?t.seed:m(t.seed,c),{param:u,ref:p}=x(s.value,l,r,i===1?[1]:[1,i],o,t.kind),h=v(e,i,`none`);a.set(e,{type:n,tupleSize:i}),d.set(e,h),f.push({op:`replace`,name:e,type:n,tupleSize:i});let g={target:{kind:`slot`,index:h}};p!==null&&(g.value=p),r.push(S(Ve(u,n,i),0,g,o));break}case`transformPoints`:{y(`P`,`f32`,3);let e=x(s.translate,t.seed,r,[1,3],o,t.kind),n=x(s.rotateEuler,t.seed,r,[1,3],o,t.kind),i=x(s.scale,t.seed,r,[1,3],o,t.kind),c=a.get(`rot`),l=c!==void 0&&c.type===`f32`&&c.tupleSize===4,u=a.get(`scale`),f=u!==void 0&&u.type===`f32`&&u.tupleSize===3,p=_(`P`);d.set(`P`,p);let m={P:{kind:`slot`,index:p}};if(e.ref!==null&&(m.translate=e.ref),n.ref!==null&&(m.rotateEuler=n.ref),i.ref!==null&&(m.scale=i.ref),l){let e=_(`rot`);d.set(`rot`,e),m.rot={kind:`slot`,index:e}}if(f){let e=_(`scale`);d.set(`scale`,e),m.scaleAttr={kind:`slot`,index:e}}r.push(S(He(e.param,n.param,i.param,l,f),0,m,o));break}case`jitterPoints`:{if(y(`P`,`f32`,3),d.has(`P`))throw new $(`identity after P write`);let e=typeof s.seed==`number`?s.seed:NaN,n=m(t.seed,e),i=x(s.amount,n,r,[1,3],o,t.kind),c=a.get(`seed`),l=c!==void 0;if(l&&(c.type!==`u32`||c.tupleSize!==1))throw new $(`seed attribute shape`);let u=_(`P`);d.set(`P`,u);let f={P:{kind:`slot`,index:u}};i.ref!==null&&(f.amount=i.ref),l&&(f.seed={kind:`slot`,index:_(`seed`)}),r.push(S(Ue(i.param,l),n,f,o));break}case`orientAlongVector`:{let e=s.axis;if(!nt.includes(e))throw new $(`axis`);if(!it(s.up))throw new $(`up`);let n=x(s.direction,t.seed,r,[1,3],o,t.kind),i=s.up,c=i[0]*i[0]+i[1]*i[1]+i[2]*i[2],l=c>0?1/Math.sqrt(c):0,u=[i[0]*l,i[1]*l,i[2]*l];for(let e of u)if(!Number.isFinite(Math.fround(e)))throw new $(`up range`);let p=b(u,o,t.kind),m=a.get(`rot`),h=m!==void 0&&m.type===`f32`&&m.tupleSize===4?_(`rot`):v(`rot`,4,`quat-default`);a.set(`rot`,{type:`f32`,tupleSize:4}),d.set(`rot`,h),f.push({op:`ensure-rot`});let g={rot:{kind:`slot`,index:h}};n.ref!==null&&(g.direction=n.ref),r.push(S(Ge(n.param,e,p),0,g,o));break}case`spawnInstances`:{if(!n)throw new $(`spawnInstances must be the run's last member`);let e=s.assetId;if(typeof e!=`string`||e===``)throw new $(`assetId`);if(y(`P`,`f32`,3),i>1048576)throw new $(`${i} instances over MAX_INSTANCES`);let t=s.assetAttr;if(t!==void 0&&typeof t!=`string`)throw new $(`assetAttr`);let c=t===void 0?``:t;if(c!==``){let e=a.get(c);if(e===void 0)throw new $(`assetAttr "${c}" not on the point domain`);if(e.type!==`string`)throw new $(`assetAttr "${c}" is ${e.type}, not string`)}let l=s.colorAttr;if(l!==void 0&&typeof l!=`string`)throw new $(`colorAttr`);let u=l===void 0?``:l,d=0;if(u!==``){let e=a.get(u);if(e===void 0)throw new $(`colorAttr "${u}" not on the point domain`);if(e.type!==`f32`||e.tupleSize<3)throw new $(`colorAttr "${u}" is ${e.type}x${e.tupleSize}`);d=e.tupleSize}let f=a.get(`rot`),p=f!==void 0&&f.type===`f32`&&f.tupleSize===4,m=a.get(`scale`),g=m!==void 0&&m.type===`f32`&&m.tupleSize===3,v={P:{kind:`slot`,index:_(`P`)},transforms:{kind:`out`}};p&&(v.rot={kind:`slot`,index:_(`rot`)}),g&&(v.scaleAttr={kind:`slot`,index:_(`scale`)});let b=c!==``;b&&(v.perm={kind:`perm`}),d>0&&(v.color={kind:`slot`,index:_(u)},v.colors={kind:`colorOut`}),r.push(S(Ke(p,g,b,d),0,v,o,b)),h={assetId:e,assetAttr:c,colorAttr:u,colorTupleSize:d,count:i,bytes:i*64,colorBytes:d>0?i*Qe:0,permBytes:b?i*4:0};break}default:throw new $(`unknown kind ${t.kind}`)}p.push({id:t.id,type:t.type,steps:r})}}catch(e){if(e instanceof $)return tt;throw e}let{writtenList:C,materialize:w,totalBytes:T}=ot(d,s,u,h,t.needsGeometry);return T>n?{reason:`run-too-large`}:{plan:{format:$e,count:i,members:p,slots:s,cols:u,written:C,layoutOps:f,materialize:w,instances:h,totalBytes:T}}}var ct={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function lt(){return new Promise(e=>setTimeout(e,0))}async function ut(e,t,n,i){let{device:a,pool:o}=e,{geo:s,signal:c,budgetMs:l}=n,u=t.count;if(s.attrs.point.count!==u)throw Error(`resident run: plan was built for ${u} points but the input geometry has ${s.attrs.point.count}; plans are single-cook artifacts — re-plan for new inputs`);let d=()=>{if(c?.aborted)throw new h},f=[],p=(e,t)=>{let n=o.acquire(e,t);return f.push(n),n},m=new Set,g=[];try{let n=s.attrs.point,c=t.slots.map(e=>{let t=p(e.bytes,K.STORAGE|K.COPY_DST|K.COPY_SRC);if(e.init===`attr`){let r=n.require(e.name),i=e.bytes/4;if(r.data instanceof Uint8Array){let e=new Uint32Array(i);for(let t=0;t<i;t++)e[t]=r.data[t];a.queue.writeBuffer(t,0,e)}else a.queue.writeBuffer(t,0,r.data.subarray(0,i))}else if(e.init===`quat-default`){let n=new Float32Array(e.bytes/4);for(let e=3;e<n.length;e+=4)n[e]=1;a.queue.writeBuffer(t,0,n)}return t}),f=t.cols.map(e=>p(e,K.STORAGE|K.COPY_DST|K.COPY_SRC)),h=t.instances===null?void 0:C(s,{defaultAssetId:t.instances.assetId,...t.instances.assetAttr===``?{}:{assetAttr:t.instances.assetAttr}}),_=t.instances!==null&&t.instances.permBytes>0?p(t.instances.permBytes,K.STORAGE|K.COPY_DST):void 0;_!==void 0&&h!==void 0&&a.queue.writeBuffer(_,0,h.perm);let v=K.STORAGE|K.COPY_DST|K.COPY_SRC|K.VERTEX,y=h===void 0?[]:Array.from(h.counts,e=>p(e*64,v)),b=h===void 0||t.instances===null||t.instances.colorBytes===0?[]:Array.from(h.counts,e=>p(e*Qe,v)),x=(e,t)=>{if(e.kind===`slot`)return c[e.index];if(e.kind===`col`)return f[e.index];if(e.kind===`colorOut`){let e=b[t];if(e===void 0)throw Error(`resident run: a kernel binds a retained instance-colour buffer but the plan declares no colour output (plan and kernels disagree)`);return e}if(e.kind===`perm`){if(_===void 0)throw Error(`resident run: a kernel binds the grouping permutation but the plan declares no per-point asset attribute (plan and kernels disagree)`);return _}let n=y[t];if(n===void 0)throw Error(`resident run: a kernel binds a retained instance-transform buffer but the plan declares no instances output (plan and kernels disagree)`);return n},S=a.createCommandEncoder(),w=S.beginComputePass(),T=performance.now();for(let n of t.members){d();for(let t of n.steps){let n=e.getPipeline(t.key,t.wgsl,t.entryPoint,i);w.setPipeline(n);let r=Ze(t.workgroupSize,e.maxElementsPerDispatch),o=t.perBatch&&h!==void 0?Array.from(h.counts,(e,t)=>({batch:t,elements:e,base:h.offsets[t]})):[{batch:0,elements:u,base:0}];for(let e of o){i!==void 0&&i.dispatches++;let o=new ArrayBuffer(t.uniformBytes),s=new Uint8Array(o),c=new Uint32Array(o,0,t.uniformBytes>=16?4:3);c[0]=e.elements,c[1]=t.seed>>>0,t.perBatch&&(c[3]=e.base),t.consts.length>0&&new Float32Array(o,16,t.consts.length).set(t.consts);let l=Math.ceil(e.elements/r);for(let i=0;i<l;i++){let o=p(t.uniformBytes,K.UNIFORM|K.COPY_DST);c[2]=i*r,a.queue.writeBuffer(o,0,s);let l=a.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:t.uniformsBinding,resource:{buffer:o}},...t.bindings.map(t=>({binding:t.binding,resource:{buffer:x(t.ref,e.batch)}}))]}),u=Math.min(r,e.elements-i*r);w.setBindGroup(0,l),w.dispatchWorkgroups(Math.ceil(u/t.workgroupSize))}}}l!==void 0&&performance.now()-T>l&&(await lt(),d(),T=performance.now())}w.end();let E=[],D,O=t.materialize?t.written.reduce((e,n)=>e+t.slots[n.slot].bytes,0):0;if(O>0){D=p(O,K.COPY_DST|K.MAP_READ);let e=0;for(let n of t.written){let r=t.slots[n.slot].bytes;S.copyBufferToBuffer(c[n.slot],0,D,e,r),E.push(e),e+=r}}a.queue.submit([S.finish()]);let k;if(t.materialize){let e;if(D!==void 0){await D.mapAsync(Ae.READ,0,O);try{e=D.getMappedRange(0,O).slice(0)}finally{D.unmap()}}d(),k=r(s);let n=k.attrs.point;for(let e of t.layoutOps)if(e.op===`replace`)n.replace(e.name,e.type,e.tupleSize);else{let e=n.get(`rot`);(!e||e.type!==`f32`||e.tupleSize!==4)&&(e&&n.remove(`rot`),n.add(`rot`,`f32`,4,[0,0,0,1]))}t.written.forEach((t,r)=>{let i=n.require(t.name),a=u*i.tupleSize;if(e===void 0)throw Error(`resident run: readback missing for a written attribute`);if(i.data instanceof Uint8Array){let t=new Uint32Array(e,E[r],a);for(let e=0;e<a;e++)i.data[e]=t[e]}else{let n=ct[i.type];if(n===void 0)throw Error(`resident run: cannot materialize attribute "${t.name}" of type ${i.type}`);i.data.set(new n(e,E[r],a))}})}else d();let A;if(t.instances!==null){let e=t.instances.colorBytes>0;if(h===void 0||y.length!==h.order.length||b.length!==(e?h.order.length:0))throw Error(`resident run: the plan declares an instances output but the acquired transform buffers do not match the grouping (library bug: plan.instances, the grouping, and the acquired buffers must agree)`);let n=(e,t,n)=>{let r=o.detach(e);m.add(e);try{return Ye(r,t,n)}catch(e){throw r.destroy(),e}},r=[];for(let t=0;t<h.order.length;t++){let i=h.order[t],a=h.counts[t],o=n(y[t],a*64,`${a} instances of "${i}"`);if(g.push(o),!e){r.push({residency:`device`,assetId:i,count:a,transforms:o});continue}let s=n(b[t],a*Qe,`${a} instance colours of "${i}"`);g.push(s),r.push({residency:`device`,assetId:i,count:a,transforms:o,colors:s})}A=r}i!==void 0&&(i.residentRuns++,i.fusedNodes+=t.members.length,i.readbacksSaved+=t.members.length-+!!t.materialize);let j={};return k!==void 0&&(j.geo=k),A!==void 0&&(j.deviceBatches=A),j}catch(e){for(let e of g)e.dispose();throw e instanceof h?e:Error(`GpuFieldEvaluator: resident run failed (${t.members.length} fused nodes [${t.members.map(e=>`"${e.id}"`).join(`, `)}], ${u} points): ${e instanceof Error?e.message:String(e)}`,{cause:e})}finally{for(let e of f)m.has(e)||o.release(e)}}var dt=`gpu2`,ft=268435456,pt=[`spawnInstances`],mt={f32:Float32Array,i32:Int32Array,u32:Uint32Array},ht={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function gt(e){let t=e=>e!==void 0&&e!==``?e:`?`;return[dt,t(e?.vendor),t(e?.architecture),t(e?.device),t(e?.description)].join(`|`)}function _t(e,t){return e!==void 0&&(e.fallbacks[t]=(e.fallbacks[t]??0)+1),null}var vt=class{cacheSalt;residentTerminals;acceptDerivedSpecs;device;kernels=new Map;pipelines=new Map;pool;maxElementsPerDispatch;maxResidentBytes;constructor(e,t={}){if(t.maxElementsPerDispatch!==void 0&&!Number.isFinite(t.maxElementsPerDispatch))throw Error(`GpuFieldEvaluator: maxElementsPerDispatch must be a finite number, got ${t.maxElementsPerDispatch}; leave it unset to use the device maximum`);this.device=e,this.cacheSalt=gt(t.adapterInfo??e.adapterInfo),this.pool=new Ne(e,t.maxPooledBytes??ft),this.maxElementsPerDispatch=t.maxElementsPerDispatch,this.maxResidentBytes=t.maxResidentBytes??536870912,this.residentTerminals=t.deviceInstances===!0?pt:[],this.acceptDerivedSpecs=s(t)}get pipelineCacheSize(){return this.pipelines.size}get poolStats(){return this.pool.stats}dispose(){this.pool.dispose()}chunkElements(e){let t=Xe*e.workgroupSize,n=Math.min(this.maxElementsPerDispatch??t,t);return Math.max(e.workgroupSize,Math.floor(n/e.workgroupSize)*e.workgroupSize)}resolveField(e,t,r){let i=c(e,this.acceptDerivedSpecs);if(i===void 0)return _t(r,n(e));let a=t.geo.attrs[t.domain],o={},s=[];for(let e of a.names().sort()){let t=a.get(e);t!==void 0&&(o[e]={type:t.type,tupleSize:t.tupleSize},s.push(`${JSON.stringify(e)}:${t.type}x${t.tupleSize}`))}let l=`${e.key.length}#${e.key}|${s.join(`,`)}`,u=this.kernels.get(l);if(u===void 0){try{u=ke(i,{attributes:o})}catch(e){u=e instanceof Error?e:Error(String(e))}this.kernels.set(l,u)}if(u instanceof Error)return _t(r,`compile-error`);if(u.inputs.length+1>8)return _t(r,`too-many-buffers`);let d=a.count;if(d===0)return Promise.resolve({data:new ht[u.outType](0),tupleSize:u.outTupleSize});let f=this.getPipeline(u.key,u.wgsl,u.entryPoint,r);return r!==void 0&&r.dispatches++,this.dispatch(e,t,u,f,d)}getPipeline(e,t,n,r){let i=this.pipelines.get(e);if(i!==void 0)return r!==void 0&&r.pipelineCacheHits++,i;let a=this.device.createShaderModule({code:t}),o=this.device.createComputePipeline({layout:`auto`,compute:{module:a,entryPoint:n}});return this.pipelines.set(e,o),r!==void 0&&r.pipelinesCompiled++,o}planRun(e,t,n){let r=st(e,t,this.maxResidentBytes,this.acceptDerivedSpecs);return`plan`in r?r.plan:(n!==void 0&&(n.fallbacks[r.reason]=(n.fallbacks[r.reason]??0)+1),null)}executeRun(e,t,n){let r=et(e);return r===null?Promise.reject(Error(`GpuFieldEvaluator.executeRun: plan was not produced by this library's planRun; pass the object returned by planRun on the same resolver`)):ut({device:this.device,pool:this.pool,maxElementsPerDispatch:this.maxElementsPerDispatch,getPipeline:(e,t,n,r)=>this.getPipeline(e,t,n,r)},r,t,n)}async dispatch(e,t,n,r,i){let a=this.device,o=[],s=(e,t)=>{let n=this.pool.acquire(e,t);return o.push(n),n};try{let e=this.chunkElements(n),o=Math.ceil(i/e),c=[],l=t.geo.attrs[t.domain];for(let e of n.inputs){let t=l.require(e.name),n=i*e.tupleSize,r;if(t.data instanceof Uint8Array){let e=new Uint32Array(n);for(let r=0;r<n;r++)e[r]=t.data[r];r=e}else r=t.data.subarray(0,n);let o=s(n*4,K.STORAGE|K.COPY_DST);a.queue.writeBuffer(o,0,r),c.push({binding:e.binding,resource:{buffer:o}})}let u=i*n.outTupleSize*4,d=s(u,K.STORAGE|K.COPY_SRC);c.push({binding:n.bindings.output,resource:{buffer:d}});let f=s(u,K.COPY_DST|K.MAP_READ),p=[];for(let l=0;l<o;l++){let o=s(12,K.UNIFORM|K.COPY_DST);a.queue.writeBuffer(o,0,new Uint32Array([i,t.seed>>>0,l*e])),p.push(a.createBindGroup({layout:r.getBindGroupLayout(0),entries:[{binding:n.bindings.uniforms,resource:{buffer:o}},...c]}))}let m=a.createCommandEncoder(),h=m.beginComputePass();h.setPipeline(r);for(let t=0;t<o;t++){let r=Math.min(e,i-t*e);h.setBindGroup(0,p[t]),h.dispatchWorkgroups(Math.ceil(r/n.workgroupSize))}h.end(),m.copyBufferToBuffer(d,0,f,0,u),a.queue.submit([m.finish()]),await f.mapAsync(Ae.READ,0,u);let g;try{g=f.getMappedRange(0,u).slice(0)}finally{f.unmap()}return{data:new mt[n.outType](g),tupleSize:n.outTupleSize}}catch(n){throw Error(`GpuFieldEvaluator: dispatch failed for field ${e.key} (${i} elements on the ${t.domain} domain): ${n instanceof Error?n.message:String(n)}`,{cause:n})}finally{for(let e of o)this.pool.release(e)}}};export{vt as t};