import{$i as e,Ci as t,Ei as n,Gi as r,Ji as i,Ki as a,Qi as o,Ti as s,Wi as c,Xi as l,Yi as u,Zi as d,_i as f,bi as p,ea as m,ei as h,fi as g,gi as _,hi as v,ia as y,mi as b,oi as x,ra as S,ta as C,vi as w,wi as T,xi as E,zr as D}from"./fps-AzBzSqg2.js";var O=class extends Error{constructor(e){super(e),this.name=`GpuCompileError`}};function k(e,t){let n=Math.fround(e);if(!Number.isFinite(n))throw new O(`${t}: value ${e} is not representable as a finite f32 (WGSL kernels compute in f32; keep magnitudes within ~3.4e38)`);return Object.is(n,-0)?`-0f`:`${String(n)}f`}function ee(e){return`${e>>>0}u`}function A(e){return`0x${(e>>>0).toString(16).padStart(8,`0`)}u`}var j=A,te=k(34028234663852886e22,`internal f32 max`);function ne(e,t){let n=j(e);for(let e of t)n=`pcg_hash_mix(${n}, ${e})`;return`pcg_hash_finalize(${n})`}function re(){let e=[];for(let t=0;t<12;t++){let n=e=>k(T[t*3+e],`internal GRAD3`);e.push(`  vec3<f32>(${n(0)}, ${n(1)}, ${n(2)}),`)}return`var<private> PCG_GRAD3: array<vec3<f32>, 12> = array<vec3<f32>, 12>(
${e.join(`
`)}
  ...
  return ${M(`internal PERLIN_SCALE`)(E)} * pcg_mix(
  ...
  let t = ${M(`internal simplex R2`)(f)} - x * x - y * y - z * z;
  if (t <= 0f) {
    return 0f;
  }
  ...
  let s = (p.x + p.y + p.z) * ${M(`internal simplex F3`)(v)};
  let i = i32(floor(p.x + s));
  let j = i32(floor(p.y + s));
  let k = i32(floor(p.z + s));
  let t = f32(i + j + k) * ${M(`internal simplex G3`)(_)};
  let x0 = p.x - (f32(i) - t);
  let y0 = p.y - (f32(j) - t);
  let z0 = p.z - (f32(k) - t);
  var i1: i32;
  ...
  let x1 = x0 - f32(i1) + ${M(`internal simplex G3`)(_)};
  let y1 = y0 - f32(j1) + ${M(`internal simplex G3`)(_)};
  let z1 = z0 - f32(k1) + ${M(`internal simplex G3`)(_)};
  let x2 = x0 - f32(i2) + ${M(`internal simplex 2*G3`)(2*_)};
  let y2 = y0 - f32(j2) + ${M(`internal simplex 2*G3`)(2*_)};
  let z2 = z0 - f32(k2) + ${M(`internal simplex 2*G3`)(2*_)};
  let x3 = x0 - 1f + ${M(`internal simplex 3*G3`)(3*_)};
  let y3 = y0 - 1f + ${M(`internal simplex 3*G3`)(3*_)};
  let z3 = z0 - 1f + ${M(`internal simplex 3*G3`)(3*_)};
...
`))}var We={"+x":`f, u, -r`,"-x":`-f, u, r`,"+y":`-r, f, u`,"-y":`r, -f, u`,"+z":`r, u, f`,"-z":`-r, u, -f`};function Ge(e,t,n){let r=new J,i=e.kind===`column`?r.add(`direction`,`read`,e.type,`direction column ${Z(e)}`):``,a=r.add(`rot`,`read_write`,`f32`,`attribute rot: f32 tupleSize 4`),o=k(1e-12,`internal ORIENT_PARALLEL_EPS`),s=`  let d = vec3<f32>(${[0,1,2].map(t=>q(i,e,t)).join(`, `)});
  ...
  ${s}[o + 13u] = ${i}[${l} * 3u + 1u];
  ${s}[o + 14u] = ${i}[${l} * 3u + 2u];
  ${s}[o + 15u] = 1f;`;return X(`spawnInstances|rot=${+!!e}|scl=${+!!t}${n?`|perm`:``}`,0,r.items,[],f,n)}var qe=`webgpu`,Je=class{backend=qe;byteLength;detached;label;constructor(e,t,n){this.detached=e,this.byteLength=t,this.label=n}get disposed(){return this.detached.destroyed}get resource(){if(this.detached.destroyed)throw Error(`device transforms handle (${this.label}) was disposed; its GPU buffer is destroyed and cannot be bound. Dispose a handle only after the last frame that reads it, and re-cook to obtain a fresh one (device-resident outputs are never memoized, so every cook produces a new handle)`);return this.detached.buffer}dispose(){this.detached.destroy()}};function Ye(e,t,n){return new Je(e,t,n)}var Xe=65535;function Ze(e,t){let n=Xe*e;return Math.max(e,Math.floor(Math.min(t??n,n)/e)*e)}var Qe=`pcg-resident-run/4`;function $e(e){return e.format===Qe?e:null}var et={reason:`run-plan-failed`},tt=[`+x`,`-x`,`+y`,`-y`,`+z`,`-z`];function nt(e){if(typeof e!=`object`||!e||Array.isArray(e))return!1;let t=e;if(t.fn===`randomField`)return!0;let n=t.args;if(Array.isArray(n)){for(let e of n)if(nt(e))return!0}let r=t.opts;return!!(typeof r==`object`&&r&&nt(r.position))}function rt(e){return Array.isArray(e)&&e.length===3&&e.every(e=>typeof e==`number`&&Number.isFinite(e))}var $=class extends Error{},it=[];function at(e,t,n,a){let o=t.count,s=new Map(Object.entries(t.attributes)),c=[],l=new Map,u=[],d=new Map,f=[],p=[],m=null,h=()=>Object.fromEntries(s),g=e=>{let t=l.get(e);if(t!==void 0)return t;let n=s.get(e);if(n===void 0||n.type===`string`)throw new $(e);let r=c.length;return c.push({bytes:o*n.tupleSize*4,init:`attr`,name:e}),l.set(e,r),r},_=(e,t,n)=>{let r=c.length;return c.push({bytes:o*t*4,init:n,name:e}),l.set(e,r),r},v=(e,t,n)=>{let r=s.get(e);if(r===void 0||r.type!==t||r.tupleSize!==n)throw new $(e)},y=(e,t,n)=>{let r=t.length/4;if(r>=4)throw Error(`resident run: "${n}" needs more than 4 uniform constant slots for its constant params; raise MAX_APPLY_CONST_SLOTS in applyKernels.ts (each slot costs 16 bytes of the per-chunk uniform and nothing else)`);for(let n=0;n<4;n++)t.push(n<e.length?e[n]:0);return{kind:`const`,tupleSize:e.length,slot:r}},b=(e,t,n,s,c,l)=>{let f;if(i(e)){let t=r(e,a);if(t===void 0)throw new $(`no spec`);if(d.has(`P`)&&nt(t))throw new $(`identity after P write`);f=t}else if(typeof e==`number`||Array.isArray(e)&&e.every(e=>typeof e==`number`)){let t=typeof e==`number`?[e]:e;if(t.length<1||t.length>4||s!==null&&!s.includes(t.length))throw new $(`tuple`);for(let e of t)if(!Number.isFinite(Math.fround(e)))throw new $(`f32 range`);return{param:y(t,c,l),ref:null}}else throw new $(`bad param value`);let p;try{p=ke(f,{attributes:h()})}catch{throw new $(`compile`)}if(p.inputs.length+1>8)throw new $(`buffers`);if(s!==null&&!s.includes(p.outTupleSize))throw new $(`tuple`);let m=u.length;return u.push(o*p.outTupleSize*4),n.push({key:p.key,wgsl:p.wgsl,entryPoint:p.entryPoint,workgroupSize:p.workgroupSize,seed:t,uniformsBinding:p.bindings.uniforms,uniformBytes:12,consts:it,perBatch:!1,bindings:[...p.inputs.map(e=>({binding:e.binding,ref:{kind:`slot`,index:g(e.name)}})),{binding:p.bindings.output,ref:{kind:`col`,index:m}}]}),{param:{kind:`column`,type:p.outType,tupleSize:p.outTupleSize},ref:{kind:`col`,index:m}}},x=(e,t,n,r,i=!1)=>{if(e.constSlots*4!==r.length)throw Error(`resident run: apply kernel "${e.key}" declares ${e.constSlots} constant slots but the planner allocated ${r.length/4}`);return{key:e.key,wgsl:e.wgsl,entryPoint:e.entryPoint,workgroupSize:e.workgroupSize,seed:t,uniformsBinding:0,uniformBytes:e.uniformBytes,consts:r,perBatch:i,bindings:e.bindings.map(e=>{let t=n[e.role];if(t===void 0)throw new $(`unmapped role ${e.role}`);return{binding:e.binding,ref:t}})}};try{for(let t of e){let n=t===e[e.length-1],r=[],i=[],a=t.params;switch(t.kind){case`setAttribute`:{let e=a.name,n=a.type,o=a.tupleSize;if(typeof e!=`string`)throw new $(`name`);if(n!==`f32`&&n!==`i32`&&n!==`u32`&&n!==`bool`)throw new $(`type`);if(typeof o!=`number`||!Number.isInteger(o)||o<1||o>4)throw new $(`tupleSize`);let c=typeof a.seed==`number`?a.seed:NaN,l=c===0?t.seed:C(t.seed,c),{param:u,ref:p}=b(a.value,l,r,o===1?[1]:[1,o],i,t.kind),m=_(e,o,`none`);s.set(e,{type:n,tupleSize:o}),d.set(e,m),f.push({op:`replace`,name:e,type:n,tupleSize:o});let h={target:{kind:`slot`,index:m}};p!==null&&(h.value=p),r.push(x(Ve(u,n,o),0,h,i));break}case`transformPoints`:{v(`P`,`f32`,3);let e=b(a.translate,t.seed,r,[1,3],i,t.kind),n=b(a.rotateEuler,t.seed,r,[1,3],i,t.kind),o=b(a.scale,t.seed,r,[1,3],i,t.kind),c=s.get(`rot`),l=c!==void 0&&c.type===`f32`&&c.tupleSize===4,u=s.get(`scale`),f=u!==void 0&&u.type===`f32`&&u.tupleSize===3,p=g(`P`);d.set(`P`,p);let m={P:{kind:`slot`,index:p}};if(e.ref!==null&&(m.translate=e.ref),n.ref!==null&&(m.rotateEuler=n.ref),o.ref!==null&&(m.scale=o.ref),l){let e=g(`rot`);d.set(`rot`,e),m.rot={kind:`slot`,index:e}}if(f){let e=g(`scale`);d.set(`scale`,e),m.scaleAttr={kind:`slot`,index:e}}r.push(x(He(e.param,n.param,o.param,l,f),0,m,i));break}case`jitterPoints`:{if(v(`P`,`f32`,3),d.has(`P`))throw new $(`identity after P write`);let e=typeof a.seed==`number`?a.seed:NaN,n=C(t.seed,e),o=b(a.amount,n,r,[1,3],i,t.kind),c=s.get(`seed`),l=c!==void 0;if(l&&(c.type!==`u32`||c.tupleSize!==1))throw new $(`seed attribute shape`);let u=g(`P`);d.set(`P`,u);let f={P:{kind:`slot`,index:u}};o.ref!==null&&(f.amount=o.ref),l&&(f.seed={kind:`slot`,index:g(`seed`)}),r.push(x(Ue(o.param,l),n,f,i));break}case`orientAlongVector`:{let e=a.axis;if(!tt.includes(e))throw new $(`axis`);if(!rt(a.up))throw new $(`up`);let n=b(a.direction,t.seed,r,[1,3],i,t.kind),o=a.up,c=o[0]*o[0]+o[1]*o[1]+o[2]*o[2],l=c>0?1/Math.sqrt(c):0,u=[o[0]*l,o[1]*l,o[2]*l];for(let e of u)if(!Number.isFinite(Math.fround(e)))throw new $(`up range`);let p=y(u,i,t.kind),m=s.get(`rot`),h=m!==void 0&&m.type===`f32`&&m.tupleSize===4?g(`rot`):_(`rot`,4,`quat-default`);s.set(`rot`,{type:`f32`,tupleSize:4}),d.set(`rot`,h),f.push({op:`ensure-rot`});let v={rot:{kind:`slot`,index:h}};n.ref!==null&&(v.direction=n.ref),r.push(x(Ge(n.param,e,p),0,v,i));break}case`spawnInstances`:{if(!n)throw new $(`spawnInstances must be the run's last member`);let e=a.assetId;if(typeof e!=`string`||e===``)throw new $(`assetId`);v(`P`,`f32`,3);let t=a.assetAttr;if(t!==void 0&&typeof t!=`string`)throw new $(`assetAttr`);let c=t===void 0?``:t;if(c!==``){let e=s.get(c);if(e===void 0)throw new $(`assetAttr "${c}" not on the point domain`);if(e.type!==`string`)throw new $(`assetAttr "${c}" is ${e.type}, not string`)}let l=s.get(`rot`),u=l!==void 0&&l.type===`f32`&&l.tupleSize===4,d=s.get(`scale`),f=d!==void 0&&d.type===`f32`&&d.tupleSize===3,p={P:{kind:`slot`,index:g(`P`)},transforms:{kind:`out`}};u&&(p.rot={kind:`slot`,index:g(`rot`)}),f&&(p.scaleAttr={kind:`slot`,index:g(`scale`)});let h=c!==``;h&&(p.perm={kind:`perm`}),r.push(x(Ke(u,f,h),0,p,i,h)),m={assetId:e,assetAttr:c,count:o,bytes:o*64,permBytes:h?o*4:0};break}default:throw new $(`unknown kind ${t.kind}`)}p.push({id:t.id,type:t.type,steps:r})}}catch(e){if(e instanceof $)return et;throw e}let S=[...d].map(([e,t])=>({name:e,slot:t})),w=t.needsGeometry||m===null,T=c.reduce((e,t)=>e+t.bytes,0),E=u.reduce((e,t)=>e+t,0),D=w?S.reduce((e,t)=>e+c[t.slot].bytes,0):0,O=T+E+D+(m?.bytes??0)+(m?.permBytes??0);return O>n?{reason:`run-too-large`}:{plan:{format:Qe,count:o,members:p,slots:c,cols:u,written:S,layoutOps:f,materialize:w,instances:m,totalBytes:O}}}var ot={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function st(){return new Promise(e=>setTimeout(e,0))}async function ct(e,t,n,r){let{device:i,pool:a}=e,{geo:o,signal:s,budgetMs:c}=n,l=t.count;if(o.attrs.point.count!==l)throw Error(`resident run: plan was built for ${l} points but the input geometry has ${o.attrs.point.count}; plans are single-cook artifacts — re-plan for new inputs`);let u=()=>{if(s?.aborted)throw new g},d=[],f=(e,t)=>{let n=a.acquire(e,t);return d.push(n),n},p=new Set,m=[];try{let n=o.attrs.point,s=t.slots.map(e=>{let t=f(e.bytes,K.STORAGE|K.COPY_DST|K.COPY_SRC);if(e.init===`attr`){let r=n.require(e.name),a=e.bytes/4;if(r.data instanceof Uint8Array){let e=new Uint32Array(a);for(let t=0;t<a;t++)e[t]=r.data[t];i.queue.writeBuffer(t,0,e)}else i.queue.writeBuffer(t,0,r.data.subarray(0,a))}else if(e.init===`quat-default`){let n=new Float32Array(e.bytes/4);for(let e=3;e<n.length;e+=4)n[e]=1;i.queue.writeBuffer(t,0,n)}return t}),d=t.cols.map(e=>f(e,K.STORAGE|K.COPY_DST|K.COPY_SRC)),h=t.instances===null?void 0:D(o,{defaultAssetId:t.instances.assetId,...t.instances.assetAttr===``?{}:{assetAttr:t.instances.assetAttr}}),g=t.instances!==null&&t.instances.permBytes>0?f(t.instances.permBytes,K.STORAGE|K.COPY_DST):void 0;g!==void 0&&h!==void 0&&i.queue.writeBuffer(g,0,h.perm);let _=h===void 0?[]:Array.from(h.counts,e=>f(e*64,K.STORAGE|K.COPY_DST|K.COPY_SRC|K.VERTEX)),v=(e,t)=>{if(e.kind===`slot`)return s[e.index];if(e.kind===`col`)return d[e.index];if(e.kind===`perm`){if(g===void 0)throw Error(`resident run: a kernel binds the grouping permutation but the plan declares no per-point asset attribute (plan and kernels disagree)`);return g}let n=_[t];if(n===void 0)throw Error(`resident run: a kernel binds a retained instance-transform buffer but the plan declares no instances output (plan and kernels disagree)`);return n},y=i.createCommandEncoder(),b=y.beginComputePass(),S=performance.now();for(let n of t.members){u();for(let t of n.steps){let n=e.getPipeline(t.key,t.wgsl,t.entryPoint,r);b.setPipeline(n);let a=Ze(t.workgroupSize,e.maxElementsPerDispatch),o=t.perBatch&&h!==void 0?Array.from(h.counts,(e,t)=>({batch:t,elements:e,base:h.offsets[t]})):[{batch:0,elements:l,base:0}];for(let e of o){r!==void 0&&r.dispatches++;let o=new ArrayBuffer(t.uniformBytes),s=new Uint8Array(o),c=new Uint32Array(o,0,t.uniformBytes>=16?4:3);c[0]=e.elements,c[1]=t.seed>>>0,t.perBatch&&(c[3]=e.base),t.consts.length>0&&new Float32Array(o,16,t.consts.length).set(t.consts);let l=Math.ceil(e.elements/a);for(let r=0;r<l;r++){let o=f(t.uniformBytes,K.UNIFORM|K.COPY_DST);c[2]=r*a,i.queue.writeBuffer(o,0,s);let l=i.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:t.uniformsBinding,resource:{buffer:o}},...t.bindings.map(t=>({binding:t.binding,resource:{buffer:v(t.ref,e.batch)}}))]}),u=Math.min(a,e.elements-r*a);b.setBindGroup(0,l),b.dispatchWorkgroups(Math.ceil(u/t.workgroupSize))}}}c!==void 0&&performance.now()-S>c&&(await st(),u(),S=performance.now())}b.end();let C=[],w,T=t.materialize?t.written.reduce((e,n)=>e+t.slots[n.slot].bytes,0):0;if(T>0){w=f(T,K.COPY_DST|K.MAP_READ);let e=0;for(let n of t.written){let r=t.slots[n.slot].bytes;y.copyBufferToBuffer(s[n.slot],0,w,e,r),C.push(e),e+=r}}i.queue.submit([y.finish()]);let E;if(t.materialize){let e;if(w!==void 0){await w.mapAsync(Ae.READ,0,T);try{e=w.getMappedRange(0,T).slice(0)}finally{w.unmap()}}u(),E=x(o);let n=E.attrs.point;for(let e of t.layoutOps)if(e.op===`replace`)n.replace(e.name,e.type,e.tupleSize);else{let e=n.get(`rot`);(!e||e.type!==`f32`||e.tupleSize!==4)&&(e&&n.remove(`rot`),n.add(`rot`,`f32`,4,[0,0,0,1]))}t.written.forEach((t,r)=>{let i=n.require(t.name),a=l*i.tupleSize;if(e===void 0)throw Error(`resident run: readback missing for a written attribute`);if(i.data instanceof Uint8Array){let t=new Uint32Array(e,C[r],a);for(let e=0;e<a;e++)i.data[e]=t[e]}else{let n=ot[i.type];if(n===void 0)throw Error(`resident run: cannot materialize attribute "${t.name}" of type ${i.type}`);i.data.set(new n(e,C[r],a))}})}else u();let O;if(t.instances!==null){if(h===void 0||_.length!==h.order.length)throw Error(`resident run: the plan declares an instances output but the acquired transform buffers do not match the grouping (library bug: plan.instances, the grouping, and the acquired buffers must agree)`);let e=[];for(let t=0;t<h.order.length;t++){let n=h.order[t],r=h.counts[t],i=a.detach(_[t]);p.add(_[t]);let o;try{o=Ye(i,r*64,`${r} instances of "${n}"`)}catch(e){throw i.destroy(),e}m.push(o),e.push({residency:`device`,assetId:n,count:r,transforms:o})}O=e}r!==void 0&&(r.residentRuns++,r.fusedNodes+=t.members.length,r.readbacksSaved+=t.members.length-+!!t.materialize);let k={};return E!==void 0&&(k.geo=E),O!==void 0&&(k.deviceBatches=O),k}catch(e){for(let e of m)e.dispose();throw e instanceof g?e:Error(`GpuFieldEvaluator: resident run failed (${t.members.length} fused nodes [${t.members.map(e=>`"${e.id}"`).join(`, `)}], ${l} points): ${e instanceof Error?e.message:String(e)}`,{cause:e})}finally{for(let e of d)p.has(e)||a.release(e)}}var lt=`gpu2`,ut=268435456,dt=[`spawnInstances`],ft={f32:Float32Array,i32:Int32Array,u32:Uint32Array},pt={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function mt(e){let t=e=>e!==void 0&&e!==``?e:`?`;return[lt,t(e?.vendor),t(e?.architecture),t(e?.device),t(e?.description)].join(`|`)}function ht(e,t){return e!==void 0&&(e.fallbacks[t]=(e.fallbacks[t]??0)+1),null}var gt=class{cacheSalt;residentTerminals;acceptDerivedSpecs;device;kernels=new Map;pipelines=new Map;pool;maxElementsPerDispatch;maxResidentBytes;constructor(e,t={}){if(t.maxElementsPerDispatch!==void 0&&!Number.isFinite(t.maxElementsPerDispatch))throw Error(`GpuFieldEvaluator: maxElementsPerDispatch must be a finite number, got ${t.maxElementsPerDispatch}; leave it unset to use the device maximum`);this.device=e,this.cacheSalt=mt(t.adapterInfo??e.adapterInfo),this.pool=new Ne(e,t.maxPooledBytes??ut),this.maxElementsPerDispatch=t.maxElementsPerDispatch,this.maxResidentBytes=t.maxResidentBytes??536870912,this.residentTerminals=t.deviceInstances===!0?dt:[],this.acceptDerivedSpecs=c(t)}get pipelineCacheSize(){return this.pipelines.size}get poolStats(){return this.pool.stats}dispose(){this.pool.dispose()}chunkElements(e){let t=Xe*e.workgroupSize,n=Math.min(this.maxElementsPerDispatch??t,t);return Math.max(e.workgroupSize,Math.floor(n/e.workgroupSize)*e.workgroupSize)}resolveField(e,t,n){let i=r(e,this.acceptDerivedSpecs);if(i===void 0)return ht(n,a(e));let o=t.geo.attrs[t.domain],s={},c=[];for(let e of o.names().sort()){let t=o.get(e);t!==void 0&&(s[e]={type:t.type,tupleSize:t.tupleSize},c.push(`${JSON.stringify(e)}:${t.type}x${t.tupleSize}`))}let l=`${e.key.length}#${e.key}|${c.join(`,`)}`,u=this.kernels.get(l);if(u===void 0){try{u=ke(i,{attributes:s})}catch(e){u=e instanceof Error?e:Error(String(e))}this.kernels.set(l,u)}if(u instanceof Error)return ht(n,`compile-error`);if(u.inputs.length+1>8)return ht(n,`too-many-buffers`);let d=o.count;if(d===0)return Promise.resolve({data:new pt[u.outType](0),tupleSize:u.outTupleSize});let f=this.getPipeline(u.key,u.wgsl,u.entryPoint,n);return n!==void 0&&n.dispatches++,this.dispatch(e,t,u,f,d)}getPipeline(e,t,n,r){let i=this.pipelines.get(e);if(i!==void 0)return r!==void 0&&r.pipelineCacheHits++,i;let a=this.device.createShaderModule({code:t}),o=this.device.createComputePipeline({layout:`auto`,compute:{module:a,entryPoint:n}});return this.pipelines.set(e,o),r!==void 0&&r.pipelinesCompiled++,o}planRun(e,t,n){let r=at(e,t,this.maxResidentBytes,this.acceptDerivedSpecs);return`plan`in r?r.plan:(n!==void 0&&(n.fallbacks[r.reason]=(n.fallbacks[r.reason]??0)+1),null)}executeRun(e,t,n){let r=$e(e);return r===null?Promise.reject(Error(`GpuFieldEvaluator.executeRun: plan was not produced by this library's planRun; pass the object returned by planRun on the same resolver`)):ct({device:this.device,pool:this.pool,maxElementsPerDispatch:this.maxElementsPerDispatch,getPipeline:(e,t,n,r)=>this.getPipeline(e,t,n,r)},r,t,n)}async dispatch(e,t,n,r,i){let a=this.device,o=[],s=(e,t)=>{let n=this.pool.acquire(e,t);return o.push(n),n};try{let e=this.chunkElements(n),o=Math.ceil(i/e),c=[],l=t.geo.attrs[t.domain];for(let e of n.inputs){let t=l.require(e.name),n=i*e.tupleSize,r;if(t.data instanceof Uint8Array){let e=new Uint32Array(n);for(let r=0;r<n;r++)e[r]=t.data[r];r=e}else r=t.data.subarray(0,n);let o=s(n*4,K.STORAGE|K.COPY_DST);a.queue.writeBuffer(o,0,r),c.push({binding:e.binding,resource:{buffer:o}})}let u=i*n.outTupleSize*4,d=s(u,K.STORAGE|K.COPY_SRC);c.push({binding:n.bindings.output,resource:{buffer:d}});let f=s(u,K.COPY_DST|K.MAP_READ),p=[];for(let l=0;l<o;l++){let o=s(12,K.UNIFORM|K.COPY_DST);a.queue.writeBuffer(o,0,new Uint32Array([i,t.seed>>>0,l*e])),p.push(a.createBindGroup({layout:r.getBindGroupLayout(0),entries:[{binding:n.bindings.uniforms,resource:{buffer:o}},...c]}))}let m=a.createCommandEncoder(),h=m.beginComputePass();h.setPipeline(r);for(let t=0;t<o;t++){let r=Math.min(e,i-t*e);h.setBindGroup(0,p[t]),h.dispatchWorkgroups(Math.ceil(r/n.workgroupSize))}h.end(),m.copyBufferToBuffer(d,0,f,0,u),a.queue.submit([m.finish()]),await f.mapAsync(Ae.READ,0,u);let g;try{g=f.getMappedRange(0,u).slice(0)}finally{f.unmap()}return{data:new ft[n.outType](g),tupleSize:n.outTupleSize}}catch(n){throw Error(`GpuFieldEvaluator: dispatch failed for field ${e.key} (${i} elements on the ${t.domain} domain): ${n instanceof Error?n.message:String(n)}`,{cause:n})}finally{for(let e of o)this.pool.release(e)}}};export{gt as t};