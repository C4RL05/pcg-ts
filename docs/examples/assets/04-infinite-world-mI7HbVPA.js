import{A as e,Ai as t,Bi as n,Br as r,Di as i,H as a,Hr as ee,Ii as te,Ir as ne,K as o,Ot as s,Ri as c,Rr as re,Rt as l,Si as ie,U as ae,Ui as oe,Ur as se,Vi as ce,Xr as le,Zr as ue,ci as de,fi as u,pi as fe,qr as pe,t as d,ta as f,yt as p}from"./fps-AzBzSqg2.js";import{t as m}from"./worldBinding-60rVrBK5.js";import{t as h}from"./overlay-DGfJn5rn.js";import{t as me}from"./scene-DI8tK07W.js";import{t as he}from"./gpu-C5yqbq_M.js";var ge=.35,_e=777;function ve(){let e=new de,t=e.add(le,{count:170,boundsMin:[-800,0,-800],boundsMax:[800,0,800]}),i=e.add(r,{name:`scale`,tupleSize:3,value:(()=>{let e=c(oe(`mega`),0,1,5,13);return n(e,te(e,1.6),e)})()}),a=e.add(re,{assetId:`megarock`});return e.connect(t,`out`,i,`in`),e.connect(i,`out`,a,`in`),e.output(a,`instances`,`instances`),{name:`landmarks`,cellSize:`unbounded`,generationRadius:1/0,graph:e,bind(e,n){e.setParam(t,`seed`,n.seed),e.setParam(i,`seed`,f(n.seed,9))}}}function ye(e){let{cellSize:i,generationRadius:a,anchored:ne}=e,o=e.halo?4:0,s=new de,l=ne?s.add(ue,{density:ge,cellSize:7,latticeMode:`xz`,height:0}):s.add(le,{count:Math.round(ge*(i+2*o)**2)}),ae=s.add(r,{name:`density`,tupleSize:1,value:c(fe(ie,{seed:_e,frequency:.02,octaves:3}),-1,1,0,1)}),u=s.add(se,{mode:`probabilistic`}),d=s.add(pe,{radius:4,countAttr:`nbrCount`}),p=s.add(ee,{mode:`inside`}),m=s.add(r,{name:`scale`,tupleSize:3,value:(()=>{let e=c(t(ce(`nbrCount`),2,16),2,16,.4,1.35),r=te(e,c(oe(`rock`),0,1,.85,1.15));return n(r,r,r)})()}),h=s.add(re,{assetId:`rock`});return s.connect(l,`out`,ae,`in`),s.connect(ae,`out`,u,`in`),s.connect(u,`out`,d,`in`),s.connect(d,`out`,p,`in`),s.connect(p,`out`,m,`in`),s.connect(m,`out`,h,`in`),s.output(h,`instances`,`instances`),{name:`rocks`,cellSize:i,generationRadius:a,graph:s,bind(e,t){e.setParam(l,`boundsMin`,[t.min[0]-o,0,t.min[1]-o]),e.setParam(l,`boundsMax`,[t.max[0]+o,0,t.max[1]+o]);let n=ne?t.worldSeed:t.seed;e.setParam(l,`seed`,n),e.setParam(u,`seed`,f(n,1)),e.setParam(m,`seed`,f(n,2)),e.setParam(p,`boundsMin`,[t.min[0],-1,t.min[1]]),e.setParam(p,`boundsMax`,[t.max[0],1,t.max[1]])}}}function be(e){return e instanceof Error?e.message:String(e)}function xe(e){let t=(e?.description??``)===``?e?.device:e?.description;return[e?.vendor,e?.architecture,t].filter(e=>typeof e==`string`&&e!==``).join(` · `)||`adapter (no info exposed)`}async function Se(e){let t=navigator.gpu;if(t===void 0)return{error:`navigator.gpu is missing — this browser has no WebGPU.`};try{let n=await t.requestAdapter();if(n===null)return{error:`navigator.gpu.requestAdapter() returned null — no compatible GPU adapter.`};let r=n.info,i=await n.requestDevice(),a=i.lost;return a!==void 0&&a.then(t=>{e(`${t?.reason??`unknown`}: ${t?.message??`no detail`}`)}),{device:i,info:r,label:xe(r)}}catch(e){return{error:`requestDevice() failed: ${be(e)}`}}}function Ce(e){let t=e.info===void 0?{}:{adapterInfo:e.info};return{derived:new he(e.device,{...t,acceptDerivedSpecs:!0}),strict:new he(e.device,t)}}var we=class{cacheSalt;residentTerminals;acceptDerivedSpecs;base;seen=new Set;constructor(e){this.base=e,this.cacheSalt=e.cacheSalt,this.residentTerminals=e.residentTerminals,this.acceptDerivedSpecs=e.acceptDerivedSpecs}resolveField(e,t,n){return n!==void 0&&this.seen.add(n),this.base.resolveField(e,t,n)}planRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.planRun(e,t,n)}executeRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.executeRun(e,t,n)}drain(){if(this.seen.size===0)return;let e=i();for(let t of this.seen){e.dispatches+=t.dispatches,e.pipelinesCompiled+=t.pipelinesCompiled,e.pipelineCacheHits+=t.pipelineCacheHits,e.residentRuns+=t.residentRuns,e.fusedNodes+=t.fusedNodes,e.readbacksSaved+=t.readbacksSaved;for(let[n,r]of Object.entries(t.fallbacks))e.fallbacks[n]=(e.fallbacks[n]??0)+r}return this.seen.clear(),e}};function Te(e){let t=Object.entries(e).sort(([e],[t])=>e.localeCompare(t));return t.length===0?`none`:t.map(([e,t])=>`${e} ×${t}`).join(`, `)}var g=1,_=18,v=140,y=`gpu`,b=!0,x=20,S=!0,C=!0,w=!0,Ee=7,De=12,Oe=8,ke=5e3;function Ae(e){return e instanceof Error?e.message:String(e)}var{scene:T,camera:E,start:je}=me({cameraPosition:[0,26,0],orbit:!1,fog:{near:140,far:640},far:1600}),Me=new p(new l(4e3,4e3),new s({color:1449515,roughness:1}));Me.rotation.x=-Math.PI/2,Me.position.y=-.03,T.add(Me);var Ne=40,D;function Pe(){D&&(T.remove(D),D.geometry.dispose(),D.material.dispose());let e=new a(x*Ne,Ne,4158656,2903936),t=e.material;t.transparent=!0,t.opacity=.45,t.depthWrite=!1,e.position.y=.02,e.visible=w,T.add(e),D=e}function Fe(){!D||!D.visible||(D.position.x=Math.round(E.position.x/x)*x,D.position.z=Math.round(E.position.z/x)*x)}var Ie=new s({color:8028816,roughness:.95,flatShading:!0}),Le=new s({color:6121077,roughness:1,flatShading:!0}),Re={megarock:{geometry:new e(1).translate(0,.62,0),material:Le},rock:{geometry:new o(.55).translate(0,.33,0),material:Ie}},O,ze,k=`requesting…`,A,j=!1,Be=``,M;function N(){return O!==void 0&&!j}function Ve(){if(!(y===`cpu`||!N()))return b?O:ze}function He(e,t){let n=e*1.25/t+1.5;return Math.max(256,Math.ceil(Math.PI*n*n))}function Ue(e){let t=0;for(let n of Object.keys(e))for(let r of e[n])if(r.kind===`instances`)for(let e of r.batches)t+=e.count;return t}var P,F=0,I,We=0,L=!1,Ge=0;function R(){P&&(P.disposed=!0,P.abort.abort(),P.binding.dispose(),T.remove(P.group));let e=new ae;T.add(e);let t=new m({group:e,assets:Re}),n=new Map,r=Ve(),i={world:void 0,group:e,binding:t,cellInstances:n,tap:r===void 0?void 0:new we(r),abort:new AbortController,disposed:!1};i.world=new ne({seed:g,levels:[ve(),ye({cellSize:x,generationRadius:v,anchored:S,halo:C})],maxCellsPerLevel:He(v,x),...i.tap===void 0?{}:{gpu:i.tap},onCellReady:(e,r,a)=>{i.disposed||(t.cellReady(e,r,a),n.set(`${e}|${r[0]},${r[1]}`,Ue(a)))},onCellEvicted:(e,r)=>{i.disposed||(t.cellEvicted(e,r),n.delete(`${e}|${r[0]},${r[1]}`))}}),P=i,F=0,M=void 0,I=void 0,dt(),Ke(i,De)}function Ke(e,t){let n=++Ge;$=!0,We=performance.now(),e.world.update([E.position.x,0,E.position.z],{budgetMs:t,maxCooksPerUpdate:Oe,signal:e.abort.signal,...e.tap===void 0?{}:{gpu:e.tap}}).then(t=>{if(e.disposed)return;F=t.pending,I=t.elapsedMs;let n=e.tap?.drain();n!==void 0&&(M=n),dt(),L&&(L=!1,Z(ut()))}).catch(t=>{t instanceof u||(console.error(t),e.disposed||Z(`update failed: ${Ae(t)}`))}).finally(()=>{n===Ge&&($=!1)})}var z=0,qe=0,B=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(t===`g`){J(y===`gpu`?`cpu`:`gpu`);return}B.add(t)}),window.addEventListener(`keyup`,e=>B.delete(e.key.toLowerCase())),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&(We=performance.now())});var V=h({title:`04 · infinite world`,info:`Unbounded landmark level + world-anchored rock cells streamed around a flying camera. Steer with A/D or arrow keys.`}),Je=document.createElement(`style`);Je.textContent=`
