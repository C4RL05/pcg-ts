...
**Node types:** `connectPoints`, `copyToPoints`, `filterByAttribute`, `filterByDensity`, `forEach`, `jitterPoints`, `mergePoints`, `orientAlongVector`, `partitionByAttribute`, `pathPointAt`, `pathResample`, `pathSegments`, `pointLine`, `pointsToPath`, `setAttribute`, `spawnInstances`, `subgraph`, `transferAttribute`, `transformPoints`, `writeCurveFrame`
