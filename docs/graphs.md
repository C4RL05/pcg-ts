...
**Node types:** `connectPoints`, `copyToPoints`, `filterByAttribute`, `filterByDensity`, `filterPrimitivesByAttribute`, `forEach`, `jitterPoints`, `mergePoints`, `orientAlongVector`, `partitionByAttribute`, `pathPointAt`, `pathResample`, `pathSegments`, `pointLine`, `pointsToPath`, `setAttribute`, `spawnInstances`, `subgraph`, `sweepProfile`, `transferAttribute`, `transformPoints`, `writeCurveFrame`
