import{$n as e,$r as t,Gn as n,Qn as r,Vn as i,Vt as a,Xr as o,Zn as s,Zr as c,ai as l,ar as u,ci as d,cr as f,di as p,ei as m,er as h,fi as g,ii as _,ir as v,li as y,lr as b,mi as x,mr as S,nr as C,oi as w,pi as T,ri as E,si as D,sr as O,ti as k,tr as ee,ui as te}from"./wordmark-El-7dZE6.js";var A=class extends Error{constructor(e){super(e),this.name=`GpuCompileError`}};function j(e,t){let n=Math.fround(e);if(!Number.isFinite(n))throw new A(`${t}: value ${e} is not representable as a finite f32 (WGSL kernels compute in f32; keep magnitudes within ~3.4e38)`);return Object.is(n,-0)?`-0f`:`${String(n)}f`}function ne(e){return`${e>>>0}u`}function M(e){return`0x${(e>>>0).toString(16).padStart(8,`0`)}u`}var N=M,re=j(34028234663852886e22,`internal f32 max`);function ie(e,t){let n=N(e);for(let e of t)n=`pcg_hash_mix(${n}, ${e})`;return`pcg_hash_finalize(${n})`}function ae(){let e=[];for(let t=0;t<12;t++){let n=e=>j(O[t*3+e],`internal GRAD3`);e.push(`  vec3<f32>(${n(0)}, ${n(1)}, ${n(2)}),`)}return`var<private> PCG_GRAD3: array<vec3<f32>, 12> = array<vec3<f32>, 12>(
${e.join(`
`)}
  ...
  return ${P(`internal PERLIN_SCALE`)(u)} * pcg_mix(
  ...
  let t = ${P(`internal simplex R2`)(ee)} - x * x - y * y - z * z;
  if (t <= 0f) {
    return 0f;
  }
