var e=`{
  ...
  "seed": 9043,
  "meta": {
    "title": "two hundred props each pick one of five kinds, by drawing its number",
  ...
  "nodes": [
    {
      "id": "catalog",
      "type": "pointGrid",
      "params": { "countX": 5, "countY": 1, "countZ": 1, "spacing": [6, 1, 1], "origin": [0, 0, 0] }
    },
    {
      "id": "catalogTint",
      "type": "setAttribute",
      "params": {
        ...
        "value": {
          "fn": "vec",
          "args": [
            { "fn": "fract", "args": [{ "fn": "mul", "args": [{ "fn": "index" }, 0.37] }] },
            { "fn": "fract", "args": [{ "fn": "mul", "args": [{ "fn": "index" }, 0.61] }] },
            0.8
          ]
        }
      }
    },
    {
      ...
      "params": {
        ...
        "value": {
          ...
          "args": [
            0.7,
            { "fn": "add", "args": [0.8, { "fn": "mul", "args": [{ "fn": "index" }, 0.9] }] },
            0.7
          ]
        }
      }
    },
    {
      ...
      "params": { "count": 200, "boundsMin": [-30, 0, -30], "boundsMax": [30, 0, 30], "seed": 5 }
    },
    {
      "id": "pick",
      "type": "setAttribute",
      "params": {
        ...
        "value": {
          "fn": "floor",
          "args": [{ "fn": "mul", "args": [{ "fn": "randomField", "key": "pick" }, 5] }]
        }
      }
    },
    {
      ...
      "params": {
        "index": { "fn": "attribute", "name": "pick" },
        "attributes": ["color", "scale"],
        "outOfRange": "clamp"
      }
    },
    {
  ...
  "connections": [
    { "from": ["catalog", "out"], "to": ["catalogTint", "in"] },
    { "from": ["catalogTint", "out"], "to": ["catalogSize", "in"] },
    { "from": ["cloud", "out"], "to": ["pick", "in"] },
    { "from": ["pick", "out"], "to": ["join", "in"] },
    { "from": ["catalogSize", "out"], "to": ["join", "source"] },
    { "from": ["join", "out"], "to": ["spawn", "in"] }
  ],
  "outputs": [
    { "id": "catalogSize", "pin": "out", "name": "catalog" },
    { "id": "spawn", "pin": "instances", "name": "props" }
  ]
}
`;export{e as default};