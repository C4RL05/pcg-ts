import{Ar as e,D as t,Dr as n,En as r,It as i,Nr as a,Pn as o,Rt as ee,Sn as s,Vn as c,Yr as l,Zn as te,ar as ne,cn as re,jr as ie,or as u,r as d,sn as ae,ur as oe,vn as se,wr as ce,xn as le}from"./wordmark-yJ1m0gS6.js";import{t as ue}from"./types-C9vZymIy.js";import{A as f,St as p,U as de,Vt as m,W as fe,jt as h,q as g}from"./three.core-B85ZZh_6.js";import{t as pe}from"./scene-QpK-6DxV.js";import{t as me}from"./gpu-kGiLOzDK.js";import{t as he}from"./worldBinding-BIw-CqJU.js";import{n as ge,t as _e}from"./panel-BpNIhDQx.js";var ve=.35,ye=777;function be(){let t=new o,i=t.add(ae,{count:170,boundsMin:[-800,0,-800],boundsMax:[800,0,800]}),s=t.add(r,{name:`scale`,tupleSize:3,value:(()=>{let t=n(a(`mega`),0,1,5,13);return e(t,ce(t,1.6),t)})()}),c=t.add(ee,{assetId:`megarock`});return t.connect(i,`out`,s,`in`),t.connect(s,`out`,c,`in`),t.output(c,`instances`,`instances`),{name:`landmarks`,cellSize:`unbounded`,generationRadius:1/0,graph:t,bind(e,t){e.setParam(i,`seed`,t.seed),e.setParam(s,`seed`,l(t.seed,9))}}}function xe(t){let{cellSize:i,generationRadius:ne,anchored:u}=t,d=t.halo?4:0,f=new o,p=u?f.add(re,{density:ve,cellSize:7,latticeMode:`xz`,height:0}):f.add(ae,{count:Math.round(ve*(i+2*d)**2)}),de=f.add(r,{name:`density`,tupleSize:1,value:n(c(te,{seed:ye,frequency:.02,octaves:3}),-1,1,0,1)}),m=f.add(s,{mode:`probabilistic`}),fe=f.add(se,{radius:4,countAttr:`nbrCount`}),h=f.add(le,{mode:`inside`}),g=f.add(r,{name:`scale`,tupleSize:3,value:(()=>{let t=n(oe(ie(`nbrCount`),2,16),2,16,.4,1.35),r=ce(t,n(a(`rock`),0,1,.85,1.15));return e(r,r,r)})()}),pe=f.add(ee,{assetId:`rock`});return f.connect(p,`out`,de,`in`),f.connect(de,`out`,m,`in`),f.connect(m,`out`,fe,`in`),f.connect(fe,`out`,h,`in`),f.connect(h,`out`,g,`in`),f.connect(g,`out`,pe,`in`),f.output(pe,`instances`,`instances`),{name:`rocks`,cellSize:i,generationRadius:ne,graph:f,bind(e,t){let{min:n,max:r}=ue(t);e.setParam(p,`boundsMin`,[n[0]-d,0,n[1]-d]),e.setParam(p,`boundsMax`,[r[0]+d,0,r[1]+d]);let i=u?t.worldSeed:t.seed;e.setParam(p,`seed`,i),e.setParam(m,`seed`,l(i,1)),e.setParam(g,`seed`,l(i,2)),e.setParam(h,`boundsMin`,[n[0],-1,n[1]]),e.setParam(h,`boundsMax`,[r[0],1,r[1]])}}}function Se(e){return e instanceof Error?e.message:String(e)}function Ce(e){let t=(e?.description??``)===``?e?.device:e?.description;return[e?.vendor,e?.architecture,t].filter(e=>typeof e==`string`&&e!==``).join(` · `)||`adapter (no info exposed)`}async function we(e){let t=navigator.gpu;if(t===void 0)return{error:`navigator.gpu is missing — this browser has no WebGPU.`};try{let n=await t.requestAdapter();if(n===null)return{error:`navigator.gpu.requestAdapter() returned null — no compatible GPU adapter.`};let r=n.info,i=await n.requestDevice(),a=i.lost;return a!==void 0&&a.then(t=>{e(`${t?.reason??`unknown`}: ${t?.message??`no detail`}`)}),{device:i,info:r,label:Ce(r)}}catch(e){return{error:`requestDevice() failed: ${Se(e)}`}}}function Te(e){let t=e.info===void 0?{}:{adapterInfo:e.info};return{derived:new me(e.device,{...t,acceptDerivedSpecs:!0}),strict:new me(e.device,t)}}var Ee=class{cacheSalt;residentTerminals;acceptDerivedSpecs;base;seen=new Set;constructor(e){this.base=e,this.cacheSalt=e.cacheSalt,this.residentTerminals=e.residentTerminals,this.acceptDerivedSpecs=e.acceptDerivedSpecs}resolveField(e,t,n){return n!==void 0&&this.seen.add(n),this.base.resolveField(e,t,n)}planRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.planRun(e,t,n)}executeRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.executeRun(e,t,n)}drain(){if(this.seen.size===0)return;let e=u();for(let t of this.seen){e.dispatches+=t.dispatches,e.pipelinesCompiled+=t.pipelinesCompiled,e.pipelineCacheHits+=t.pipelineCacheHits,e.residentRuns+=t.residentRuns,e.fusedNodes+=t.fusedNodes,e.readbacksSaved+=t.readbacksSaved;for(let[n,r]of Object.entries(t.fallbacks))e.fallbacks[n]=(e.fallbacks[n]??0)+r}return this.seen.clear(),e}};function De(e){let t=Object.entries(e).sort(([e],[t])=>e.localeCompare(t));return t.length===0?`none`:t.map(([e,t])=>`${e} ×${t}`).join(`, `)}var _=1,v=18,y=140,b=`gpu`,x=!0,S=20,C=!0,w=!0,T=!0,Oe=7,ke=12,Ae=8,je=5e3;function Me(e){return e instanceof Error?e.message:String(e)}var{scene:E,camera:D,start:Ne}=pe({cameraPosition:[0,26,0],orbit:!1,fog:{near:140,far:640},far:1600}),O=new p(new m(4e3,4e3),new h({color:1449515,roughness:1}));O.rotation.x=-Math.PI/2,O.position.y=-.03,E.add(O);var Pe=40,k;function Fe(){k&&(E.remove(k),k.geometry.dispose(),k.material.dispose());let e=new de(S*Pe,Pe,4158656,2903936),t=e.material;t.transparent=!0,t.opacity=.45,t.depthWrite=!1,e.position.y=.02,e.visible=T,E.add(e),k=e}function Ie(){!k||!k.visible||(k.position.x=Math.round(D.position.x/S)*S,k.position.z=Math.round(D.position.z/S)*S)}var Le=new h({color:8028816,roughness:.95,flatShading:!0}),Re=new h({color:6121077,roughness:1,flatShading:!0}),ze={megarock:{geometry:new f(1).translate(0,.62,0),material:Re},rock:{geometry:new g(.55).translate(0,.33,0),material:Le}},A,Be,j=`requesting…`,M,N=!1,Ve=``,P;function F(){return A!==void 0&&!N}function He(){if(!(b===`cpu`||!F()))return x?A:Be}var I;function Ue(e,t){let n=[{name:`landmarks`,graph:e},{name:`rocks`,graph:t}];I?I.set(n):I=_e(n,{into:_t,title:`infinite world`})}function We(e,t){let n=e*1.25/t+1.5;return Math.max(256,Math.ceil(Math.PI*n*n))}function Ge(e){let t=0;for(let n of Object.keys(e))for(let r of e[n])if(r.kind===`instances`)for(let e of r.batches)t+=e.count;return t}var L,R=0,z,B=0,V=!1,Ke=0;function H(){L&&(L.disposed=!0,L.abort.abort(),L.binding.dispose(),E.remove(L.group));let e=new fe;E.add(e);let t=new he({group:e,assets:ze}),n=new Map,r=He(),a={world:void 0,group:e,binding:t,cellInstances:n,tap:r===void 0?void 0:new Ee(r),abort:new AbortController,disposed:!1},o=[be(),xe({cellSize:S,generationRadius:y,anchored:C,halo:w})];Ue(o[0].graph,o[1].graph),a.world=new i({seed:_,levels:o,maxCellsPerLevel:We(y,S),...a.tap===void 0?{}:{gpu:a.tap},onCellReady:(e,r,i)=>{a.disposed||(t.cellReady(e,r,i),n.set(`${e}|${r[0]},${r[1]}`,Ge(i)))},onCellEvicted:(e,r)=>{a.disposed||(t.cellEvicted(e,r),n.delete(`${e}|${r[0]},${r[1]}`))}}),L=a,R=0,P=void 0,z=void 0,gt(),qe(a,ke)}function qe(e,t){let n=++Ke;$=!0,B=performance.now(),e.world.update([D.position.x,0,D.position.z],{budgetMs:t,maxCooksPerUpdate:Ae,signal:e.abort.signal,...e.tap===void 0?{}:{gpu:e.tap}}).then(t=>{if(e.disposed)return;R=t.pending,z=t.elapsedMs;let n=e.tap?.drain();n!==void 0&&(P=n),gt(),V&&(V=!1,Z(ht()))}).catch(t=>{t instanceof ne||(console.error(t),e.disposed||Z(`update failed: ${Me(t)}`))}).finally(()=>{n===Ke&&($=!1)})}var U=0,Je=0,W=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(t===`g`){tt(b===`gpu`?`cpu`:`gpu`);return}W.add(t)}),window.addEventListener(`keyup`,e=>W.delete(e.key.toLowerCase())),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&(B=performance.now())});var G=ge({title:`infinite world`,info:`Unbounded landmark level + world-anchored rock cells streamed around a flying camera. Steer with A/D or arrow keys.`}),Ye=document.createElement(`style`);Ye.textContent=`
