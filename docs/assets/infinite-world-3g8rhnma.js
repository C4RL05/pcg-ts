import{D as e,En as t,It as n,Mr as r,Nn as i,Qn as a,Rt as o,Un as ee,Zn as s,cr as te,dr as c,fn as ne,gn as re,gr as ie,hn as ae,in as oe,mr as se,pr as ce,r as l,rn as le,tr as ue,vn as u}from"./wordmark-IB04M5C6.js";import{A as d,St as f,U as p,Vt as m,W as h,jt as g,q as _}from"./three.core-B85ZZh_6.js";import{t as v}from"./scene-QpK-6DxV.js";import{n as de}from"./debug-xg-_BCf-.js";import{t as fe}from"./worldBinding-kZg9FLL7.js";import{n as pe,t as me}from"./panel-sdn9Hce8.js";var he=.35,ge=777;function _e(){let e=new t,n=e.add(le,{count:170,boundsMin:[-800,0,-800],boundsMax:[800,0,800]}),i=e.add(u,{name:`scale`,tupleSize:3,value:(()=>{let e=c(ie(`mega`),0,1,5,13);return ce(e,te(e,1.6),e)})()}),a=e.add(o,{assetId:`megarock`});return e.connect(n,`out`,i,`in`),e.connect(i,`out`,a,`in`),e.output(a,`instances`,`instances`),{name:`landmarks`,cellSize:`unbounded`,generationRadius:1/0,graph:e,bind(e,t){e.setParam(n,`seed`,t.seed),e.setParam(i,`seed`,r(t.seed,9))}}}function ve(e){let{cellSize:n,generationRadius:a,anchored:s}=e,l=e.halo?4:0,d=new t,f=s?d.add(oe,{density:he,cellSize:7,latticeMode:`xz`,height:0}):d.add(le,{count:Math.round(he*(n+2*l)**2)}),p=d.add(u,{name:`density`,tupleSize:1,value:c(i(ee,{seed:ge,frequency:.02,octaves:3}),-1,1,0,1)}),m=d.add(re,{mode:`probabilistic`}),h=d.add(ne,{radius:4,countAttr:`nbrCount`}),g=d.add(ae,{mode:`inside`}),_=d.add(u,{name:`scale`,tupleSize:3,value:(()=>{let e=c(ue(se(`nbrCount`),2,16),2,16,.4,1.35),t=te(e,c(ie(`rock`),0,1,.85,1.15));return ce(t,t,t)})()}),v=d.add(o,{assetId:`rock`});return d.connect(f,`out`,p,`in`),d.connect(p,`out`,m,`in`),d.connect(m,`out`,h,`in`),d.connect(h,`out`,g,`in`),d.connect(g,`out`,_,`in`),d.connect(_,`out`,v,`in`),d.output(v,`instances`,`instances`),{name:`rocks`,cellSize:n,generationRadius:a,graph:d,bind(e,t){e.setParam(f,`boundsMin`,[t.min[0]-l,0,t.min[1]-l]),e.setParam(f,`boundsMax`,[t.max[0]+l,0,t.max[1]+l]);let n=s?t.worldSeed:t.seed;e.setParam(f,`seed`,n),e.setParam(m,`seed`,r(n,1)),e.setParam(_,`seed`,r(n,2)),e.setParam(g,`boundsMin`,[t.min[0],-1,t.min[1]]),e.setParam(g,`boundsMax`,[t.max[0],1,t.max[1]])}}}function ye(e){return e instanceof Error?e.message:String(e)}function be(e){let t=(e?.description??``)===``?e?.device:e?.description;return[e?.vendor,e?.architecture,t].filter(e=>typeof e==`string`&&e!==``).join(` · `)||`adapter (no info exposed)`}async function xe(e){let t=navigator.gpu;if(t===void 0)return{error:`navigator.gpu is missing — this browser has no WebGPU.`};try{let n=await t.requestAdapter();if(n===null)return{error:`navigator.gpu.requestAdapter() returned null — no compatible GPU adapter.`};let r=n.info,i=await n.requestDevice(),a=i.lost;return a!==void 0&&a.then(t=>{e(`${t?.reason??`unknown`}: ${t?.message??`no detail`}`)}),{device:i,info:r,label:be(r)}}catch(e){return{error:`requestDevice() failed: ${ye(e)}`}}}function Se(e){let t=e.info===void 0?{}:{adapterInfo:e.info};return{derived:new de(e.device,{...t,acceptDerivedSpecs:!0}),strict:new de(e.device,t)}}var Ce=class{cacheSalt;residentTerminals;acceptDerivedSpecs;base;seen=new Set;constructor(e){this.base=e,this.cacheSalt=e.cacheSalt,this.residentTerminals=e.residentTerminals,this.acceptDerivedSpecs=e.acceptDerivedSpecs}resolveField(e,t,n){return n!==void 0&&this.seen.add(n),this.base.resolveField(e,t,n)}planRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.planRun(e,t,n)}executeRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.executeRun(e,t,n)}drain(){if(this.seen.size===0)return;let e=a();for(let t of this.seen){e.dispatches+=t.dispatches,e.pipelinesCompiled+=t.pipelinesCompiled,e.pipelineCacheHits+=t.pipelineCacheHits,e.residentRuns+=t.residentRuns,e.fusedNodes+=t.fusedNodes,e.readbacksSaved+=t.readbacksSaved;for(let[n,r]of Object.entries(t.fallbacks))e.fallbacks[n]=(e.fallbacks[n]??0)+r}return this.seen.clear(),e}};function we(e){let t=Object.entries(e).sort(([e],[t])=>e.localeCompare(t));return t.length===0?`none`:t.map(([e,t])=>`${e} ×${t}`).join(`, `)}var Te=1,y=18,b=140,x=`gpu`,S=!0,C=20,w=!0,T=!0,E=!0,Ee=7,De=12,Oe=8,ke=5e3;function Ae(e){return e instanceof Error?e.message:String(e)}var{scene:D,camera:O,start:je}=v({cameraPosition:[0,26,0],orbit:!1,fog:{near:140,far:640},far:1600}),k=new f(new m(4e3,4e3),new g({color:1449515,roughness:1}));k.rotation.x=-Math.PI/2,k.position.y=-.03,D.add(k);var Me=40,A;function Ne(){A&&(D.remove(A),A.geometry.dispose(),A.material.dispose());let e=new p(C*Me,Me,4158656,2903936),t=e.material;t.transparent=!0,t.opacity=.45,t.depthWrite=!1,e.position.y=.02,e.visible=E,D.add(e),A=e}function Pe(){!A||!A.visible||(A.position.x=Math.round(O.position.x/C)*C,A.position.z=Math.round(O.position.z/C)*C)}var Fe=new g({color:8028816,roughness:.95,flatShading:!0}),Ie=new g({color:6121077,roughness:1,flatShading:!0}),Le={megarock:{geometry:new d(1).translate(0,.62,0),material:Ie},rock:{geometry:new _(.55).translate(0,.33,0),material:Fe}},j,Re,M=`requesting…`,N,P=!1,ze=``,F;function I(){return j!==void 0&&!P}function Be(){if(!(x===`cpu`||!I()))return S?j:Re}var L;function Ve(e,t){let n=[{name:`landmarks`,graph:e},{name:`rocks`,graph:t}];L?L.set(n):L=me(n,{into:gt,title:`infinite world`})}function He(e,t){let n=e*1.25/t+1.5;return Math.max(256,Math.ceil(Math.PI*n*n))}function Ue(e){let t=0;for(let n of Object.keys(e))for(let r of e[n])if(r.kind===`instances`)for(let e of r.batches)t+=e.count;return t}var R,We=0,z,Ge=0,B=!1,Ke=0;function V(){R&&(R.disposed=!0,R.abort.abort(),R.binding.dispose(),D.remove(R.group));let e=new h;D.add(e);let t=new fe({group:e,assets:Le}),r=new Map,i=Be(),a={world:void 0,group:e,binding:t,cellInstances:r,tap:i===void 0?void 0:new Ce(i),abort:new AbortController,disposed:!1},o=[_e(),ve({cellSize:C,generationRadius:b,anchored:w,halo:T})];Ve(o[0].graph,o[1].graph),a.world=new n({seed:Te,levels:o,maxCellsPerLevel:He(b,C),...a.tap===void 0?{}:{gpu:a.tap},onCellReady:(e,n,i)=>{a.disposed||(t.cellReady(e,n,i),r.set(`${e}|${n[0]},${n[1]}`,Ue(i)))},onCellEvicted:(e,n)=>{a.disposed||(t.cellEvicted(e,n),r.delete(`${e}|${n[0]},${n[1]}`))}}),R=a,We=0,F=void 0,z=void 0,Q(),qe(a,De)}function qe(e,t){let n=++Ke;$=!0,Ge=performance.now(),e.world.update([O.position.x,0,O.position.z],{budgetMs:t,maxCooksPerUpdate:Oe,signal:e.abort.signal,...e.tap===void 0?{}:{gpu:e.tap}}).then(t=>{if(e.disposed)return;We=t.pending,z=t.elapsedMs;let n=e.tap?.drain();n!==void 0&&(F=n),Q(),B&&(B=!1,X(ht()))}).catch(t=>{t instanceof s||(console.error(t),e.disposed||X(`update failed: ${Ae(t)}`))}).finally(()=>{n===Ke&&($=!1)})}var H=0,Je=0,U=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(t===`g`){tt(x===`gpu`?`cpu`:`gpu`);return}U.add(t)}),window.addEventListener(`keyup`,e=>U.delete(e.key.toLowerCase())),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&(Ge=performance.now())});var W=pe({title:`infinite world`,info:`Unbounded landmark level + world-anchored rock cells streamed around a flying camera. Steer with A/D or arrow keys.`}),Ye=document.createElement(`style`);Ye.textContent=`
