import{$n as e,Ht as t,Si as n,Sr as r,Un as i,_i as a,ai as o,bi as s,br as c,ci as l,di as u,dr as d,er as f,fi as p,gi as m,hi as h,ii as g,ir as _,li as v,lr as y,mi as b,nr as x,or as S,pi as C,pr as ee,qn as w,rr as T,si as te,sr as E,tr as ne,ur as D,vi as O,vr as k,xi as A,yi as j}from"./wordmark-1f_kjN-C.js";var M=class extends Error{constructor(e){super(e),this.name=`GpuCompileError`}};function N(e,t){let n=Math.fround(e);if(!Number.isFinite(n))throw new M(`${t}: value ${e} is not representable as a finite f32 (WGSL kernels compute in f32; keep magnitudes within ~3.4e38)`);return Object.is(n,-0)?`-0f`:`${String(n)}f`}function re(e){return`${e>>>0}u`}function P(e){return`0x${(e>>>0).toString(16).padStart(8,`0`)}u`}var F=P,ie=N(34028234663852886e22,`internal f32 max`);function ae(e,t){let n=F(e);for(let e of t)n=`pcg_hash_mix(${n}, ${e})`;return`pcg_hash_finalize(${n})`}function oe(){let e=[];for(let t=0;t<12;t++){let n=e=>N(y[t*3+e],`internal GRAD3`);e.push(`  vec3<f32>(${n(0)}, ${n(1)}, ${n(2)}),`)}return`var<private> PCG_GRAD3: array<vec3<f32>, 12> = array<vec3<f32>, 12>(
${e.join(`
`)}
  ...
  return ${I(`internal PERLIN_SCALE`)(E)} * pcg_mix(
  ...
  let t = ${I(`internal simplex R2`)(T)} - x * x - y * y - z * z;
  if (t <= 0f) {
    return 0f;
  }
  ...
  let s = (p.x + p.y + p.z) * ${I(`internal simplex F3`)(ne)};
  let i = i32(floor(p.x + s));
  let j = i32(floor(p.y + s));
  let k = i32(floor(p.z + s));
  let t = f32(i + j + k) * ${I(`internal simplex G3`)(x)};
  let x0 = p.x - (f32(i) - t);
  let y0 = p.y - (f32(j) - t);
  let z0 = p.z - (f32(k) - t);
  var i1: i32;
  ...
  let x1 = x0 - f32(i1) + ${I(`internal simplex G3`)(x)};
  let y1 = y0 - f32(j1) + ${I(`internal simplex G3`)(x)};
  let z1 = z0 - f32(k1) + ${I(`internal simplex G3`)(x)};
  let x2 = x0 - f32(i2) + ${I(`internal simplex 2*G3`)(2*x)};
  let y2 = y0 - f32(j2) + ${I(`internal simplex 2*G3`)(2*x)};
  let z2 = z0 - f32(k2) + ${I(`internal simplex 2*G3`)(2*x)};
  let x3 = x0 - 1f + ${I(`internal simplex 3*G3`)(3*x)};
  let y3 = y0 - 1f + ${I(`internal simplex 3*G3`)(3*x)};
  let z3 = z0 - 1f + ${I(`internal simplex 3*G3`)(3*x)};
...
${`literal`in f?``:`  let ns = ${f.expr};\n`}  var seeds = array<u32, ${a}>(${g.join(`, `)});
  ...
  return sum;
}`,w=n.helper(`fbm`,ee),T=n.emit(`${w}(${m.ref})`,1);if(i.normalized!==!0)return T;if(!(S>x))throw new M(`${t}: fbm: normalized: true needs a non-degenerate output range, got [${x}, ${S}] for this octaves/gain configuration`);return Ye(n,T,[x,S],`${t}.opts.normalized`)});var Qe=new Set([`valueNoise`,`perlinNoise`,`simplexNoise`,`worleyNoise`,`fbm`]);function Z(e,t){if(!V(e))return;let n=e.fn;if(n===`param`){let n=l(e);n!==void 0&&Z(n,t);return}if(n===`attribute`||n===`attributeIs`){typeof e.name==`string`&&t.add(e.name);return}if(n===`byAttribute`){typeof e.name==`string`&&t.add(e.name);for(let n of u(e))Z(n,t);return}if(n===`position`){t.add(`P`);return}if(n===`randomField`){t.add(`P`),t.add(`seed`);return}if(typeof n==`string`&&Qe.has(n)){let n=e.opts;V(n)&&n.position!==void 0?Z(n.position,t):t.add(`P`);return}let r=e.args;if(Array.isArray(r))for(let e of r)Z(e,t)}var $e=16;function et(e,t){return`${JSON.stringify(e)},${JSON.stringify(t)}`}var tt={names:[],slots:new Map,arities:[],attrIs:[],attrIsSlots:new Map};function nt(e){return typeof e==`number`?1:e.length}function rt(e,t){if(V(e)){if(t(e),e.fn===`param`){let n=l(e);n!==void 0&&rt(n,t);return}for(let n of u(e))rt(n,t)}}function it(e){let t=ot.get(e);if(t!==void 0)return t;let n=st.get(e);if(n!==void 0)throw n;try{let t=at(e);return ot.set(e,t),t}catch(t){throw t instanceof M&&st.set(e,t),t}}function at(e){let t=new Map,n=new Set,r=new Map;if(rt(e,e=>{if(e.fn===`attributeIs`){if(typeof e.name!=`string`||e.name===``||typeof e.value!=`string`)return;r.set(et(e.name,e.value),{attr:e.name,value:e.value});return}if(e.fn===`byAttribute`){if(typeof e.name!=`string`||e.name===``||!V(e.cases))return;for(let t of Object.keys(e.cases))r.set(et(e.name,t),{attr:e.name,value:t});return}if(e.fn!==`param`||typeof e.name!=`string`||e.name===``)return;let i=e.name;if(l(e)!==void 0)return;if(te(e))throw new M(`param ${JSON.stringify(i)} is bound to a Field that carries no spec (a makeField closure, or something composed over one), so there is nothing to compile in its place; this expression evaluates on the CPU — build the bound field with the grammar constructors or fieldFromJson if it should lower`);n.add(i);let a=v(e);if(a===void 0)return;let o=nt(a);if(o>4)throw new M(`param ${JSON.stringify(i)} is bound to a ${o}-tuple, but a uniform slot holds 4 components; bind a tuple of 1 to 4, or evaluate this field on the CPU`);let s=t.get(i);if(s!==void 0&&s!==o)throw new M(`param ${JSON.stringify(i)} is bound to a ${s}-tuple in one place and a ${o}-tuple in another within the same expression; one uniform slot serves the name, so both references must have the same arity`);t.set(i,o)}),n.size===0&&r.size===0)return tt;let i=[...n].sort(),a=[...r.keys()].sort(),o=i.length+a.length;if(o>$e)throw new M(`this field needs ${o} uniform constant slots (${i.length} distinct params and ${a.length} distinct string literals across its attributeIs tests and byAttribute case keys), but a kernel carries at most ${$e}; split the expression, or evaluate it on the CPU (raise MAX_FIELD_CONST_SLOTS in compile.ts if an expression legitimately needs more)`);return{names:i,slots:new Map(i.map((e,t)=>[e,t])),arities:i.map(e=>t.get(e)??1),attrIs:a.map(e=>r.get(e)),attrIsSlots:new Map(a.map((e,t)=>[e,i.length+t]))}}var ot=new WeakMap,st=new WeakMap,ct=new WeakMap;function lt(e){let t=``;return e.names.length>0&&(t+=`|params=[${e.names.map((t,n)=>`${JSON.stringify(t)}:${e.arities[n]}`).join(`,`)}]`),e.attrIs.length>0&&(t+=`|attrIs=[${e.attrIs.map(e=>et(e.attr,e.value)).join(`;`)}]`),t}function ut(e,t){let n=it(e);if(n.names.length===0&&n.attrIs.length===0)return t;let r=ct.get(e);if(r!==void 0)return r;let i=`${w(e).key}${lt(n)}`;return ct.set(e,i),i}function dt(e,t){return e.length===t.length&&e.every((e,n)=>Object.is(e,t[n]))}function ft(e,t){return t.constSlots===0?{values:[]}:t.attrIsSlots.length>0?{problem:`this kernel carries ${t.attrIsSlots.length} string-literal slot(s) (${t.attrIsSlots.map(e=>`${JSON.stringify(e.attr)} == ${JSON.stringify(e.value)}`).join(`, `)}) whose values are string-table indices of the geometry being cooked; fill them with constSlotValues, which takes that geometry's attribute set`}:pt(e,t)}function pt(e,t){let n=new Map,r;if(rt(e,e=>{if(e.fn!==`param`||typeof e.name!=`string`||e.name===``)return;let t=e.name;if(l(e)!==void 0)return;let i=v(e);if(i===void 0){r??=`param ${JSON.stringify(t)} has no bound value`;return}let a=typeof i==`number`?[i]:[...i],o=n.get(t);o===void 0?n.set(t,a):dt(o,a)||(r??=`param ${JSON.stringify(t)} is bound to two different values in one expression`)}),r!==void 0)return{problem:r};let i=[];for(let e of t.paramNames){let t=n.get(e);if(t===void 0)return{problem:`param ${JSON.stringify(e)} is not referenced by this spec`};for(let e=0;e<4;e++)i.push(e<t.length?t[e]:0)}return{values:i}}var mt=-1;function ht(e,t,n){if(t.constSlots===0)return{values:[]};let r=pt(e,t);if(`problem`in r||t.attrIsSlots.length===0)return r;let i=[...r.values];for(let e of t.attrIsSlots){let t=n.get(e.attr);if(t===void 0||t.type!==`string`)return{problem:`attributeIs ${JSON.stringify(e.attr)}: this geometry has no string attribute of that name (${t===void 0?`no such attribute`:`it is ${t.type}`}), so the literal has no index to resolve to`};let r=t.lookupString(e.value)??mt;for(let e=0;e<4;e++)i.push(e===0?r:0)}return{values:i}}var gt=new Set([`f32`,`i32`,`u32`,`bool`,`string`]);function _t(e){if(!V(e)||!V(e.attributes))throw new M(`compileFieldSpec: layout must be { attributes: { name: { type, tupleSize } } }`);for(let[t,n]of Object.entries(e.attributes)){if(!V(n)||!gt.has(n.type))throw new M(`kernel layout attribute ${JSON.stringify(t)}: unknown type ${JSON.stringify(n?.type)}; valid types: "f32", "i32", "u32", "bool", "string" (a string column binds as u32 and is readable only through attributeIs)`);let e=n.tupleSize;if(typeof e!=`number`||!Number.isInteger(e)||e<1)throw new M(`kernel layout attribute ${JSON.stringify(t)}: tupleSize must be a positive integer, got ${String(e)}`)}}function vt(e){return typeof e==`number`?{fn:`constant`,value:e}:Array.isArray(e)?{fn:`constant`,value:[...e]}:e}function yt(e){return e.type===`bool`||e.type===`string`?`u32`:e.type}function bt(e,t){_t(t);let n=vt(e),r=w(n),i=new Set;Z(n,i);let a=[...i].filter(e=>Object.hasOwn(t.attributes,e)).sort(),o=it(n),s=new ke(t,a,o),c=`f32`,l=0,u=[],d=e=>{if(l=e.size,e.size===1)u.push(`  outBuf[i] = ${e.ref};`);else for(let t=0;t<e.size;t++)u.push(`  outBuf[${K(e.size,t)}] = ${e.ref}.${De[t]};`)},f=n.fn===`attribute`?n.name:n.fn===`position`?`P`:void 0;if(n.fn===`index`)c=`u32`,l=1,u.push(`  outBuf[i] = i;`);else if(f!==void 0){let e=Me(s,`$`,f,n.fn===`position`?3:n.tupleSize,n.fn===`position`?`position reads `:``);if(e.type===`i32`||e.type===`u32`){c=e.type,l=e.tupleSize;let t=s.binding(f);for(let n=0;n<e.tupleSize;n++)u.push(`  outBuf[${K(e.tupleSize,n)}] = ${t.varName}[${K(e.tupleSize,n)}];`)}else d(Fe(n,`$`,s))}else d(Fe(n,`$`,s));let p=s.boundAttrs(),m=p.map(e=>({name:e.name,type:yt(e.attr),tupleSize:e.attr.tupleSize,binding:e.binding})),h=p.length+1,g=[`@group(0) @binding(0) var<uniform> params: PcgParams;`];for(let e of p)g.push(`@group(0) @binding(${e.binding}) var<storage, read> ${e.varName}: array<${yt(e.attr)}>; // attribute ${JSON.stringify(e.name)}: ${e.attr.type} tupleSize ${e.attr.tupleSize}`);g.push(`@group(0) @binding(${h}) var<storage, read_write> outBuf: array<${c}>;`);let _=o.names.length+o.attrIs.length,v=[`// Generated by pcg-ts compileFieldSpec (WGSL field kernel).
...
${g.join(`
`)}`,...ce(s.libRoots),...s.helperBlocks(),`@compute @workgroup_size(${Te})
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
  let i = gid.x + params.chunkOffset;
  if (i >= params.count) {
    return;
...
`)}\n`,entryPoint:`main`,workgroupSize:Te,outTupleSize:l,outType:c,inputs:m,bindings:{uniforms:0,output:h},constSlots:_,paramNames:o.names,attrIsSlots:o.attrIs,uniformBytes:ue(_),usesSeed:s.usesSeed,key:`${Ee}|spec=${b}|layout=[${y}]`}}var Q={MAP_READ:1,COPY_SRC:4,COPY_DST:8,VERTEX:32,UNIFORM:64,STORAGE:128},xt={READ:1},St=256;function Ct(e){let t=St;for(;t<e;)t*=2;return t}var wt=class{device;maxPooledBytes;free=new Map;meta=new Map;detachedSet=new WeakSet;idleBytes=0;idleCount=0;created=0;reused=0;destroyed=0;detachedTotal=0;detachedLive=0;detachedLiveBytes=0;constructor(e,t){this.device=e,this.maxPooledBytes=t}acquire(e,t){let n=Ct(e),r=`${t}|${n}`,i=this.free.get(r)?.pop();if(i!==void 0)return this.idleBytes-=n,this.idleCount--,this.reused++,i;let a=this.device.createBuffer({size:n,usage:t});return this.meta.set(a,{key:r,bytes:n}),this.created++,a}release(e){let t=this.meta.get(e);if(t===void 0)throw this.detachedSet.has(e)?Error(`BufferPool.release: buffer was detached from this pool, so the pool no longer owns it and cannot reclaim it; destroy it through the DetachedBuffer that detach() returned (or the handle wrapping it) and stop releasing it`):Error(`BufferPool.release: buffer was not acquired from this pool`);if(this.idleBytes+t.bytes>this.maxPooledBytes){this.meta.delete(e),e.destroy(),this.destroyed++;return}let n=this.free.get(t.key);n===void 0&&(n=[],this.free.set(t.key,n)),n.push(e),this.idleBytes+=t.bytes,this.idleCount++}detach(e){let t=this.meta.get(e);if(t===void 0)throw Error(this.detachedSet.has(e)?`BufferPool.detach: buffer was already detached from this pool; ownership can only leave once — reuse the DetachedBuffer the first detach() returned`:`BufferPool.detach: buffer was not acquired from this pool`);this.meta.delete(e),this.detachedSet.add(e),this.detachedTotal++,this.detachedLive++,this.detachedLiveBytes+=t.bytes;let n=!1,r=this;return{buffer:e,bytes:t.bytes,get destroyed(){return n},destroy(){n||(n=!0,r.detachedLive--,r.detachedLiveBytes-=t.bytes,r.destroyed++,e.destroy())}}}get stats(){return{buffersCreated:this.created,buffersReused:this.reused,buffersDestroyed:this.destroyed,pooledBuffers:this.idleCount,pooledBytes:this.idleBytes,buffersDetached:this.detachedTotal,detachedBuffers:this.detachedLive,detachedBytes:this.detachedLiveBytes}}dispose(){for(let e of this.free.values())for(let t of e)this.meta.delete(t),t.destroy(),this.destroyed++;this.free.clear(),this.idleBytes=0,this.idleCount=0}},Tt=`webgpu`,Et=class{backend=Tt;byteLength;detached;label;constructor(e,t,n){this.detached=e,this.byteLength=t,this.label=n}get disposed(){return this.detached.destroyed}get resource(){if(this.detached.destroyed)throw Error(`device transforms handle (${this.label}) was disposed; its GPU buffer is destroyed and cannot be bound. Dispose a handle only after the last frame that reads it, and re-cook to obtain a fresh one (device-resident outputs are never memoized, so every cook produces a new handle)`);return this.detached.buffer}dispose(){this.detached.destroy()}};function Dt(e,t,n){return new Et(e,t,n)}var Ot=65535;function kt(e,t){let n=Ot*e;return Math.max(e,Math.floor(Math.min(t??n,n)/e)*e)}var At=16,jt=`pcg-resident-run/6`;function Mt(e){return e.format===jt?e:null}var Nt={reason:`run-plan-failed`},Pt=[`+x`,`-x`,`+y`,`-y`,`+z`,`-z`];function Ft(e){if(typeof e!=`object`||!e||Array.isArray(e))return!1;let t=e;if(t.fn===`randomField`)return!0;for(let e of u(t))if(Ft(e))return!0;return!1}function It(e){return Array.isArray(e)&&e.length===3&&e.every(e=>typeof e==`number`&&Number.isFinite(e))}var $=class extends Error{};function Lt(e,t,n,r,i){let a=[...e].map(([e,t])=>({name:e,slot:t})),o=i||r===null,s=t.reduce((e,t)=>e+t.bytes,0),c=n.reduce((e,t)=>e+t,0),l=o?a.reduce((e,n)=>e+t[n.slot].bytes,0):0;return{writtenList:a,materialize:o,totalBytes:s+c+l+(r?.bytes??0)+(r?.colorBytes??0)+(r?.channelBytes??0)+(r?.permBytes??0)}}function Rt(e,t,r,i,a={}){let s=a.deviceInstanceAttrs===!0,l=t.count,u=new Map(Object.entries(t.attributes)),d=[],f=new Map,p=[],m=new Map,h=[],g=[],_=null,v=()=>Object.fromEntries(u),y=e=>{let t=f.get(e);if(t!==void 0)return t;let n=u.get(e);if(n===void 0||n.type===`string`)throw new $(e);let r=d.length;return d.push({bytes:l*n.tupleSize*4,init:`attr`,name:e}),f.set(e,r),r},b=(e,t,n)=>{let r=d.length;return d.push({bytes:l*t*4,init:n,name:e}),f.set(e,r),r},x=(e,t,n)=>{let r=u.get(e);if(r===void 0||r.type!==t||r.tupleSize!==n)throw new $(e)},S=(e,t,n)=>{let r=t.length/4;if(r>=4)throw Error(`resident run: "${n}" needs more than 4 uniform constant slots for its constant params; raise MAX_APPLY_CONST_SLOTS in applyKernels.ts (each slot costs 16 bytes of the per-chunk uniform and nothing else)`);for(let n=0;n<4;n++)t.push(n<e.length?e[n]:0);return{kind:`const`,tupleSize:e.length,slot:r}},C=(e,t,r,a,s,c)=>{let u;if(n(e)){let t=o(e,i);if(t===void 0)throw new $(`no spec`);if(m.has(`P`)&&Ft(t))throw new $(`identity after P write`);u=t}else if(typeof e==`number`||Array.isArray(e)&&e.every(e=>typeof e==`number`)){let t=typeof e==`number`?[e]:e;if(t.length<1||t.length>4||a!==null&&!a.includes(t.length))throw new $(`tuple`);for(let e of t)if(!Number.isFinite(Math.fround(e)))throw new $(`f32 range`);return{param:S(t,s,c),ref:null}}else throw new $(`bad param value`);let d;try{d=bt(u,{attributes:v()})}catch{throw new $(`compile`)}if(d.inputs.length+1>8)throw new $(`buffers`);if(a!==null&&!a.includes(d.outTupleSize))throw new $(`tuple`);if(d.attrIsSlots.length>0)throw new $(`attributeIs / byAttribute need a per-dispatch string table`);let f=ft(u,d);if(`problem`in f)throw new $(`param bindings`);let h=p.length;return p.push(l*d.outTupleSize*4),r.push({key:d.key,wgsl:d.wgsl,entryPoint:d.entryPoint,workgroupSize:d.workgroupSize,seed:t,uniformsBinding:d.bindings.uniforms,uniformBytes:d.uniformBytes,consts:f.values,perBatch:!1,bindings:[...d.inputs.map(e=>({binding:e.binding,ref:{kind:`slot`,index:y(e.name)}})),{binding:d.bindings.output,ref:{kind:`col`,index:h}}]}),{param:{kind:`column`,type:d.outType,tupleSize:d.outTupleSize},ref:{kind:`col`,index:h}}},w=(e,t,n,r,i=!1)=>{if(e.constSlots*4!==r.length)throw Error(`resident run: apply kernel "${e.key}" declares ${e.constSlots} constant slots but the planner allocated ${r.length/4}`);return{key:e.key,wgsl:e.wgsl,entryPoint:e.entryPoint,workgroupSize:e.workgroupSize,seed:t,uniformsBinding:0,uniformBytes:e.uniformBytes,consts:r,perBatch:i,bindings:e.bindings.map(e=>{let t=n[e.role];if(t===void 0)throw new $(`unmapped role ${e.role}`);return{binding:e.binding,ref:t}})}};try{for(let t of e){let n=t===e[e.length-1],r=[],i=[],a=t.params;switch(t.kind){case`setAttribute`:{let e=a.name,n=a.type,o=a.tupleSize;if(typeof e!=`string`)throw new $(`name`);if(n!==`f32`&&n!==`i32`&&n!==`u32`&&n!==`bool`)throw new $(`type`);if(typeof o!=`number`||!Number.isInteger(o)||o<1||o>4)throw new $(`tupleSize`);let s=typeof a.seed==`number`?a.seed:NaN,c=s===0?t.seed:j(t.seed,s),{param:l,ref:d}=C(a.value,c,r,o===1?[1]:[1,o],i,t.kind),f=b(e,o,`none`);u.set(e,{type:n,tupleSize:o}),m.set(e,f),h.push({op:`replace`,name:e,type:n,tupleSize:o});let p={target:{kind:`slot`,index:f}};d!==null&&(p.value=d),r.push(w(_e(l,n,o),0,p,i));break}case`transformPoints`:{x(`P`,`f32`,3);let e=C(a.translate,t.seed,r,[1,3],i,t.kind),n=C(a.rotateEuler,t.seed,r,[1,3],i,t.kind),o=C(a.scale,t.seed,r,[1,3],i,t.kind),s=u.get(`rot`),c=s!==void 0&&s.type===`f32`&&s.tupleSize===4,l=u.get(`scale`),d=l!==void 0&&l.type===`f32`&&l.tupleSize===3,f=y(`P`);m.set(`P`,f);let p={P:{kind:`slot`,index:f}};if(e.ref!==null&&(p.translate=e.ref),n.ref!==null&&(p.rotateEuler=n.ref),o.ref!==null&&(p.scale=o.ref),c){let e=y(`rot`);m.set(`rot`,e),p.rot={kind:`slot`,index:e}}if(d){let e=y(`scale`);m.set(`scale`,e),p.scaleAttr={kind:`slot`,index:e}}r.push(w(ye(e.param,n.param,o.param,c,d),0,p,i));break}case`jitterPoints`:{if(x(`P`,`f32`,3),m.has(`P`))throw new $(`identity after P write`);let e=typeof a.seed==`number`?a.seed:NaN,n=j(t.seed,e),o=C(a.amount,n,r,[1,3],i,t.kind),s=u.get(`seed`),c=s!==void 0;if(c&&(s.type!==`u32`||s.tupleSize!==1))throw new $(`seed attribute shape`);let l=y(`P`);m.set(`P`,l);let d={P:{kind:`slot`,index:l}};o.ref!==null&&(d.amount=o.ref),c&&(d.seed={kind:`slot`,index:y(`seed`)}),r.push(w(be(o.param,c),n,d,i));break}case`orientAlongVector`:{let e=a.axis;if(!Pt.includes(e))throw new $(`axis`);if(!It(a.up))throw new $(`up`);let n=C(a.direction,t.seed,r,[1,3],i,t.kind),o=a.up,s=o[0]*o[0]+o[1]*o[1]+o[2]*o[2],c=s>0?1/Math.sqrt(s):0,l=[o[0]*c,o[1]*c,o[2]*c];for(let e of l)if(!Number.isFinite(Math.fround(e)))throw new $(`up range`);let d=S(l,i,t.kind),f=u.get(`rot`),p=f!==void 0&&f.type===`f32`&&f.tupleSize===4?y(`rot`):b(`rot`,4,`quat-default`);u.set(`rot`,{type:`f32`,tupleSize:4}),m.set(`rot`,p),h.push({op:`ensure-rot`});let g={rot:{kind:`slot`,index:p}};n.ref!==null&&(g.direction=n.ref),r.push(w(Se(n.param,e,d),0,g,i));break}case`spawnInstances`:{if(!n)throw new $(`spawnInstances must be the run's last member`);let e=a.assetId;if(typeof e!=`string`||e===``)throw new $(`assetId`);if(x(`P`,`f32`,3),l>1048576)throw new $(`${l} instances over MAX_INSTANCES`);let t=a.assetAttr;if(t!==void 0&&typeof t!=`string`)throw new $(`assetAttr`);let o=t===void 0?``:t;if(o!==``){let e=u.get(o);if(e===void 0)throw new $(`assetAttr "${o}" not on the point domain`);if(e.type!==`string`)throw new $(`assetAttr "${o}" is ${e.type}, not string`)}let d=a.instanceAttrs,f=[];if(d!==void 0){if(!Array.isArray(d))throw new $(`instanceAttrs`);if(d.length>0&&!s)throw new $(`instanceAttrs names ${d.length} per-instance channel(s) and this resolver did not opt in to device channels (deviceInstanceAttrs)`);let e=new Set;for(let t of d){if(typeof t!=`string`)throw new $(`instanceAttrs entry is not a string`);if(t===``)throw new $(`instanceAttrs contains an empty name`);if(e.has(t))throw new $(`instanceAttrs names "${t}" twice`);if(e.add(t),t===`color`)throw new $(`instanceAttrs cannot carry "${ee}" — the name is reserved for per-instance RGB (colorAttr is the route)`);let n=u.get(t);if(n===void 0)throw new $(`instanceAttrs "${t}" not on the point domain`);if(n.type===`string`)throw new $(`instanceAttrs "${t}" is a string attribute`);if(!Number.isInteger(n.tupleSize)||n.tupleSize<1||n.tupleSize>4)throw new $(`instanceAttrs "${t}" has tupleSize ${n.tupleSize}; a device channel binds as a scalar or a vec2/vec3/vec4`);let r;try{r=c(n.type,n.tupleSize)}catch{throw new $(`instanceAttrs "${t}" has no device channel layout`)}f.push({name:t,type:n.type,itemSize:n.tupleSize,components:r.components,byteStride:r.byteStride})}}let p=a.colorAttr;if(p!==void 0&&typeof p!=`string`)throw new $(`colorAttr`);let m=p===void 0?``:p,h=0;if(m!==``){let e=u.get(m);if(e===void 0)throw new $(`colorAttr "${m}" not on the point domain`);if(e.type!==`f32`||e.tupleSize<3)throw new $(`colorAttr "${m}" is ${e.type}x${e.tupleSize}`);h=e.tupleSize}let g=u.get(`rot`),v=g!==void 0&&g.type===`f32`&&g.tupleSize===4,b=u.get(`scale`),S=b!==void 0&&b.type===`f32`&&b.tupleSize===3,C={P:{kind:`slot`,index:y(`P`)},transforms:{kind:`out`}};v&&(C.rot={kind:`slot`,index:y(`rot`)}),S&&(C.scaleAttr={kind:`slot`,index:y(`scale`)});let T=o!==``;T&&(C.perm={kind:`perm`}),h>0&&(C.color={kind:`slot`,index:y(m)},C.colors={kind:`colorOut`}),r.push(w(Ce(v,S,T,h),0,C,i,T)),f.forEach((e,t)=>{let n={src:{kind:`slot`,index:y(e.name)},out:{kind:`channelOut`,index:t}};T&&(n.perm={kind:`perm`}),r.push(w(we(e.itemSize,e.components,T),0,n,[],T))}),_={assetId:e,assetAttr:o,colorAttr:m,colorTupleSize:h,count:l,bytes:l*64,colorBytes:h>0?l*At:0,channels:f,channelBytes:f.reduce((e,t)=>e+l*t.byteStride,0),permBytes:T?l*4:0};break}default:throw new $(`unknown kind ${t.kind}`)}g.push({id:t.id,type:t.type,steps:r})}}catch(e){if(e instanceof $)return Nt;throw e}let{writtenList:T,materialize:te,totalBytes:E}=Lt(m,d,p,_,t.needsGeometry);return E>r?{reason:`run-too-large`}:{plan:{format:jt,count:l,members:g,slots:d,cols:p,written:T,layoutOps:h,materialize:te,instances:_,totalBytes:E}}}var zt={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function Bt(){return new Promise(e=>setTimeout(e,0))}async function Vt(e,n,a,o){let{device:s,pool:c}=e,{geo:l,signal:u,budgetMs:d}=a,f=n.count;if(l.attrs.point.count!==f)throw Error(`resident run: plan was built for ${f} points but the input geometry has ${l.attrs.point.count}; plans are single-cook artifacts — re-plan for new inputs`);let p=()=>{if(u?.aborted)throw new k},m=[],h=(e,t)=>{let n=c.acquire(e,t);return m.push(n),n},g=new Set,_=[];try{let a=l.attrs.point,u=n.slots.map(e=>{let t=h(e.bytes,Q.STORAGE|Q.COPY_DST|Q.COPY_SRC);if(e.init===`attr`){let n=a.require(e.name),r=e.bytes/4;if(n.data instanceof Uint8Array){let e=new Uint32Array(r);for(let t=0;t<r;t++)e[t]=n.data[t];s.queue.writeBuffer(t,0,e)}else s.queue.writeBuffer(t,0,n.data.subarray(0,r))}else if(e.init===`quat-default`){let n=new Float32Array(e.bytes/4);for(let e=3;e<n.length;e+=4)n[e]=1;s.queue.writeBuffer(t,0,n)}return t}),m=n.cols.map(e=>h(e,Q.STORAGE|Q.COPY_DST|Q.COPY_SRC)),v=n.instances===null?void 0:t(l,{defaultAssetId:n.instances.assetId,...n.instances.assetAttr===``?{}:{assetAttr:n.instances.assetAttr}}),y=n.instances!==null&&n.instances.permBytes>0?h(n.instances.permBytes,Q.STORAGE|Q.COPY_DST):void 0;y!==void 0&&v!==void 0&&s.queue.writeBuffer(y,0,v.perm);let b=Q.STORAGE|Q.COPY_DST|Q.COPY_SRC|Q.VERTEX,x=v===void 0?[]:Array.from(v.counts,e=>h(e*64,b)),S=v===void 0||n.instances===null||n.instances.colorBytes===0?[]:Array.from(v.counts,e=>h(e*At,b)),C=n.instances?.channels??[],w=v===void 0||C.length===0?[]:Array.from(v.counts,e=>C.map(t=>h(e*t.byteStride,b))),T=(e,t)=>{if(e.kind===`slot`)return u[e.index];if(e.kind===`col`)return m[e.index];if(e.kind===`colorOut`){let e=S[t];if(e===void 0)throw Error(`resident run: a kernel binds a retained instance-colour buffer but the plan declares no colour output (plan and kernels disagree)`);return e}if(e.kind===`channelOut`){let n=w[t]?.[e.index];if(n===void 0)throw Error(`resident run: a kernel binds retained per-instance channel ${e.index} but the plan declares no such channel (plan and kernels disagree)`);return n}if(e.kind===`perm`){if(y===void 0)throw Error(`resident run: a kernel binds the grouping permutation but the plan declares no per-point asset attribute (plan and kernels disagree)`);return y}let n=x[t];if(n===void 0)throw Error(`resident run: a kernel binds a retained instance-transform buffer but the plan declares no instances output (plan and kernels disagree)`);return n},te=s.createCommandEncoder(),E=te.beginComputePass(),ne=performance.now();for(let t of n.members){p();for(let n of t.steps){let t=e.getPipeline(n.key,n.wgsl,n.entryPoint,o);E.setPipeline(t);let r=kt(n.workgroupSize,e.maxElementsPerDispatch),i=n.perBatch&&v!==void 0?Array.from(v.counts,(e,t)=>({batch:t,elements:e,base:v.offsets[t]})):[{batch:0,elements:f,base:0}];for(let e of i){o!==void 0&&o.dispatches++;let i=new ArrayBuffer(n.uniformBytes),a=new Uint8Array(i),c=new Uint32Array(i,0,n.uniformBytes>=16?4:3);c[0]=e.elements,c[1]=n.seed>>>0,n.perBatch&&(c[3]=e.base),n.consts.length>0&&new Float32Array(i,16,n.consts.length).set(n.consts);let l=Math.ceil(e.elements/r);for(let i=0;i<l;i++){let o=h(n.uniformBytes,Q.UNIFORM|Q.COPY_DST);c[2]=i*r,s.queue.writeBuffer(o,0,a);let l=s.createBindGroup({layout:t.getBindGroupLayout(0),entries:[{binding:n.uniformsBinding,resource:{buffer:o}},...n.bindings.map(t=>({binding:t.binding,resource:{buffer:T(t.ref,e.batch)}}))]}),u=Math.min(r,e.elements-i*r);E.setBindGroup(0,l),E.dispatchWorkgroups(Math.ceil(u/n.workgroupSize))}}}d!==void 0&&performance.now()-ne>d&&(await Bt(),p(),ne=performance.now())}E.end();let D=[],O,k=n.materialize?n.written.reduce((e,t)=>e+n.slots[t.slot].bytes,0):0;if(k>0){O=h(k,Q.COPY_DST|Q.MAP_READ);let e=0;for(let t of n.written){let r=n.slots[t.slot].bytes;te.copyBufferToBuffer(u[t.slot],0,O,e,r),D.push(e),e+=r}}s.queue.submit([te.finish()]);let A;if(n.materialize){let e;if(O!==void 0){await O.mapAsync(xt.READ,0,k);try{e=O.getMappedRange(0,k).slice(0)}finally{O.unmap()}}p(),A=i(l);let t=A.attrs.point;for(let e of n.layoutOps)if(e.op===`replace`)t.replace(e.name,e.type,e.tupleSize);else{let e=t.get(`rot`);(!e||e.type!==`f32`||e.tupleSize!==4)&&(e&&t.remove(`rot`),t.add(`rot`,`f32`,4,[0,0,0,1]))}n.written.forEach((n,r)=>{let i=t.require(n.name),a=f*i.tupleSize;if(e===void 0)throw Error(`resident run: readback missing for a written attribute`);if(i.data instanceof Uint8Array){let t=new Uint32Array(e,D[r],a);for(let e=0;e<a;e++)i.data[e]=t[e]}else{let t=zt[i.type];if(t===void 0)throw Error(`resident run: cannot materialize attribute "${n.name}" of type ${i.type}`);i.data.set(new t(e,D[r],a))}})}else p();let j;if(n.instances!==null){let e=n.instances.colorBytes>0;if(v===void 0||x.length!==v.order.length||S.length!==(e?v.order.length:0)||w.length!==(C.length>0?v.order.length:0)||w.some(e=>e.length!==C.length))throw Error(`resident run: the plan declares an instances output but the acquired transform buffers do not match the grouping (library bug: plan.instances, the grouping, and the acquired buffers must agree)`);let t=(e,t,n)=>{let r=c.detach(e);g.add(e);try{return Dt(r,t,n)}catch(e){throw r.destroy(),e}},i=[];for(let n=0;n<v.order.length;n++){let a=v.order[n],o=v.counts[n],s=t(x[n],o*64,`${o} instances of "${a}"`);_.push(s);let c=Object.create(null);if(e){let e=t(S[n],o*At,`${o} instance colours of "${a}"`);_.push(e),c[ee]={handle:e,type:`f32`,itemSize:3}}C.forEach((e,r)=>{let i=t(w[n][r],o*e.byteStride,`${o} instance "${e.name}" values of "${a}"`);_.push(i),c[e.name]={handle:i,type:e.type,itemSize:e.itemSize}}),i.push(r(a,o,s,c))}j=i}o!==void 0&&(o.residentRuns++,o.fusedNodes+=n.members.length,o.readbacksSaved+=n.members.length-+!!n.materialize);let M={};return A!==void 0&&(M.geo=A),j!==void 0&&(M.deviceBatches=j),M}catch(e){for(let e of _)e.dispose();throw e instanceof k?e:Error(`GpuFieldEvaluator: resident run failed (${n.members.length} fused nodes [${n.members.map(e=>`"${e.id}"`).join(`, `)}], ${f} points): ${e instanceof Error?e.message:String(e)}`,{cause:e})}finally{for(let e of m)g.has(e)||c.release(e)}}var Ht=`gpu2`,Ut=268435456,Wt=[`spawnInstances`],Gt={f32:Float32Array,i32:Int32Array,u32:Uint32Array},Kt={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function qt(e){let t=e=>e!==void 0&&e!==``?e:`?`;return[Ht,t(e?.vendor),t(e?.architecture),t(e?.device),t(e?.description)].join(`|`)}function Jt(e,t){return e!==void 0&&(e.fallbacks[t]=(e.fallbacks[t]??0)+1),null}var Yt=class{cacheSalt;residentTerminals;acceptDerivedSpecs;deviceInstanceAttrs;device;kernels=new Map;pipelines=new Map;pool;maxElementsPerDispatch;maxResidentBytes;constructor(e,t={}){if(t.maxElementsPerDispatch!==void 0&&!Number.isFinite(t.maxElementsPerDispatch))throw Error(`GpuFieldEvaluator: maxElementsPerDispatch must be a finite number, got ${t.maxElementsPerDispatch}; leave it unset to use the device maximum`);if(t.deviceInstanceAttrs===!0&&t.deviceInstances!==!0)throw Error(`GpuFieldEvaluator: deviceInstanceAttrs requires deviceInstances: true — per-instance channels ride on a device-resident spawner terminal, and without deviceInstances no spawner is one, so the flag could never take effect. Pass both to produce channels on the device (and bind them yourself from batch.attributes[name].handle.resource), or drop deviceInstanceAttrs to let the CPU spawner produce transforms and channels together.`);this.device=e,this.cacheSalt=qt(t.adapterInfo??e.adapterInfo),this.pool=new wt(e,t.maxPooledBytes??Ut),this.maxElementsPerDispatch=t.maxElementsPerDispatch,this.maxResidentBytes=t.maxResidentBytes??536870912,this.residentTerminals=t.deviceInstances===!0?Wt:[],this.deviceInstanceAttrs=t.deviceInstanceAttrs===!0,this.acceptDerivedSpecs=g(t)}get pipelineCacheSize(){return this.pipelines.size}get kernelCacheSize(){return this.kernels.size}get poolStats(){return this.pool.stats}dispose(){this.pool.dispose()}chunkElements(e){let t=Ot*e.workgroupSize,n=Math.min(this.maxElementsPerDispatch??t,t);return Math.max(e.workgroupSize,Math.floor(n/e.workgroupSize)*e.workgroupSize)}resolveField(e,t,n){let r=o(e,this.acceptDerivedSpecs);if(r===void 0)return Jt(n,p(e));let i=t.geo.attrs[t.domain],a={},s=[];for(let e of i.names().sort()){let t=i.get(e);t!==void 0&&(a[e]={type:t.type,tupleSize:t.tupleSize},s.push(`${JSON.stringify(e)}:${t.type}x${t.tupleSize}`))}let c;try{c=ut(r,e.key)}catch{return Jt(n,`compile-error`)}let l=`${c.length}#${c}|${s.join(`,`)}`,u=this.kernels.get(l);if(u===void 0){try{u=bt(r,{attributes:a})}catch(e){u=e instanceof Error?e:Error(String(e))}this.kernels.set(l,u)}if(u instanceof Error)return Jt(n,`compile-error`);if(u.inputs.length+1>8)return Jt(n,`too-many-buffers`);let d=ht(r,u,i);if(`problem`in d)return Jt(n,`param-bindings`);let f=i.count;if(f===0)return Promise.resolve({data:new Kt[u.outType](0),tupleSize:u.outTupleSize});let m=this.getPipeline(u.key,u.wgsl,u.entryPoint,n);return n!==void 0&&n.dispatches++,this.dispatch(e,t,u,m,f,d.values)}getPipeline(e,t,n,r){let i=this.pipelines.get(e);if(i!==void 0)return r!==void 0&&r.pipelineCacheHits++,i;let a=this.device.createShaderModule({code:t}),o=this.device.createComputePipeline({layout:`auto`,compute:{module:a,entryPoint:n}});return this.pipelines.set(e,o),r!==void 0&&r.pipelinesCompiled++,o}planRun(e,t,n){let r=Rt(e,t,this.maxResidentBytes,this.acceptDerivedSpecs,{deviceInstanceAttrs:this.deviceInstanceAttrs});return`plan`in r?r.plan:(n!==void 0&&(n.fallbacks[r.reason]=(n.fallbacks[r.reason]??0)+1),null)}executeRun(e,t,n){let r=Mt(e);return r===null?Promise.reject(Error(`GpuFieldEvaluator.executeRun: plan was not produced by this library's planRun; pass the object returned by planRun on the same resolver`)):Vt({device:this.device,pool:this.pool,maxElementsPerDispatch:this.maxElementsPerDispatch,getPipeline:(e,t,n,r)=>this.getPipeline(e,t,n,r)},r,t,n)}async dispatch(e,t,n,r,i,a){let o=this.device,s=[],c=(e,t)=>{let n=this.pool.acquire(e,t);return s.push(n),n};try{let e=this.chunkElements(n),s=Math.ceil(i/e),l=[],u=t.geo.attrs[t.domain];for(let e of n.inputs){let t=u.require(e.name),n=i*e.tupleSize,r;if(t.data instanceof Uint8Array){let e=new Uint32Array(n);for(let r=0;r<n;r++)e[r]=t.data[r];r=e}else r=t.data.subarray(0,n);let a=c(n*4,Q.STORAGE|Q.COPY_DST);o.queue.writeBuffer(a,0,r),l.push({binding:e.binding,resource:{buffer:a}})}let d=i*n.outTupleSize*4,f=c(d,Q.STORAGE|Q.COPY_SRC);l.push({binding:n.bindings.output,resource:{buffer:f}});let p=c(d,Q.COPY_DST|Q.MAP_READ),m=new ArrayBuffer(n.uniformBytes),h=new Uint8Array(m),g=new Uint32Array(m,0,3);g[0]=i,g[1]=t.seed>>>0,a.length>0&&new Float32Array(m,16,a.length).set(a);let _=[];for(let t=0;t<s;t++){let i=c(n.uniformBytes,Q.UNIFORM|Q.COPY_DST);g[2]=t*e,o.queue.writeBuffer(i,0,h),_.push(o.createBindGroup({layout:r.getBindGroupLayout(0),entries:[{binding:n.bindings.uniforms,resource:{buffer:i}},...l]}))}let v=o.createCommandEncoder(),y=v.beginComputePass();y.setPipeline(r);for(let t=0;t<s;t++){let r=Math.min(e,i-t*e);y.setBindGroup(0,_[t]),y.dispatchWorkgroups(Math.ceil(r/n.workgroupSize))}y.end(),v.copyBufferToBuffer(f,0,p,0,d),o.queue.submit([v.finish()]),await p.mapAsync(xt.READ,0,d);let b;try{b=p.getMappedRange(0,d).slice(0)}finally{p.unmap()}return{data:new Gt[n.outType](b),tupleSize:n.outTupleSize}}catch(n){throw Error(`GpuFieldEvaluator: dispatch failed for field ${e.key} (${i} elements on the ${t.domain} domain): ${n instanceof Error?n.message:String(n)}`,{cause:n})}finally{for(let e of s)this.pool.release(e)}}};export{Yt as t};