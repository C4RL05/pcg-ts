import{D as e,En as t,It as n,Mr as r,Nn as i,Qn as a,Rt as o,Un as ee,Zn as s,cr as te,dr as c,fn as ne,gn as re,gr as ie,hn as ae,in as oe,mr as se,pr as ce,r as l,rn as le,tr as ue,vn as u}from"./wordmark-C04h7Kgu.js";import{t as de}from"./types-C9vZymIy.js";import{A as d,St as f,U as p,Vt as m,W as fe,jt as h,q as g}from"./three.core-B85ZZh_6.js";import{t as pe}from"./scene-QpK-6DxV.js";import{n as me}from"./debug-dzB0_tPL.js";import{t as he}from"./worldBinding-C4WCZ1un.js";import{n as ge,t as _e}from"./panel-BWs-7l7t.js";var ve=.35,ye=777;function be(){let e=new t,n=e.add(le,{count:170,boundsMin:[-800,0,-800],boundsMax:[800,0,800]}),i=e.add(u,{name:`scale`,tupleSize:3,value:(()=>{let e=c(ie(`mega`),0,1,5,13);return ce(e,te(e,1.6),e)})()}),a=e.add(o,{assetId:`megarock`});return e.connect(n,`out`,i,`in`),e.connect(i,`out`,a,`in`),e.output(a,`instances`,`instances`),{name:`landmarks`,cellSize:`unbounded`,generationRadius:1/0,graph:e,bind(e,t){e.setParam(n,`seed`,t.seed),e.setParam(i,`seed`,r(t.seed,9))}}}function xe(e){let{cellSize:n,generationRadius:a,anchored:s}=e,l=e.halo?4:0,d=new t,f=s?d.add(oe,{density:ve,cellSize:7,latticeMode:`xz`,height:0}):d.add(le,{count:Math.round(ve*(n+2*l)**2)}),p=d.add(u,{name:`density`,tupleSize:1,value:c(i(ee,{seed:ye,frequency:.02,octaves:3}),-1,1,0,1)}),m=d.add(re,{mode:`probabilistic`}),fe=d.add(ne,{radius:4,countAttr:`nbrCount`}),h=d.add(ae,{mode:`inside`}),g=d.add(u,{name:`scale`,tupleSize:3,value:(()=>{let e=c(ue(se(`nbrCount`),2,16),2,16,.4,1.35),t=te(e,c(ie(`rock`),0,1,.85,1.15));return ce(t,t,t)})()}),pe=d.add(o,{assetId:`rock`});return d.connect(f,`out`,p,`in`),d.connect(p,`out`,m,`in`),d.connect(m,`out`,fe,`in`),d.connect(fe,`out`,h,`in`),d.connect(h,`out`,g,`in`),d.connect(g,`out`,pe,`in`),d.output(pe,`instances`,`instances`),{name:`rocks`,cellSize:n,generationRadius:a,graph:d,bind(e,t){let{min:n,max:i}=de(t);e.setParam(f,`boundsMin`,[n[0]-l,0,n[1]-l]),e.setParam(f,`boundsMax`,[i[0]+l,0,i[1]+l]);let a=s?t.worldSeed:t.seed;e.setParam(f,`seed`,a),e.setParam(m,`seed`,r(a,1)),e.setParam(g,`seed`,r(a,2)),e.setParam(h,`boundsMin`,[n[0],-1,n[1]]),e.setParam(h,`boundsMax`,[i[0],1,i[1]])}}}function Se(e){return e instanceof Error?e.message:String(e)}function Ce(e){let t=(e?.description??``)===``?e?.device:e?.description;return[e?.vendor,e?.architecture,t].filter(e=>typeof e==`string`&&e!==``).join(` · `)||`adapter (no info exposed)`}async function we(e){let t=navigator.gpu;if(t===void 0)return{error:`navigator.gpu is missing — this browser has no WebGPU.`};try{let n=await t.requestAdapter();if(n===null)return{error:`navigator.gpu.requestAdapter() returned null — no compatible GPU adapter.`};let r=n.info,i=await n.requestDevice(),a=i.lost;return a!==void 0&&a.then(t=>{e(`${t?.reason??`unknown`}: ${t?.message??`no detail`}`)}),{device:i,info:r,label:Ce(r)}}catch(e){return{error:`requestDevice() failed: ${Se(e)}`}}}function Te(e){let t=e.info===void 0?{}:{adapterInfo:e.info};return{derived:new me(e.device,{...t,acceptDerivedSpecs:!0}),strict:new me(e.device,t)}}var Ee=class{cacheSalt;residentTerminals;acceptDerivedSpecs;base;seen=new Set;constructor(e){this.base=e,this.cacheSalt=e.cacheSalt,this.residentTerminals=e.residentTerminals,this.acceptDerivedSpecs=e.acceptDerivedSpecs}resolveField(e,t,n){return n!==void 0&&this.seen.add(n),this.base.resolveField(e,t,n)}planRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.planRun(e,t,n)}executeRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.executeRun(e,t,n)}drain(){if(this.seen.size===0)return;let e=a();for(let t of this.seen){e.dispatches+=t.dispatches,e.pipelinesCompiled+=t.pipelinesCompiled,e.pipelineCacheHits+=t.pipelineCacheHits,e.residentRuns+=t.residentRuns,e.fusedNodes+=t.fusedNodes,e.readbacksSaved+=t.readbacksSaved;for(let[n,r]of Object.entries(t.fallbacks))e.fallbacks[n]=(e.fallbacks[n]??0)+r}return this.seen.clear(),e}};function De(e){let t=Object.entries(e).sort(([e],[t])=>e.localeCompare(t));return t.length===0?`none`:t.map(([e,t])=>`${e} ×${t}`).join(`, `)}var _=1,v=18,y=140,b=`gpu`,x=!0,S=20,C=!0,w=!0,T=!0,Oe=7,ke=12,Ae=8,je=5e3;function Me(e){return e instanceof Error?e.message:String(e)}var{scene:E,camera:D,start:Ne}=pe({cameraPosition:[0,26,0],orbit:!1,fog:{near:140,far:640},far:1600}),O=new f(new m(4e3,4e3),new h({color:1449515,roughness:1}));O.rotation.x=-Math.PI/2,O.position.y=-.03,E.add(O);var Pe=40,k;function Fe(){k&&(E.remove(k),k.geometry.dispose(),k.material.dispose());let e=new p(S*Pe,Pe,4158656,2903936),t=e.material;t.transparent=!0,t.opacity=.45,t.depthWrite=!1,e.position.y=.02,e.visible=T,E.add(e),k=e}function Ie(){!k||!k.visible||(k.position.x=Math.round(D.position.x/S)*S,k.position.z=Math.round(D.position.z/S)*S)}var Le=new h({color:8028816,roughness:.95,flatShading:!0}),Re=new h({color:6121077,roughness:1,flatShading:!0}),ze={megarock:{geometry:new d(1).translate(0,.62,0),material:Re},rock:{geometry:new g(.55).translate(0,.33,0),material:Le}},A,Be,j=`requesting…`,M,N=!1,Ve=``,P;function F(){return A!==void 0&&!N}function He(){if(!(b===`cpu`||!F()))return x?A:Be}var I;function Ue(e,t){let n=[{name:`landmarks`,graph:e},{name:`rocks`,graph:t}];I?I.set(n):I=_e(n,{into:_t,title:`infinite world`})}function We(e,t){let n=e*1.25/t+1.5;return Math.max(256,Math.ceil(Math.PI*n*n))}function Ge(e){let t=0;for(let n of Object.keys(e))for(let r of e[n])if(r.kind===`instances`)for(let e of r.batches)t+=e.count;return t}var L,R=0,z,Ke=0,B=!1,qe=0;function V(){L&&(L.disposed=!0,L.abort.abort(),L.binding.dispose(),E.remove(L.group));let e=new fe;E.add(e);let t=new he({group:e,assets:ze}),r=new Map,i=He(),a={world:void 0,group:e,binding:t,cellInstances:r,tap:i===void 0?void 0:new Ee(i),abort:new AbortController,disposed:!1},o=[be(),xe({cellSize:S,generationRadius:y,anchored:C,halo:w})];Ue(o[0].graph,o[1].graph),a.world=new n({seed:_,levels:o,maxCellsPerLevel:We(y,S),...a.tap===void 0?{}:{gpu:a.tap},onCellReady:(e,n,i)=>{a.disposed||(t.cellReady(e,n,i),r.set(`${e}|${n[0]},${n[1]}`,Ge(i)))},onCellEvicted:(e,n)=>{a.disposed||(t.cellEvicted(e,n),r.delete(`${e}|${n[0]},${n[1]}`))}}),L=a,R=0,P=void 0,z=void 0,Q(),Je(a,ke)}function Je(e,t){let n=++qe;$=!0,Ke=performance.now(),e.world.update([D.position.x,0,D.position.z],{budgetMs:t,maxCooksPerUpdate:Ae,signal:e.abort.signal,...e.tap===void 0?{}:{gpu:e.tap}}).then(t=>{if(e.disposed)return;R=t.pending,z=t.elapsedMs;let n=e.tap?.drain();n!==void 0&&(P=n),Q(),B&&(B=!1,X(gt()))}).catch(t=>{t instanceof s||(console.error(t),e.disposed||X(`update failed: ${Me(t)}`))}).finally(()=>{n===qe&&($=!1)})}var H=0,Ye=0,U=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(t===`g`){nt(b===`gpu`?`cpu`:`gpu`);return}U.add(t)}),window.addEventListener(`keyup`,e=>U.delete(e.key.toLowerCase())),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&(Ke=performance.now())});var W=ge({title:`infinite world`,info:`Unbounded landmark level + world-anchored rock cells streamed around a flying camera. Steer with A/D or arrow keys.`}),Xe=document.createElement(`style`);Xe.textContent=`
...
update cooks nothing.`;function bt(e){N=!0,Ve=e,j=`device lost`,Y(j),X(Z()),J(),b===`gpu`&&(b=`cpu`,J(),V())}async function xt(){let e=await we(bt);if(`error`in e){M=e.error,j=`no WebGPU adapter`,Y(j),b=`cpu`,J(),X(`${e.error} Running the CPU path.`);return}try{let t=Te(e);A=t.derived,Be=t.strict}catch(e){M=`GpuFieldEvaluator construction failed: ${Me(e)}`,j=`evaluator unavailable`,Y(j),b=`cpu`,J(),X(`${M} Running the CPU path.`);return}N||(j=e.label,Y(j),J(),X(gt()),b===`gpu`&&V())}var $=!1,St=e(e=>rt(e));Y(j),X(`requesting WebGPU adapter…`),J(),ht(),Q(),Fe(),V(),xt(),Ne(e=>{St(),Ye=(U.has(`a`)||U.has(`arrowleft`)?1:0)-(U.has(`d`)||U.has(`arrowright`)?1:0),H+=Ye*1.1*e,D.position.x+=Math.sin(H)*v*e,D.position.z+=Math.cos(H)*v*e,D.position.y=26,D.lookAt(D.position.x+Math.sin(H)*60,5,D.position.z+Math.cos(H)*60),Ie();let t=L;if(t&&!$?Je(t,Oe):$&&!B&&performance.now()-Ke>je&&(B=!0,X(`a cook has been in flight for over 5 s — the GPU device may have been lost.`)),t){let e=t.world.stats(),n=e.levels.find(e=>e.name===`rocks`)?.cellCount??0;at(String(n)),ot(`${e.totalCooked} / ${e.totalEvicted}`),st(String(R));let r=0;for(let e of t.cellInstances.values())r+=e;ct(String(r)),lt(`${D.position.x.toFixed(0)}, ${D.position.z.toFixed(0)}`)}});