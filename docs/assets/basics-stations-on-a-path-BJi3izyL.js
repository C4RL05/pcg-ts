var e=`{
  ...
  "seed": 8317,
  "meta": {
    "title": "read a lap's own frame and width at thirty arbitrary stations, and place markers there",
  ...
  "nodes": [
        ...
        "value": {
          ...
          "args": [
            3,
            {
              ...
              "args": [
                1.2,
                { "fn": "sin", "args": [{ "fn": "mul", "args": [{ "fn": "index" }, 0.19634954] }] }
              ]
            }
          ]
        }
    ...
    },
    {
      "id": "markers",
      "type": "pointLine",
      "params": { "mode": "endpoints", "count": 30, "start": [0, 0, 0], "end": [29, 0, 0], "includeEnd": true }
    },
    {
      "id": "station",
      "type": "setAttribute",
      "params": {
        ...
        "value": {
          "fn": "add",
          "args": [-24, { "fn": "mul", "args": [{ "fn": "randomField", "key": "station" }, 150] }]
        }
      }
    },
    {
      ...
      "params": {
        "arcAttr": "station",
        "attributes": ["P", "tangent", "roadWidth"],
        "normalize": ["tangent"],
        "wrap": true
      }
    },
    {
      ...
      "params": {
        "direction": { "fn": "attribute", "name": "tangent" },
        "up": [0, 1, 0],
        "axis": "+z"
      }
    },
  ...
  "connections": [
    { "from": ["loop", "out"], "to": ["frame", "in"] },
    { "from": ["frame", "out"], "to": ["width", "in"] },
    { "from": ["width", "out"], "to": ["gather", "path"] },
    { "from": ["markers", "out"], "to": ["station", "in"] },
    { "from": ["station", "out"], "to": ["gather", "at"] },
    { "from": ["gather", "out"], "to": ["orient", "in"] },
    { "from": ["orient", "out"], "to": ["size", "in"] },
    { "from": ["size", "out"], "to": ["spawn", "in"] }
  ],
  "outputs": [
    { "id": "width", "pin": "out", "name": "road" },
    { "id": "spawn", "pin": "instances", "name": "markers" }
  ]
}
`;export{e as default};