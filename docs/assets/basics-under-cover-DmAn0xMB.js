var e=`{
  ...
  "seed": 4127,
  "meta": {
    "title": "measure what runs under cover, where the route passes close to itself",
  ...
  "nodes": [
    {
      "id": "coil",
      "type": "subgraph",
      "params": { "count": 320, "turns": 3, "size": [26, 1, 26] },
      "ref": { "name": "shape/spiral" }
    },
    {
      "id": "path",
      "type": "pointsToPath",
    ...
    },
    {
      "id": "lap",
      "type": "pathResample",
      "params": { "mode": "spacing", "spacing": 0.8 }
    },
    {
      "id": "stations",
      "type": "subgraph",
      "params": { "mode": "spacing", "spacing": 4, "axis": "+z" },
    ...
    },
    {
      ...
      "params": {
        "predicate": {
          "fn": "gt",
          "args": [{ "fn": "length", "args": [{ "fn": "position" }] }, 21]
        }
      }
    },
    {
      ...
      "params": {
        ...
        "value": {
          ...
          "args": [
            {
              "fn": "ramp",
              "args": [{ "fn": "attribute", "name": "coverHits" }],
              "stops": [
                [0, 0.16],
                [2, 0.28],
                [4, 0.95],
    ...
    },
    {
      "id": "sheltered",
      "type": "filterByExpression",
      "params": { "predicate": { "fn": "attribute", "name": "covered" } }
    },
    {
      "id": "canopy",
      "type": "spawnInstances",
      "params": { "assetId": "panel" }
    }
  ],
  "connections": [
    { "from": ["coil", "out"], "to": ["path", "in"] },
    { "from": ["path", "out"], "to": ["lap", "in"] },
    { "from": ["path", "out"], "to": ["stations", "curve"] },
    { "from": ["stations", "out"], "to": ["rim", "in"] },
    { "from": ["rim", "out"], "to": ["panels", "in"] },
    { "from": ["panels", "out"], "to": ["roof", "in"] },
    { "from": ["lap", "out"], "to": ["cover", "path"] },
    { "from": ["roof", "out"], "to": ["cover", "boxes"] },
    { "from": ["cover", "out"], "to": ["tint", "in"] },
    { "from": ["tint", "out"], "to": ["sheltered", "in"] },
    { "from": ["roof", "out"], "to": ["canopy", "in"] }
  ],
  "outputs": [
    { "id": "tint", "pin": "out", "name": "lap" },
    { "id": "sheltered", "pin": "out", "name": "sheltered" },
    { "id": "canopy", "pin": "instances", "name": "canopy" }
  ]
}
`;export{e as default};