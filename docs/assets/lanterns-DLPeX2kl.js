import{$r as e,D as t,Gn as n,In as r,Jr as i,Qn as a,Wn as o,cr as s,ei as c,gr as l,hn as u,ni as d,r as f,ri as p,wr as m,zt as ee}from"./wordmark-1f_kjN-C.js";import{Bt as h,H as g,Jn as _,R as v,Rt as y,U as b,Yn as x,d as S}from"./three.core-auuZCBBV.js";import{t as C}from"./three.module-nQRqYuUd.js";import{t as te}from"./OrbitControls-Bt5vZkN6.js";import{a as ne,c as re,o as w,s as T}from"./three-BOVIlnmx.js";import{t as E}from"./recook-DLZ34zXJ.js";import{n as D,t as O}from"./panel-Q1e-Sbno.js";var k={instances:`instances`},A=`lantern`,j=`seed`,M=`seedWidened`;function ie(t={}){let{seed:o=7,count:l=6e3,extent:f=90,relief:h=30}=t,g=new n(o),_=g.add(u,{count:l,boundsMin:[-f,0,-f],boundsMax:[f,0,f]},`scatter`),v=m(i(a(s,{seed:{from:`node`,variant:0},frequency:.011,octaves:4,gain:.5,normalized:!0}),.28,.72,0,h),i(p(`hover`),0,1,0,9)),y=g.add(r,{name:`P`,type:`f32`,tupleSize:3,value:m(d(),e(0,v,0))},`lift`),b=i(p(`size`),0,1,.55,1.5),x=g.add(r,{name:`scale`,type:`f32`,tupleSize:3,value:e(b,b,b)},`size`),S=g.add(r,{name:M,type:`f32`,tupleSize:1,value:c(j)},`widen`),C=g.add(ee,{assetId:A,instanceAttrs:[j,M]},`spawn`);return g.connect(_,`out`,y,`in`),g.connect(y,`out`,x,`in`),g.connect(x,`out`,S,`in`),g.connect(S,`out`,C,`in`),g.output(C,`instances`,k.instances),g}function ae(e){for(let t of e??[])if(t.kind===`instances`){if(l(t))throw Error(`lanterns: the graph produced device-resident batches, whose columns are GPU buffers`);return t.batches}throw Error(`lanterns: the graph produced no instance batches`)}function oe(e){let t=0,n=0,r=new Set,i=new Set;for(let a of e){let e=a.attributes?.[j],o=a.attributes?.[M];if(!(!e||!o))for(let s=0;s<a.count;s++){let a=e[s],c=o[s];a!==c&&t++,n=Math.max(n,Math.abs(c-a)),r.add(a&255),i.add(c>>>0&255)}}return{altered:t,worst:n,huesExact:r.size,huesWidened:i.size}}async function se(e,t,n){let r=performance.now(),i=ie({seed:e,count:t,relief:n}),a=(await o(i)).outputs,s=ae(a[k.instances]);return{graph:i,batches:s,count:s.reduce((e,t)=>e+t.count,0),cookMs:performance.now()-r,loss:oe(s)}}var N=329483,P=90,F=420,I=6.2831853;function L(){return new x({glslVersion:g,uniforms:{uTime:{value:0},uWiden:{value:0},uPulse:{value:1},uBob:{value:1.4},uBackground:{value:new S(N)},uFogNear:{value:P},uFogFar:{value:F}},vertexShader:`
