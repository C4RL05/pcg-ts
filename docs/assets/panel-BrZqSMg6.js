import{$ as e,$t as t,A as n,At as r,B as i,C as a,Dt as o,J as s,Kt as c,Mt as l,N as u,Nt as d,O as f,Ot as p,Q as m,R as h,S as g,St as _,T as v,W as y,Y as b,Z as x,_ as S,_t as C,a as w,bt as T,c as ee,ct as E,d as D,et as O,g as k,gt as A,h as j,ht as te,i as M,it as N,jt as ne,k as P,kt as re,l as F,lt as I,mt as L,nt as R,ot as z,p as ie,pt as B,q as V,rt as H,s as ae,st as U,tt as oe,ut as W,vt as G,w as K,wt as q,x as J,xt as Y,yt as X,z as se}from"./wordmark-AasxZBgD.js";var Z=!1;function ce(){if(Z)return;Z=!0;let e=document.createElement(`style`);e.textContent=`
.pcg-overlay {
...
`,document.head.appendChild(e)}function le(e){ce();let t=document.createElement(`div`);t.className=`pcg-overlay`;let n=document.createElement(`h1`);n.textContent=e.title;let r=document.createElement(`span`);r.className=`pcg-chevron`,r.textContent=`▾`,n.appendChild(r),t.appendChild(n),n.setAttribute(`role`,`button`),n.tabIndex=0;let i=()=>{n.setAttribute(`aria-expanded`,String(!t.classList.contains(`pcg-collapsed`)))},a=()=>{t.classList.toggle(`pcg-collapsed`),i()};n.addEventListener(`click`,a),n.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),a())});let o=w();if(o.matches&&t.classList.add(`pcg-collapsed`),o.addEventListener(`change`,e=>{t.classList.toggle(`pcg-collapsed`,e.matches),i()}),i(),e.info){let n=document.createElement(`p`);n.className=`pcg-info`,n.textContent=e.info,t.appendChild(n)}let s=document.createElement(`div`);t.appendChild(s);let c=document.createElement(`div`);c.className=`pcg-stats`,t.appendChild(c),document.body.appendChild(t);function l(e){let t=document.createElement(`div`);t.className=`pcg-row`;let n=document.createElement(`label`);return n.textContent=e,t.appendChild(n),s.appendChild(t),t}function u(e,t){let n=document.createElement(`span`);n.className=`pcg-numbox`,n.appendChild(e);let r=document.createElement(`span`);r.className=`pcg-steps`;for(let[n,i,a]of[[-1,`−`,`decrease`],[1,`+`,`increase`]]){let o=document.createElement(`button`);o.type=`button`,o.tabIndex=-1,o.textContent=i,o.setAttribute(`aria-label`,a);let s,c,l=()=>{n>0?e.stepUp():e.stepDown(),t()},u=()=>{clearTimeout(s),clearInterval(c)};o.addEventListener(`pointerdown`,e=>{e.preventDefault(),l(),s=setTimeout(()=>{c=setInterval(l,60)},400)});for(let e of[`pointerup`,`pointerleave`,`pointercancel`])o.addEventListener(e,u);r.appendChild(o)}return n.appendChild(r),n}return{el:t,addSeed(e,t){let n=l(`seed`),r=document.createElement(`input`);r.type=`number`,r.step=`1`,r.min=`0`,r.value=String(e);let i=()=>{let e=Math.floor(r.valueAsNumber);Number.isFinite(e)&&t(e>>>0)};r.addEventListener(`change`,i),n.appendChild(u(r,i))},addSlider(e,t,n){let r=l(e),i=document.createElement(`input`);i.type=`range`,i.min=String(t.min),i.max=String(t.max),i.step=String(t.step),i.value=String(t.value);let a=document.createElement(`span`);a.className=`pcg-val`;let o=t.format??(e=>String(e));a.textContent=o(t.value);let s=e=>{let n=t.max-t.min,r=n>0?(e-t.min)/n:0;i.style.setProperty(`--p`,`${Math.min(1,Math.max(0,r))*100}%`)};s(t.value),i.addEventListener(`input`,()=>{let e=Number(i.value);a.textContent=o(e),s(e),n(e)}),r.appendChild(i),r.appendChild(a)},addSelect(e,t,n,r){let i=l(e),a=document.createElement(`select`);for(let e of t){let t=document.createElement(`option`);t.value=e.value,t.textContent=e.label,a.appendChild(t)}a.value=n,a.addEventListener(`change`,()=>r(a.value)),i.appendChild(a)},addCheckbox(e,t,n){let r=l(e),i=document.createElement(`input`);i.type=`checkbox`,i.checked=t,i.addEventListener(`change`,()=>n(i.checked)),r.appendChild(i)},addStat(e){let t=document.createElement(`div`);t.className=`pcg-stat`;let n=document.createElement(`span`);n.textContent=e;let r=document.createElement(`span`);return r.textContent=`–`,t.appendChild(n),t.appendChild(r),c.appendChild(t),e=>{r.textContent=String(e)}},addCollapsible(e,n=!1){let r=document.createElement(`details`);r.open=n;let i=document.createElement(`summary`);i.textContent=e,r.appendChild(i);let a=document.createElement(`pre`);return r.appendChild(a),t.appendChild(r),a},addNote(e){let n=document.createElement(`p`);n.className=`pcg-note`,n.textContent=e,t.appendChild(n)},addSlot(){let e=document.createElement(`div`);return e.className=`pcg-slot`,t.appendChild(e),e}}}Q[d]=`shared/graph/GraphView.svelte`;var ue=I(H(`<path class="edge-casing svelte-v559t8"></path><path></path>`,1),Q[d],[[193,8],[194,8]]),de=I(H(`<svg role="img"><g><!><!></g></svg>`),Q[d],[[171,0,[[185,2]]]]);function Q(e,t){s(new.target),re(t,!0,Q);let i=P(t,`previews`,19,()=>new Map),a=P(t,`interactive`,3,!0),c=P(t,`label`,3,`node graph`),d=r(_(void 0),`svgEl`),f=r(_(T({x:0,y:0,z:1})),`view`),m=null,g=r(q(()=>new Map([...i()].map(([e,t])=>[e,t.length]))),`rowCounts`),v=r(q(()=>new Map(t.nodes.map(e=>[e.id,e]))),`byId`);function x(e,n){return t.floor??k(e,n)}function w(){if(!W(d))return;let e=W(d).getBoundingClientRect();if(X(e.width,0)||X(e.height,0))return;let n=D(t.nodes,W(g));Y(f,ie(n,e,{floor:x(n,e),preferActual:a()}),!0)}function M(){if(!W(d))return;let e=D(t.nodes,W(g));Y(f,X(e,null)?{x:0,y:0,z:1}:F(1,e,W(d).getBoundingClientRect()),!0)}L(()=>{t.nodes,t.floor,a(),w()}),L(()=>{let e=W(d);if(!e)return;let t=new ResizeObserver(()=>w());return t.observe(e),()=>t.disconnect()});function N(e){if(!a()||!W(d))return;e.preventDefault();let n=W(d).getBoundingClientRect(),r=x(D(t.nodes,W(g)),n);Y(f,j(W(f),n,e.clientX,e.clientY,e.deltaY,r),!0)}function ne(e){!a()||X(e.button,0,!1)||(m={px:e.clientX,py:e.clientY,ox:W(f).x,oy:W(f).y},W(d)?.setPointerCapture(e.pointerId))}function I(e){m&&Y(f,{...W(f),x:m.ox+(e.clientX-m.px),y:m.oy+(e.clientY-m.py)},!0)}function R(){m=null}function z(){a()&&w()}var H={...b(),get fit(){return w},get actualSize(){return M}},K=de();E(`pointermove`,te,I),E(`pointerup`,te,R);let J;var Z=A(K),ce=A(Z);o(()=>y(ce,17,()=>t.edges,e=>`${e.from}.${e.fromPin}->${e.to}.${e.toPin}`,(e,t)=>{let n=r(q(()=>ee(W(v),W(t))),`d`);W(n);var i=oe(),a=C(i),s=e=>{var r=ue(),i=C(r),a=G(i);B(e=>{u(i,`d`,W(n)),se(a,0,`edge-line k-${e??``}`,`svelte-v559t8`),u(a,`d`,W(n))},[()=>ae(W(v),W(t))]),O(e,r)};o(()=>V(a,e=>{W(n)&&e(s)}),`if`,Q,191,6),O(e,i)}),`each`,Q,189,4);var le=G(ce);return o(()=>y(le,17,()=>t.nodes,e=>e.id,(e,t)=>{{let n=q(()=>i().get(W(t).id));o(()=>S(e,{get node(){return W(t)},get params(){return W(n)}}),`component`,Q,198,6,{componentTag:`NodeBox`})}}),`each`,Q,197,4),l(Z),l(K),n(K,e=>Y(d,e),()=>W(d)),B(e=>{J=se(K,0,`view svelte-v559t8`,null,J,{interactive:a()}),u(K,`aria-label`,c()),u(Z,`transform`,`translate(${W(f).x??``} ${W(f).y??``}) scale(${W(f).z??``})`),h(Z,`--hairline: ${e??``}`)},[()=>Math.max(1,1/W(f).z)]),E(`wheel`,K,N),U(`pointerdown`,K,ne),U(`dblclick`,K,z),O(e,K),p(H)}z([`pointerdown`,`dblclick`]);function fe(e){let t=e.parentNode;return document.body.appendChild(e),{destroy(){t&&e.parentNode===document.body&&t.appendChild(e),e.remove()}}}function pe(e){return typeof e==`object`&&!!e&&!Array.isArray(e)&&`fn`in e}function me(e){if(pe(e))try{return`ƒ ${t(e).replace(/\s+/g,` `)}`}catch{return`ƒ`}return typeof e==`number`?J(e):typeof e==`boolean`?String(e):typeof e==`string`?e===``?`–`:e:Array.isArray(e)?e.length===0?`–`:e.map(e=>typeof e==`number`?J(e):String(e)).join(`, `):e==null?`–`:`…`}function he(e,t){try{return a(e.type)}catch{let n=e=>[...e??[]].map(e=>({name:e,kind:`any`,multi:!1}));return{inputs:n(t.inputs.get(e.id)),outputs:n(t.outputs.get(e.id))}}}function ge(e){let t=new Map,n=new Map,r=(e,t,n)=>{let r=e.get(t);r||e.set(t,r=new Set),r.add(n)};for(let i of e.connections??[])r(n,i.from[0],i.from[1]),r(t,i.to[0],i.to[1]);for(let t of e.outputs??[])r(n,t.id,t.pin);return{inputs:t,outputs:n}}function _e(e){let t=ge(e),n=new Map,r=e.nodes.map(e=>{let r=he(e,t),i=g(e.type),a=Object.entries(e.params).map(([e,t])=>({key:e,value:me(t),field:pe(t)}));return n.set(e.id,K(a)),{id:e.id,type:e.type,...e.ref===void 0?{}:{label:e.ref.name},...i===void 0?{}:{category:i},x:0,y:0,inputs:r.inputs,outputs:r.outputs}}),i=(e.connections??[]).map(e=>({from:e.from[0],fromPin:e.from[1],to:e.to[0],toPin:e.to[1]}));return v(r,i,new Map([...n].map(([e,t])=>[e,t.length]))),{nodes:r,edges:i,previews:n}}$[d]=`shared/graph/GraphPanel.svelte`;var ve=I(R(`<button type="button" role="tab"> </button>`),$[d],[[187,14]]),ye=I(R(`<div class="tabs svelte-ul999b" role="tablist" aria-label="graphs"></div>`),$[d],[[185,10]]),be=I(R(`<span class="heading svelte-ul999b"> </span>`),$[d],[[197,10]]),xe=I(R(`<p class="empty svelte-ul999b">This graph could not be laid out.</p>`),$[d],[[215,10]]),Se=I(R(`<div class="backdrop svelte-ul999b" role="presentation"><div class="sheet svelte-ul999b" role="dialog" aria-modal="true"><header class="svelte-ul999b"><!> <span class="meta svelte-ul999b"><!></span> <button class="close svelte-ul999b" type="button" aria-label="close">✕</button></header> <div class="body svelte-ul999b"><!></div> <footer class="svelte-ul999b">scroll to zoom · drag to pan · double-click to fit · read-only</footer></div></div>`),$[d],[[176,2,[[182,4,[[183,6,[[199,8],[202,8]]],[206,6],[222,6]]]]]]),Ce=I(R(`<div class="pcg-graph-panel svelte-ul999b"><button class="thumb svelte-ul999b" type="button"><span class="cap svelte-ul999b"><span class="name svelte-ul999b"> </span> <span class="count svelte-ul999b"><!></span></span> <span class="frame svelte-ul999b"><!></span></button></div> <!>`,1),$[d],[[138,0,[[139,2,[[145,4,[[146,6],[147,6]]],[151,4]]]]]]);function $(e,t){s(new.target),re(t,!0,$);let n=P(t,`title`,3,`graph`),a=r(_(T(t.initial)),`graphs`),c=r(_(!1),`open`),d=r(_(0),`selected`);function h(e){Y(a,e,!0),W(d)>=e.length&&Y(d,0),S()}let g=r(_(T([])),`pictures`),v=r(q(()=>W(g)[Math.min(W(d),W(g).length-1)]??null),`current`),x=r(q(()=>W(a)[Math.min(W(d),W(a).length-1)]?.name??``),`currentName`);function S(){Y(g,W(a).map(e=>{try{return _e(e.json)}catch{return null}}),!0)}f(S);function w(e){X(e.key,`Escape`)&&W(c)&&(e.preventDefault(),Y(c,!1))}var ee={...b(),get setGraphs(){return h}},D=Ce();E(`keydown`,te,w);var k=C(D),j=A(k),M=A(j),F=A(M),I=A(F,!0);l(F);var L=G(F,2),R=A(L),z=e=>{var t=N();B(()=>m(t,`${W(v).nodes.length??``} nodes`)),O(e,t)},ie=e=>{var t=N(`…`);O(e,t)};o(()=>V(R,e=>{W(v)?e(z):e(ie,-1)}),`if`,$,148,8),l(L),l(M);var H=G(M,2),ae=A(H),oe=e=>{o(()=>Q(e,{get nodes(){return W(v).nodes},get edges(){return W(v).edges},get previews(){return W(v).previews},interactive:!1,floor:.09,get label(){return`${W(x)??``} graph, thumbnail`}}),`component`,$,153,8,{componentTag:`GraphView`})};o(()=>V(ae,e=>{W(v)&&e(oe)}),`if`,$,152,6),l(H),l(j),l(k);var K=G(k,2),J=e=>{var t=Se(),n=A(t),r=A(n),s=A(r),f=e=>{var t=ye();o(()=>y(t,23,()=>W(a),e=>e.name,(e,t,n)=>{var r=ve();let i;var a=A(r,!0);l(r),B(()=>{u(r,`aria-selected`,X(W(n),W(d))),i=se(r,1,`svelte-ul999b`,null,i,{on:X(W(n),W(d))}),m(a,W(t).name)}),U(`click`,r,function(){return Y(d,W(n),!0)}),O(e,r)}),`each`,$,186,12),l(t),O(e,t)},p=e=>{var t=be(),n=A(t,!0);l(t),B(()=>m(n,W(x))),O(e,t)};o(()=>V(s,e=>{W(a).length>1?e(f):e(p,-1)}),`if`,$,184,8);var h=G(s,2),g=A(h),_=e=>{var t=N();B(()=>m(t,`${W(v).nodes.length??``} nodes · ${W(v).edges.length??``} connections`)),O(e,t)};o(()=>V(g,e=>{W(v)&&e(_)}),`if`,$,200,10),l(h);var b=G(h,2);l(r);var S=G(r,2),C=A(S),w=e=>{o(()=>Q(e,{get nodes(){return W(v).nodes},get edges(){return W(v).edges},get previews(){return W(v).previews},get label(){return`${W(x)??``} graph`}}),`component`,$,208,10,{componentTag:`GraphView`})},T=e=>{var t=xe();O(e,t)};o(()=>V(C,e=>{W(v)?e(w):e(T,-1)}),`if`,$,207,8),l(S),ne(2),l(n),l(t),i(t,e=>fe?.(e)),B(()=>u(n,`aria-label`,`${W(x)??``} graph`)),U(`pointerdown`,t,function(e){return X(e.target,e.currentTarget)&&Y(c,!1)}),U(`click`,b,function(){return Y(c,!1)}),O(e,t)};return o(()=>V(K,e=>{W(c)&&e(J)}),`if`,$,166,0),B(()=>{u(j,`aria-label`,`show the ${(W(x)||n())??``} graph`),m(I,W(x)||n())}),U(`click`,j,function(){return Y(c,!0)}),O(e,D),p(ee)}z([`click`,`pointerdown`]);function we(e){let t=[];for(let n of e)try{t.push({name:n.name,json:c(n.graph)})}catch(e){console.warn(`graph panel: "${n.name}" could not be serialized, so it is not shown`,e)}return t}function Te(t,n){let r=document.createElement(`div`);n.into.appendChild(r);let i=x($,{target:r,props:{initial:we(t),title:n.title??`graph`}}),a=i;return{set(e){a.setGraphs(we(e))},destroy(){e(i),r.remove()}}}export{le as n,Te as t};