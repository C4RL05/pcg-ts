import{$n as e,Hn as t,Kn as n,Qn as r,Vt as i,_i as a,_r as o,ar as s,bi as c,ci as l,cr as u,di as d,er as f,fi as p,gi as m,hi as h,ii as g,lr as _,mi as v,nr as y,oi as b,or as x,pi as S,ri as C,rr as w,si as T,tr as E,ui as D,ur as O,vi as k,xi as ee,xr as te,yi as A}from"./wordmark-BA9lkr-x.js";var j=class extends Error{constructor(e){super(e),this.name=`GpuCompileError`}};function M(e,t){let n=Math.fround(e);if(!Number.isFinite(n))throw new j(`${t}: value ${e} is not representable as a finite f32 (WGSL kernels compute in f32; keep magnitudes within ~3.4e38)`);return Object.is(n,-0)?`-0f`:`${String(n)}f`}function ne(e){return`${e>>>0}u`}function N(e){return`0x${(e>>>0).toString(16).padStart(8,`0`)}u`}var P=N,re=M(34028234663852886e22,`internal f32 max`);function ie(e,t){let n=P(e);for(let e of t)n=`pcg_hash_mix(${n}, ${e})`;return`pcg_hash_finalize(${n})`}function ae(){let e=[];for(let t=0;t<12;t++){let n=e=>M(u[t*3+e],`internal GRAD3`);e.push(`  vec3<f32>(${n(0)}, ${n(1)}, ${n(2)}),`)}return`var<private> PCG_GRAD3: array<vec3<f32>, 12> = array<vec3<f32>, 12>(
${e.join(`
`)}
);`}var F=e=>t=>M(t,e),oe=new Map([[`PCG_GRAD3`,{deps:[],text:ae()}],[`pcg_hash_mix`,{deps:[],text:`fn pcg_hash_mix(h_in: u32, value: u32) -> u32 {
  var k = value * ${P(h)};
  k = (k << 15u) | (k >> 17u);
  k = k * ${P(m)};
  var h = h_in ^ k;
  ...
  return ${F(`internal PERLIN_SCALE`)(x)} * pcg_mix(
  ...
  let t = ${F(`internal simplex R2`)(y)} - x * x - y * y - z * z;
  if (t <= 0f) {
    return 0f;
  }
  ...
  let s = (p.x + p.y + p.z) * ${F(`internal simplex F3`)(f)};
  let i = i32(floor(p.x + s));
  let j = i32(floor(p.y + s));
  let k = i32(floor(p.z + s));
  let t = f32(i + j + k) * ${F(`internal simplex G3`)(E)};
  let x0 = p.x - (f32(i) - t);
  let y0 = p.y - (f32(j) - t);
  let z0 = p.z - (f32(k) - t);
  var i1: i32;
  ...
  let x1 = x0 - f32(i1) + ${F(`internal simplex G3`)(E)};
  let y1 = y0 - f32(j1) + ${F(`internal simplex G3`)(E)};
  let z1 = z0 - f32(k1) + ${F(`internal simplex G3`)(E)};
  let x2 = x0 - f32(i2) + ${F(`internal simplex 2*G3`)(2*E)};
  let y2 = y0 - f32(j2) + ${F(`internal simplex 2*G3`)(2*E)};
  let z2 = z0 - f32(k2) + ${F(`internal simplex 2*G3`)(2*E)};
  let x3 = x0 - 1f + ${F(`internal simplex 3*G3`)(3*E)};
  let y3 = y0 - 1f + ${F(`internal simplex 3*G3`)(3*E)};
  let z3 = z0 - 1f + ${F(`internal simplex 3*G3`)(3*E)};
...
`,entryPoint:`main`,workgroupSize:64,bindings:s,constSlots:t,uniformBytes:le(t,a),key:`${ce}|${e}`}}var z=e=>e.kind===`column`?`${e.type}x${e.tupleSize}`:`constx${e.tupleSize}@${e.slot}`;function ge(e,t,n){let r=e.kind===`const`?`f32`:e.type,i=t===`f32`&&e.kind===`column`&&e.type===`f32`,a=i?`u32`:r,o=t===`bool`||i?`u32`:t,s=new L,c=e.kind===`column`?s.add(`value`,`read`,a,`value column ${z(e)}`):``,l=e.kind===`column`?{...e,type:a}:e,u=s.add(`target`,`read_write`,o,`target attribute ${t} tupleSize ${n}`),d=(e,n)=>{switch(t){case`f32`:return i?e:n;case`i32`:return r===`f32`?`i32(${e})`:r===`i32`?e:`bitcast<i32>(${e})`;case`u32`:return r===`f32`?`u32(${e})`:r===`u32`?e:`bitcast<u32>(${e})`;default:return`select(0u, 1u, ${e} != ${r===`f32`?`0f`:r===`i32`?`0i`:`0u`})`}},f=[];for(let e=0;e<n;e++){let t=de(c,l,e);f.push(`  ${me(u,n,e)} = ${d(t,I(c,l,e))};`)}return R(`setAttribute|val=${z(e)}|out=${t}x${n}`,he([e]),s.items,[],f.join(`
...
`))}var be={"+x":`f, u, -r`,"-x":`-f, u, r`,"+y":`-r, f, u`,"-y":`r, -f, u`,"+z":`r, u, f`,"-z":`-r, u, -f`};function xe(e,t,n){let r=new L,i=e.kind===`column`?r.add(`direction`,`read`,e.type,`direction column ${z(e)}`):``,a=r.add(`rot`,`read_write`,`f32`,`attribute rot: f32 tupleSize 4`),o=M(1e-12,`internal ORIENT_PARALLEL_EPS`),s=`  let d = vec3<f32>(${[0,1,2].map(t=>I(i,e,t)).join(`, `)});
  ...
  ${f}[co + 1u] = ${d}[cs + 1u];
  ${f}[co + 2u] = ${d}[cs + 2u];
  ${f}[co + 3u] = 0f;`:``}`;return R(`spawnInstances|rot=${+!!e}|scl=${+!!t}${n?`|perm`:``}${i?`|color=${r}`:``}`,0,a.items,[],g,n)}var Ce=64,we=`wgsl2`,Te=[`x`,`y`,`z`,`w`];function B(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}function Ee(e,t,n){return new j(`${e}: ${t} has tupleSize ${n}, but GPU kernels support tuple sizes 1 to 4; evaluate this field on the CPU instead, or split it into components`)}function V(e,t,n){let r=1;for(let i of n)if(i!==1){if(r!==1&&r!==i)throw new j(`${t}: ${e}: incompatible tuple sizes ${r} and ${i}`);r=i}return r}var De=class{layout;params;lines=[];libRoots=new Set;usesSeed=!1;valueNumbers=new Map;bindings=new Map;helpers=new Map;helperTexts=[];helperCounters=new Map;varCounter=0;constructor(e,t,n){this.layout=e,this.params=n,t.forEach((t,n)=>{this.bindings.set(t,{name:t,varName:`in${n}`,binding:n+1,attr:e.attributes[t]})})}paramSlot(e){let t=this.params.slots.get(e);if(t===void 0)throw Error(`internal: param ${JSON.stringify(e)} was not pre-planned`);return{slot:t,arity:this.params.arities[t]}}attrIsSlot(e,t){let n=this.params.attrIsSlots.get(Z(e,t));if(n===void 0)throw Error(`internal: attributeIs ${Z(e,t)} was not pre-planned`);return n}emit(e,t){let n=this.valueNumbers.get(e);if(n)return n;let r={ref:`v${this.varCounter++}`,size:t};return this.lines.push(`  let ${r.ref} = ${e};`),this.valueNumbers.set(e,r),r}binding(e){let t=this.bindings.get(e);if(!t)throw Error(`internal: attribute ${JSON.stringify(e)} was not pre-bound`);return t}boundAttrs(){return[...this.bindings.values()]}helper(e,t){let n=this.helpers.get(t);if(n)return n;let r=this.helperCounters.get(e)??0;this.helperCounters.set(e,r+1);let i=`pcg_${e}_${r}`;return this.helpers.set(t,i),this.helperTexts.push(t.replaceAll(`@NAME@`,i)),i}helperBlocks(){return this.helperTexts}};function H(e,t){return e.size===t?e.ref:`vec${t}<f32>(${e.ref})`}function U(e){return e===1?`0f`:`vec${e}<f32>(0f)`}function W(e){return e===1?`1f`:`vec${e}<f32>(1f)`}function Oe(e,t){return e===1?t:`vec${e}<f32>(${t})`}function ke(e){let t=Object.keys(e.attributes).sort();return t.length===0?`the layout declares no attributes`:`layout attributes: ${t.map(e=>JSON.stringify(e)).join(`, `)}`}function Ae(e,t,n,r,i){let a=e.layout.attributes;if(!Object.hasOwn(a,n))throw new j(`${t}: ${i}attribute ${JSON.stringify(n)} is not in the kernel layout; ${ke(e.layout)}`);let o=a[n];if(o.type===`string`)throw new j(`${t}: ${i}attribute ${JSON.stringify(n)} has type "string"; a string column has no numeric value to read — test it with { fn: "attributeIs", name: ${JSON.stringify(n)}, value: "..." }, which is 1 where it matches and 0 elsewhere, or select on it with { fn: "byAttribute", name: ${JSON.stringify(n)}, cases: {...}, default: ... }, or read a numeric or bool attribute`);if(r!==void 0&&o.tupleSize!==r)throw new j(`${t}: ${i}attribute ${JSON.stringify(n)}: expected tupleSize ${r}, got ${o.tupleSize} in the kernel layout`);if(o.tupleSize>4)throw Ee(t,`${i}attribute ${JSON.stringify(n)}`,o.tupleSize);return o}function je(e,t,n,r,i){let a=Ae(e,t,n,r,i),o=e.binding(n),s=a.tupleSize,c=e=>a.type===`f32`?e:`f32(${e})`;if(s===1)return e.emit(c(`${o.varName}[i]`),1);let l=[];for(let e=0;e<s;e++)l.push(c(`${o.varName}[${G(s,e)}]`));return e.emit(`vec${s}<f32>(${l.join(`, `)})`,s)}function G(e,t){return e===1?`i`:t===0?`i * ${e}u`:`i * ${e}u + ${t}u`}var K=new Map;function Me(){return[...K.keys()].sort()}function Ne(e,t,n){let r=String(e.fn),i=K.get(r);if(!i)throw new j(`${t}: field fn "${r}" is not supported by the WGSL compiler; supported fns: ${Me().join(`, `)}`);return i(e,t,n)}function q(e,t,n){return typeof e==`number`?n.emit(M(e,t),1):Array.isArray(e)?Pe(e,t,n):Ne(e,t,n)}function Pe(e,t,n){let r=e.length;if(r>4)throw Ee(t,`constant`,r);if(r===1)return n.emit(M(e[0],t),1);let i=e.map(e=>M(e,t));return n.emit(`vec${r}<f32>(${i.join(`, `)})`,r)}function J(e){return e.args}K.set(`constant`,(e,t,n)=>{let r=e.value;return typeof r==`number`?n.emit(M(r,`${t}.value`),1):Pe(r,`${t}.value`,n)}),K.set(`attribute`,(e,t,n)=>{let r=e.name,i=e.tupleSize;return je(n,t,r,i,``)});function Fe(e,t,n,r,i){let a=e.layout.attributes;if(!Object.hasOwn(a,n))throw new j(`${t}: ${r}: attribute ${JSON.stringify(n)} is not in the kernel layout; ${ke(e.layout)}`);let o=a[n];if(o.type!==`string`)throw new j(`${t}: ${r}: attribute ${JSON.stringify(n)} has type ${JSON.stringify(o.type)}, but ${r} ${i} a string attribute; compare a numeric attribute with { fn: "eq", args: [{ fn: "attribute", name: ${JSON.stringify(n)} }, <number>] }`);return o}K.set(`attributeIs`,(e,t,n)=>{let r=e.name,i=e.value,a=Fe(n,t,r,`attributeIs`,`tests`),o=n.binding(r),s=n.attrIsSlot(r,i);return n.emit(`select(0f, 1f, f32(${o.varName}[${G(a.tupleSize,0)}]) == params.consts[${s}].x)`,1)}),K.set(`byAttribute`,(e,t,n)=>{let r=e.name,i=e.cases,a=Fe(n,t,r,`byAttribute`,`selects on`),o=n.binding(r),s=Object.keys(i).sort(),c=s.map(e=>q(i[e],`${t}.cases[${JSON.stringify(e)}]`,n)),l=q(e.default,`${t}.default`,n),u=V(`byAttribute`,t,[...c.map(e=>e.size),l.size]),d=n.emit(`f32(${o.varName}[${G(a.tupleSize,0)}])`,1),f=H(l,u);return s.forEach((e,t)=>{let i=n.attrIsSlot(r,e);f=`select(${f}, ${H(c[t],u)}, ${d.ref} == params.consts[${i}].x)`}),n.emit(f,u)}),K.set(`position`,(e,t,n)=>je(n,t,`P`,3,`position reads `)),K.set(`param`,(e,t,n)=>{let r=e.name,i=T(e);if(i!==void 0)return Ne(i,`${t}<${r}>`,n);let{slot:a,arity:o}=n.paramSlot(r),s=e=>`params.consts[${a}].${Te[e]}`;return o===1?n.emit(s(0),1):n.emit(`vec${o}<f32>(${Array.from({length:o},(e,t)=>s(t)).join(`, `)})`,o)}),K.set(`index`,(e,t,n)=>n.emit(`f32(i)`,1)),K.set(`fraction`,(e,t,n)=>n.emit(`f32(i) / f32(max(params.count, 2u) - 1u)`,1)),K.set(`nodeSeed`,(e,t,n)=>(n.usesSeed=!0,n.emit(`f32(params.seed >> 8u) * 256.0 + f32(params.seed & 0xFFu)`,1))),K.set(`randomField`,(e,t,n)=>{let r=e.key,i=typeof r==`string`?c(r):(r??0)>>>0;n.usesSeed=!0,n.libRoots.add(`pcg_hash3`),n.libRoots.add(`pcg_hash4`),n.libRoots.add(`pcg_hash_float`);let a=`randomField's per-point identity reads `,o=Ae(n,t,`P`,void 0,a);if(o.tupleSize<3)throw new j(`${t}: ${a}attribute "P" with x, y and z (tupleSize 3), got tupleSize ${o.tupleSize}`);let s=n.binding(`P`).varName,l=e=>{let t=`${s}[${G(o.tupleSize,e)}]`;return o.type===`f32`?`bitcast<u32>(${t})`:`bitcast<u32>(f32(${t}))`},u=`0u`,d=Object.hasOwn(n.layout.attributes,`seed`)?n.layout.attributes.seed:void 0;if(d!==void 0){if(d.tupleSize!==1||d.type!==`u32`&&d.type!==`i32`)throw new j(`${t}: ${a}the standard point attribute "seed" as a u32 or i32 scalar, but the layout has it as ${d.type}x${d.tupleSize}; this field resolves on the CPU instead`);let e=n.binding(`seed`).varName;u=d.type===`u32`?`${e}[i]`:`bitcast<u32>(${e}[i])`}let f=`pcg_hash4(${l(0)}, ${l(1)}, ${l(2)}, ${u})`;return n.emit(`pcg_hash_float(pcg_hash3(params.seed, ${N(i)}, ${f}))`,1)}),K.set(`randomFrom`,(e,t,n)=>{let r=e.key,i=typeof r==`string`?c(r):(r??0)>>>0,a=q(J(e)[0],`${t}.args[0]`,n);if(a.size!==1)throw new j(`${t}: randomFrom's key must be ONE number per element, got width ${a.size}; reduce it first, e.g. component(<expr>, 0)`);return n.usesSeed=!0,n.libRoots.add(`pcg_hash3`),n.libRoots.add(`pcg_hash_float`),n.emit(`pcg_hash_float(pcg_hash3(params.seed, ${N(i)}, bitcast<u32>(${H(a,1)})))`,1)});function Y(e,t,n){K.set(e,(r,i,a)=>{let o=J(r),s=[];for(let e=0;e<t;e++)s.push(q(o[e],`${i}.args[${e}]`,a));let c=V(e,i,s.map(e=>e.size)),l=s.map(e=>H(e,c));return a.emit(n(l,c),c)})}Y(`add`,2,e=>`${e[0]} + ${e[1]}`),Y(`sub`,2,e=>`${e[0]} - ${e[1]}`),Y(`mul`,2,e=>`${e[0]} * ${e[1]}`),Y(`div`,2,e=>`${e[0]} / ${e[1]}`),Y(`min`,2,e=>`min(${e[0]}, ${e[1]})`),Y(`max`,2,e=>`max(${e[0]}, ${e[1]})`),Y(`abs`,1,e=>`abs(${e[0]})`),Y(`floor`,1,e=>`floor(${e[0]})`),Y(`trunc`,1,e=>`trunc(${e[0]})`),Y(`fract`,1,e=>`${e[0]} - floor(${e[0]})`),Y(`mod`,2,e=>`${e[0]} - ${e[1]} * floor(${e[0]} / ${e[1]})`),Y(`rem`,2,e=>`${e[0]} - ${e[1]} * trunc(${e[0]} / ${e[1]})`),Y(`sign`,1,(e,t)=>`select(${U(t)}, ${W(t)}, ${e[0]} > ${U(t)}) - select(${U(t)}, ${W(t)}, ${e[0]} < ${U(t)})`),Y(`sin`,1,e=>`sin(${e[0]})`),Y(`cos`,1,e=>`cos(${e[0]})`),Y(`tan`,1,e=>`tan(${e[0]})`),Y(`asin`,1,e=>`asin(${e[0]})`),Y(`acos`,1,e=>`acos(${e[0]})`),Y(`atan`,1,e=>`atan(${e[0]})`),Y(`atan2`,2,e=>`atan2(${e[0]}, ${e[1]})`),Y(`sqrt`,1,e=>`sqrt(${e[0]})`),Y(`pow`,2,e=>`pow(${e[0]}, ${e[1]})`),Y(`exp`,1,e=>`exp(${e[0]})`),Y(`exp2`,1,e=>`exp2(${e[0]})`),Y(`log`,1,e=>`log(${e[0]})`),Y(`log2`,1,e=>`log2(${e[0]})`),Y(`clamp`,3,e=>`clamp(${e[0]}, ${e[1]}, ${e[2]})`),Y(`lerp`,3,e=>`${e[0]} + (${e[1]} - ${e[0]}) * ${e[2]}`),Y(`select`,3,(e,t)=>`select(${e[2]}, ${e[1]}, ${e[0]} != ${U(t)})`),Y(`lt`,2,(e,t)=>`select(${U(t)}, ${W(t)}, ${e[0]} < ${e[1]})`),Y(`le`,2,(e,t)=>`select(${U(t)}, ${W(t)}, ${e[0]} <= ${e[1]})`),Y(`gt`,2,(e,t)=>`select(${U(t)}, ${W(t)}, ${e[0]} > ${e[1]})`),Y(`ge`,2,(e,t)=>`select(${U(t)}, ${W(t)}, ${e[0]} >= ${e[1]})`),Y(`eq`,2,(e,t)=>`select(${U(t)}, ${W(t)}, ${e[0]} == ${e[1]})`),Y(`ne`,2,(e,t)=>`select(${U(t)}, ${W(t)}, ${e[0]} != ${e[1]})`),Y(`step`,2,(e,t)=>`select(${U(t)}, ${W(t)}, ${e[1]} >= ${e[0]})`),K.set(`remap`,(e,t,n)=>{let r=J(e).map((e,r)=>q(e,`${t}.args[${r}]`,n)),i=V(`remap`,t,r.map(e=>e.size)),[a,o,s,c,l]=r.map(e=>H(e,i)),u=n.emit(`${s} - ${o}`,i),d=U(i),f=n.emit(`select(${u.ref}, ${W(i)}, ${u.ref} == ${d})`,i);return n.emit(`select(${c} + ((${a} - ${o}) / ${f.ref}) * (${l} - ${c}), ${c}, ${u.ref} == ${d})`,i)}),K.set(`dot`,(e,t,n)=>{let r=J(e),i=q(r[0],`${t}.args[0]`,n),a=q(r[1],`${t}.args[1]`,n),o=V(`dot`,t,[i.size,a.size]);return o===1?n.emit(`${i.ref} * ${a.ref}`,1):n.emit(`dot(${H(i,o)}, ${H(a,o)})`,1)}),K.set(`cross`,(e,t,n)=>{let r=J(e),i=q(r[0],`${t}.args[0]`,n),a=q(r[1],`${t}.args[1]`,n);for(let[e,n]of[[`a`,i],[`b`,a]])if(n.size!==3)throw new j(`${t}: cross: argument \`${e}\` has width ${n.size}, but a cross product is defined for width 3 only. Scalars do NOT broadcast into one here — build a vec3 with \`vec(x, y, z)\`, or use \`dot\` for a product that works at any width.`);return n.emit(`cross(${i.ref}, ${a.ref})`,3)}),K.set(`smoothstep`,(e,t,n)=>{let r=J(e).map((e,r)=>q(e,`${t}.args[${r}]`,n)),i=V(`smoothstep`,t,r.map(e=>e.size)),[a,o,s]=r.map(e=>H(e,i)),c=U(i),l=W(i),u=n.emit(`select(${c}, ${l}, ${a} == ${o})`,i),d=n.emit(`${o} - ${a}`,i),f=n.emit(`select(${d.ref}, ${l}, ${u.ref} != ${c})`,i),p=n.emit(`clamp((${s} - ${a}) / ${f.ref}, ${c}, ${l})`,i),m=n.emit(`(${p.ref} * ${p.ref}) * (${Oe(i,`3f`)} - ${Oe(i,`2f`)} * ${p.ref})`,i);return n.emit(`select(${m.ref}, select(${c}, ${l}, ${s} >= ${a}), ${u.ref} != ${c})`,i)}),K.set(`distance`,(e,t,n)=>{let r=J(e),i=q(r[0],`${t}.args[0]`,n),a=q(r[1],`${t}.args[1]`,n),o=V(`distance`,t,[i.size,a.size]),s=n.emit(`${H(i,o)} - ${H(a,o)}`,o);if(o===1)return n.emit(`abs(${s.ref})`,1);let c=n.emit(`dot(${s.ref}, ${s.ref})`,1);return n.emit(`sqrt(${c.ref})`,1)}),K.set(`length`,(e,t,n)=>{let r=q(J(e)[0],`${t}.args[0]`,n);if(r.size===1)return n.emit(`abs(${r.ref})`,1);let i=n.emit(`dot(${r.ref}, ${r.ref})`,1);return n.emit(`sqrt(${i.ref})`,1)}),K.set(`normalize`,(e,t,n)=>{let r=q(J(e)[0],`${t}.args[0]`,n),i=r.size===1?n.emit(`${r.ref} * ${r.ref}`,1):n.emit(`dot(${r.ref}, ${r.ref})`,1),a=n.emit(`select(0f, 1f / sqrt(${i.ref}), ${i.ref} > 0f)`,1);return n.emit(`${r.ref} * ${a.ref}`,r.size)}),K.set(`vec`,(e,t,n)=>{let r=J(e).map((e,r)=>q(e,`${t}.args[${r}]`,n)),i=r.reduce((e,t)=>e+t.size,0);if(i>4)throw Ee(t,`vec result`,i);return r.length===1?r[0]:n.emit(`vec${i}<f32>(${r.map(e=>e.ref).join(`, `)})`,i)}),K.set(`component`,(e,t,n)=>{let r=q(J(e)[0],`${t}.args[0]`,n),i=e.index;if(i>=r.size)throw new j(`${t}: component: index ${i} out of range for tupleSize ${r.size}`);return r.size===1?r:n.emit(`${r.ref}.${Te[i]}`,1)}),K.set(`ramp`,(e,t,n)=>{let r=q(J(e)[0],`${t}.args[0]`,n);if(r.size!==1)throw new j(`${t}: ramp: input must be scalar, got tupleSize ${r.size}`);let i=e.stops,a=n.helper(`ramp`,Ie(i,`${t}.stops`));return n.emit(`${a}(${r.ref})`,1)});function Ie(e,t){let n=e=>M(e,t),r=e.length-1,i=[];i.push(`fn @NAME@(t: f32) -> f32 {`),i.push(`  if (t <= ${n(e[0][0])}) {`),i.push(`    return ${n(e[0][1])};`),i.push(`  }`),i.push(`  if (t >= ${n(e[r][0])}) {`),i.push(`    return ${n(e[r][1])};`),i.push(`  }`);let a=t=>{let r=e[t-1][0],i=e[t-1][1],a=e[t][0]-r,o=e[t][1]-i;return`${n(i)} + ${n(o)} * ((t - ${n(r)}) / ${n(a)})`};for(let t=1;t<r;t++)i.push(`  if (t <= ${n(e[t][0])}) {`),i.push(`    return ${a(t)};`),i.push(`  }`);return r>=1?i.push(`  return ${a(r)};`):i.push(`  return t;`),i.push(`}`),i.join(`
`)}var Le={valueNoise:e,perlinNoise:s,simplexNoise:w,worleyNoise:r},Re={valueNoise:`pcg_value_noise`,perlinNoise:`pcg_perlin_noise`,simplexNoise:`pcg_simplex_noise`};function ze(e){return e.opts??{}}function Be(e,t,n,r){let i=ze(t),a=i.position===void 0?n:`${n}.opts.position`,o=i.position===void 0?je(r,n,`P`,3,`${e} position reads `):q(i.position,a,r);if(o.size!==3)throw new j(`${a}: ${e}: position field must have tupleSize 3, got ${o.size}`);let s=M(i.frequency??1,`${n}.opts.frequency`),[c,l,u]=i.offset??[0,0,0],d=`vec3<f32>(${M(c,`${n}.opts.offset`)}, ${M(l,`${n}.opts.offset`)}, ${M(u,`${n}.opts.offset`)})`;return r.emit(`${o.ref} * ${s} + ${d}`,3)}function Ve(e){return e.libRoots.add(`pcg_hash_mix`),e.libRoots.add(`pcg_hash_finalize`),e.helper(`hash2`,`fn @NAME@(a: u32, b: u32) -> u32 {
  return pcg_hash_finalize(pcg_hash_mix(pcg_hash_mix(${N(A(2))}, a), b));
}`)}function He(e){return typeof e==`object`&&!!e}function Ue(e,t,n){if(e===void 0)return`0u`;if(typeof e==`number`)return ne(e);let r=e.name;if(typeof r!=`string`||r===``)throw new j(`${t}.opts.seed.variant: param requires a non-empty string name`);if(T(e)!==void 0)throw new j(`${t}.opts.seed.variant: param ${JSON.stringify(r)} is bound to a Field, and a seed is resolved in u32 integer math with no per-element form; bind an integer, or evaluate this field on the CPU`);let{slot:i}=n.paramSlot(r);return`u32(params.consts[${i}].x)`}function We(e,t,n){return He(e)?(n.usesSeed=!0,{expr:`${Ve(n)}(params.seed, ${Ue(e.variant,t,n)})`}):{literal:(e??0)>>>0}}function Ge(e,t,n){let r=Le[e];return`literal`in t?N(O(r,t.literal)):`${Ve(n)}(${N(r)}, ${t.expr})`}function Ke(e,t,n,r){let[i,a]=n,o=a-i;return e.emit(`(${t.ref} - ${M(i,r)}) / ${M(o,r)}`,1)}for(let e of[`valueNoise`,`perlinNoise`,`simplexNoise`])K.set(e,(t,n,r)=>{let i=ze(t),a=Ge(e,We(i.seed,n,r),r),o=Be(e,t,n,r);r.libRoots.add(Re[e]);let s=r.emit(`${Re[e]}(${a}, ${o.ref})`,1);return i.normalized===!0?Ke(r,s,_[e],`${n}.opts.normalized`):s});K.set(`worleyNoise`,(e,t,n)=>{let r=ze(e),i=r.output??`f1`,a=r.exact===!0,o=Ge(`worleyNoise`,We(r.seed,t,n),n),s=Be(`worleyNoise`,e,t,n);n.libRoots.add(`pcg_worley`);let c=i!==`f1`,l=n.emit(`pcg_worley(${o}, ${s.ref}, ${a}, ${c})`,2),u=i===`f1`?n.emit(`${l.ref}.x`,1):i===`f2`?n.emit(`${l.ref}.y`,1):n.emit(`${l.ref}.y - ${l.ref}.x`,1);return r.normalized===!0?Ke(n,u,_.worleyNoise[i],`${t}.opts.normalized`):u});function qe(e){return e===`worleyNoise`?_.worleyNoise.f1:_[e]}function Je(e,t,n){return e===`worleyNoise`?`pcg_worley(${t}, ${n}, false, false).x`:`${Re[e]}(${t}, ${n})`}K.set(`fbm`,(e,t,n)=>{let r=e.base,i=ze(e),a=i.octaves??4,o=i.lacunarity??2,s=i.gain??.5,c=i.frequency??1,[l,u,d]=i.offset??[0,0,0],f=We(i.seed,t,n),p=i.position===void 0?t:`${t}.opts.position`,m=i.position===void 0?je(n,t,`P`,3,`fbm position reads `):q(i.position,p,n);if(m.size!==3)throw new j(`${p}: fbm: position field must have tupleSize 3, got ${m.size}`);let h=qe(r),g=[],_=[],v=[],y=1,b=c,x=0,S=0;for(let e=0;e<a;e++)g.push(Ge(r,`literal`in f?{literal:k(f.literal,e)}:{expr:`${Ve(n)}(ns, ${ne(e)})`},n)),_.push(M(b,`${t}.opts.frequency`)),v.push(M(y,`${t}.opts.gain`)),x+=y>=0?y*h[0]:y*h[1],S+=y>=0?y*h[1]:y*h[0],y*=s,b*=o;n.libRoots.add(r===`worleyNoise`?`pcg_worley`:Re[r]);let C=`vec3<f32>(${M(l,`${t}.opts.offset`)}, ${M(u,`${t}.opts.offset`)}, ${M(d,`${t}.opts.offset`)})`,w=`fn @NAME@(p: vec3<f32>) -> f32 {
...
${[...c.lines,...d].join(`
`)}
}`],b=m.map(e=>`${JSON.stringify(e.name)}:${e.attr.type}x${e.attr.tupleSize}`).join(`,`),x=`${i.key}${at(s)}`;return it.set(r,x),{wgsl:`${y.join(`

`)}\n`,entryPoint:`main`,workgroupSize:Ce,outTupleSize:u,outType:l,inputs:h,bindings:{uniforms:0,output:g},constSlots:v,paramNames:s.names,attrIsSlots:s.attrIs,uniformBytes:le(v),usesSeed:c.usesSeed,key:`${we}|spec=${x}|layout=[${b}]`}}var Q={MAP_READ:1,COPY_SRC:4,COPY_DST:8,VERTEX:32,UNIFORM:64,STORAGE:128},_t={READ:1},vt=256;function yt(e){let t=vt;for(;t<e;)t*=2;return t}var bt=class{device;maxPooledBytes;free=new Map;meta=new Map;detachedSet=new WeakSet;idleBytes=0;idleCount=0;created=0;reused=0;destroyed=0;detachedTotal=0;detachedLive=0;detachedLiveBytes=0;constructor(e,t){this.device=e,this.maxPooledBytes=t}acquire(e,t){let n=yt(e),r=`${t}|${n}`,i=this.free.get(r)?.pop();if(i!==void 0)return this.idleBytes-=n,this.idleCount--,this.reused++,i;let a=this.device.createBuffer({size:n,usage:t});return this.meta.set(a,{key:r,bytes:n}),this.created++,a}release(e){let t=this.meta.get(e);if(t===void 0)throw this.detachedSet.has(e)?Error(`BufferPool.release: buffer was detached from this pool, so the pool no longer owns it and cannot reclaim it; destroy it through the DetachedBuffer that detach() returned (or the handle wrapping it) and stop releasing it`):Error(`BufferPool.release: buffer was not acquired from this pool`);if(this.idleBytes+t.bytes>this.maxPooledBytes){this.meta.delete(e),e.destroy(),this.destroyed++;return}let n=this.free.get(t.key);n===void 0&&(n=[],this.free.set(t.key,n)),n.push(e),this.idleBytes+=t.bytes,this.idleCount++}detach(e){let t=this.meta.get(e);if(t===void 0)throw Error(this.detachedSet.has(e)?`BufferPool.detach: buffer was already detached from this pool; ownership can only leave once — reuse the DetachedBuffer the first detach() returned`:`BufferPool.detach: buffer was not acquired from this pool`);this.meta.delete(e),this.detachedSet.add(e),this.detachedTotal++,this.detachedLive++,this.detachedLiveBytes+=t.bytes;let n=!1,r=this;return{buffer:e,bytes:t.bytes,get destroyed(){return n},destroy(){n||(n=!0,r.detachedLive--,r.detachedLiveBytes-=t.bytes,r.destroyed++,e.destroy())}}}get stats(){return{buffersCreated:this.created,buffersReused:this.reused,buffersDestroyed:this.destroyed,pooledBuffers:this.idleCount,pooledBytes:this.idleBytes,buffersDetached:this.detachedTotal,detachedBuffers:this.detachedLive,detachedBytes:this.detachedLiveBytes}}dispose(){for(let e of this.free.values())for(let t of e)this.meta.delete(t),t.destroy(),this.destroyed++;this.free.clear(),this.idleBytes=0,this.idleCount=0}},xt=`webgpu`,St=class{backend=xt;byteLength;detached;label;constructor(e,t,n){this.detached=e,this.byteLength=t,this.label=n}get disposed(){return this.detached.destroyed}get resource(){if(this.detached.destroyed)throw Error(`device transforms handle (${this.label}) was disposed; its GPU buffer is destroyed and cannot be bound. Dispose a handle only after the last frame that reads it, and re-cook to obtain a fresh one (device-resident outputs are never memoized, so every cook produces a new handle)`);return this.detached.buffer}dispose(){this.detached.destroy()}};function Ct(e,t,n){return new St(e,t,n)}var wt=65535;function Tt(e,t){let n=wt*e;return Math.max(e,Math.floor(Math.min(t??n,n)/e)*e)}var Et=16,Dt=`pcg-resident-run/5`;function Ot(e){return e.format===Dt?e:null}var kt={reason:`run-plan-failed`},At=[`+x`,`-x`,`+y`,`-y`,`+z`,`-z`];function jt(e){if(typeof e!=`object`||!e||Array.isArray(e))return!1;let t=e;if(t.fn===`randomField`)return!0;for(let e of D(t))if(jt(e))return!0;return!1}function Mt(e){return Array.isArray(e)&&e.length===3&&e.every(e=>typeof e==`number`&&Number.isFinite(e))}var $=class extends Error{};function Nt(e,t,n,r,i){let a=[...e].map(([e,t])=>({name:e,slot:t})),o=i||r===null,s=t.reduce((e,t)=>e+t.bytes,0),c=n.reduce((e,t)=>e+t,0),l=o?a.reduce((e,n)=>e+t[n.slot].bytes,0):0;return{writtenList:a,materialize:o,totalBytes:s+c+l+(r?.bytes??0)+(r?.colorBytes??0)+(r?.permBytes??0)}}function Pt(e,t,n,r){let i=t.count,a=new Map(Object.entries(t.attributes)),o=[],s=new Map,c=[],l=new Map,u=[],d=[],f=null,p=()=>Object.fromEntries(a),m=e=>{let t=s.get(e);if(t!==void 0)return t;let n=a.get(e);if(n===void 0||n.type===`string`)throw new $(e);let r=o.length;return o.push({bytes:i*n.tupleSize*4,init:`attr`,name:e}),s.set(e,r),r},h=(e,t,n)=>{let r=o.length;return o.push({bytes:i*t*4,init:n,name:e}),s.set(e,r),r},_=(e,t,n)=>{let r=a.get(e);if(r===void 0||r.type!==t||r.tupleSize!==n)throw new $(e)},v=(e,t,n)=>{let r=t.length/4;if(r>=4)throw Error(`resident run: "${n}" needs more than 4 uniform constant slots for its constant params; raise MAX_APPLY_CONST_SLOTS in applyKernels.ts (each slot costs 16 bytes of the per-chunk uniform and nothing else)`);for(let n=0;n<4;n++)t.push(n<e.length?e[n]:0);return{kind:`const`,tupleSize:e.length,slot:r}},y=(e,t,n,a,o,s)=>{let u;if(ee(e)){let t=g(e,r);if(t===void 0)throw new $(`no spec`);if(l.has(`P`)&&jt(t))throw new $(`identity after P write`);u=t}else if(typeof e==`number`||Array.isArray(e)&&e.every(e=>typeof e==`number`)){let t=typeof e==`number`?[e]:e;if(t.length<1||t.length>4||a!==null&&!a.includes(t.length))throw new $(`tuple`);for(let e of t)if(!Number.isFinite(Math.fround(e)))throw new $(`f32 range`);return{param:v(t,o,s),ref:null}}else throw new $(`bad param value`);let d;try{d=gt(u,{attributes:p()})}catch{throw new $(`compile`)}if(d.inputs.length+1>8)throw new $(`buffers`);if(a!==null&&!a.includes(d.outTupleSize))throw new $(`tuple`);if(d.attrIsSlots.length>0)throw new $(`attributeIs / byAttribute need a per-dispatch string table`);let f=ct(u,d);if(`problem`in f)throw new $(`param bindings`);let h=c.length;return c.push(i*d.outTupleSize*4),n.push({key:d.key,wgsl:d.wgsl,entryPoint:d.entryPoint,workgroupSize:d.workgroupSize,seed:t,uniformsBinding:d.bindings.uniforms,uniformBytes:d.uniformBytes,consts:f.values,perBatch:!1,bindings:[...d.inputs.map(e=>({binding:e.binding,ref:{kind:`slot`,index:m(e.name)}})),{binding:d.bindings.output,ref:{kind:`col`,index:h}}]}),{param:{kind:`column`,type:d.outType,tupleSize:d.outTupleSize},ref:{kind:`col`,index:h}}},b=(e,t,n,r,i=!1)=>{if(e.constSlots*4!==r.length)throw Error(`resident run: apply kernel "${e.key}" declares ${e.constSlots} constant slots but the planner allocated ${r.length/4}`);return{key:e.key,wgsl:e.wgsl,entryPoint:e.entryPoint,workgroupSize:e.workgroupSize,seed:t,uniformsBinding:0,uniformBytes:e.uniformBytes,consts:r,perBatch:i,bindings:e.bindings.map(e=>{let t=n[e.role];if(t===void 0)throw new $(`unmapped role ${e.role}`);return{binding:e.binding,ref:t}})}};try{for(let t of e){let n=t===e[e.length-1],r=[],o=[],s=t.params;switch(t.kind){case`setAttribute`:{let e=s.name,n=s.type,i=s.tupleSize;if(typeof e!=`string`)throw new $(`name`);if(n!==`f32`&&n!==`i32`&&n!==`u32`&&n!==`bool`)throw new $(`type`);if(typeof i!=`number`||!Number.isInteger(i)||i<1||i>4)throw new $(`tupleSize`);let c=typeof s.seed==`number`?s.seed:NaN,d=c===0?t.seed:k(t.seed,c),{param:f,ref:p}=y(s.value,d,r,i===1?[1]:[1,i],o,t.kind),m=h(e,i,`none`);a.set(e,{type:n,tupleSize:i}),l.set(e,m),u.push({op:`replace`,name:e,type:n,tupleSize:i});let g={target:{kind:`slot`,index:m}};p!==null&&(g.value=p),r.push(b(ge(f,n,i),0,g,o));break}case`transformPoints`:{_(`P`,`f32`,3);let e=y(s.translate,t.seed,r,[1,3],o,t.kind),n=y(s.rotateEuler,t.seed,r,[1,3],o,t.kind),i=y(s.scale,t.seed,r,[1,3],o,t.kind),c=a.get(`rot`),u=c!==void 0&&c.type===`f32`&&c.tupleSize===4,d=a.get(`scale`),f=d!==void 0&&d.type===`f32`&&d.tupleSize===3,p=m(`P`);l.set(`P`,p);let h={P:{kind:`slot`,index:p}};if(e.ref!==null&&(h.translate=e.ref),n.ref!==null&&(h.rotateEuler=n.ref),i.ref!==null&&(h.scale=i.ref),u){let e=m(`rot`);l.set(`rot`,e),h.rot={kind:`slot`,index:e}}if(f){let e=m(`scale`);l.set(`scale`,e),h.scaleAttr={kind:`slot`,index:e}}r.push(b(ve(e.param,n.param,i.param,u,f),0,h,o));break}case`jitterPoints`:{if(_(`P`,`f32`,3),l.has(`P`))throw new $(`identity after P write`);let e=typeof s.seed==`number`?s.seed:NaN,n=k(t.seed,e),i=y(s.amount,n,r,[1,3],o,t.kind),c=a.get(`seed`),u=c!==void 0;if(u&&(c.type!==`u32`||c.tupleSize!==1))throw new $(`seed attribute shape`);let d=m(`P`);l.set(`P`,d);let f={P:{kind:`slot`,index:d}};i.ref!==null&&(f.amount=i.ref),u&&(f.seed={kind:`slot`,index:m(`seed`)}),r.push(b(ye(i.param,u),n,f,o));break}case`orientAlongVector`:{let e=s.axis;if(!At.includes(e))throw new $(`axis`);if(!Mt(s.up))throw new $(`up`);let n=y(s.direction,t.seed,r,[1,3],o,t.kind),i=s.up,c=i[0]*i[0]+i[1]*i[1]+i[2]*i[2],d=c>0?1/Math.sqrt(c):0,f=[i[0]*d,i[1]*d,i[2]*d];for(let e of f)if(!Number.isFinite(Math.fround(e)))throw new $(`up range`);let p=v(f,o,t.kind),g=a.get(`rot`),_=g!==void 0&&g.type===`f32`&&g.tupleSize===4?m(`rot`):h(`rot`,4,`quat-default`);a.set(`rot`,{type:`f32`,tupleSize:4}),l.set(`rot`,_),u.push({op:`ensure-rot`});let x={rot:{kind:`slot`,index:_}};n.ref!==null&&(x.direction=n.ref),r.push(b(xe(n.param,e,p),0,x,o));break}case`spawnInstances`:{if(!n)throw new $(`spawnInstances must be the run's last member`);let e=s.assetId;if(typeof e!=`string`||e===``)throw new $(`assetId`);if(_(`P`,`f32`,3),i>1048576)throw new $(`${i} instances over MAX_INSTANCES`);let t=s.assetAttr;if(t!==void 0&&typeof t!=`string`)throw new $(`assetAttr`);let c=t===void 0?``:t;if(c!==``){let e=a.get(c);if(e===void 0)throw new $(`assetAttr "${c}" not on the point domain`);if(e.type!==`string`)throw new $(`assetAttr "${c}" is ${e.type}, not string`)}let l=s.instanceAttrs;if(l!==void 0){if(!Array.isArray(l))throw new $(`instanceAttrs`);if(l.length>0)throw new $(`instanceAttrs names ${l.length} per-instance channel(s); the device spawner composes transforms and colour only`)}let u=s.colorAttr;if(u!==void 0&&typeof u!=`string`)throw new $(`colorAttr`);let d=u===void 0?``:u,p=0;if(d!==``){let e=a.get(d);if(e===void 0)throw new $(`colorAttr "${d}" not on the point domain`);if(e.type!==`f32`||e.tupleSize<3)throw new $(`colorAttr "${d}" is ${e.type}x${e.tupleSize}`);p=e.tupleSize}let h=a.get(`rot`),g=h!==void 0&&h.type===`f32`&&h.tupleSize===4,v=a.get(`scale`),y=v!==void 0&&v.type===`f32`&&v.tupleSize===3,x={P:{kind:`slot`,index:m(`P`)},transforms:{kind:`out`}};g&&(x.rot={kind:`slot`,index:m(`rot`)}),y&&(x.scaleAttr={kind:`slot`,index:m(`scale`)});let S=c!==``;S&&(x.perm={kind:`perm`}),p>0&&(x.color={kind:`slot`,index:m(d)},x.colors={kind:`colorOut`}),r.push(b(Se(g,y,S,p),0,x,o,S)),f={assetId:e,assetAttr:c,colorAttr:d,colorTupleSize:p,count:i,bytes:i*64,colorBytes:p>0?i*Et:0,permBytes:S?i*4:0};break}default:throw new $(`unknown kind ${t.kind}`)}d.push({id:t.id,type:t.type,steps:r})}}catch(e){if(e instanceof $)return kt;throw e}let{writtenList:x,materialize:S,totalBytes:C}=Nt(l,o,c,f,t.needsGeometry);return C>n?{reason:`run-too-large`}:{plan:{format:Dt,count:i,members:d,slots:o,cols:c,written:x,layoutOps:u,materialize:S,instances:f,totalBytes:C}}}var Ft={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function It(){return new Promise(e=>setTimeout(e,0))}async function Lt(e,n,r,a){let{device:s,pool:c}=e,{geo:l,signal:u,budgetMs:d}=r,f=n.count;if(l.attrs.point.count!==f)throw Error(`resident run: plan was built for ${f} points but the input geometry has ${l.attrs.point.count}; plans are single-cook artifacts — re-plan for new inputs`);let p=()=>{if(u?.aborted)throw new o},m=[],h=(e,t)=>{let n=c.acquire(e,t);return m.push(n),n},g=new Set,_=[];try{let r=l.attrs.point,o=n.slots.map(e=>{let t=h(e.bytes,Q.STORAGE|Q.COPY_DST|Q.COPY_SRC);if(e.init===`attr`){let n=r.require(e.name),i=e.bytes/4;if(n.data instanceof Uint8Array){let e=new Uint32Array(i);for(let t=0;t<i;t++)e[t]=n.data[t];s.queue.writeBuffer(t,0,e)}else s.queue.writeBuffer(t,0,n.data.subarray(0,i))}else if(e.init===`quat-default`){let n=new Float32Array(e.bytes/4);for(let e=3;e<n.length;e+=4)n[e]=1;s.queue.writeBuffer(t,0,n)}return t}),u=n.cols.map(e=>h(e,Q.STORAGE|Q.COPY_DST|Q.COPY_SRC)),m=n.instances===null?void 0:i(l,{defaultAssetId:n.instances.assetId,...n.instances.assetAttr===``?{}:{assetAttr:n.instances.assetAttr}}),v=n.instances!==null&&n.instances.permBytes>0?h(n.instances.permBytes,Q.STORAGE|Q.COPY_DST):void 0;v!==void 0&&m!==void 0&&s.queue.writeBuffer(v,0,m.perm);let y=Q.STORAGE|Q.COPY_DST|Q.COPY_SRC|Q.VERTEX,b=m===void 0?[]:Array.from(m.counts,e=>h(e*64,y)),x=m===void 0||n.instances===null||n.instances.colorBytes===0?[]:Array.from(m.counts,e=>h(e*Et,y)),S=(e,t)=>{if(e.kind===`slot`)return o[e.index];if(e.kind===`col`)return u[e.index];if(e.kind===`colorOut`){let e=x[t];if(e===void 0)throw Error(`resident run: a kernel binds a retained instance-colour buffer but the plan declares no colour output (plan and kernels disagree)`);return e}if(e.kind===`perm`){if(v===void 0)throw Error(`resident run: a kernel binds the grouping permutation but the plan declares no per-point asset attribute (plan and kernels disagree)`);return v}let n=b[t];if(n===void 0)throw Error(`resident run: a kernel binds a retained instance-transform buffer but the plan declares no instances output (plan and kernels disagree)`);return n},C=s.createCommandEncoder(),w=C.beginComputePass(),T=performance.now();for(let t of n.members){p();for(let n of t.steps){let t=e.getPipeline(n.key,n.wgsl,n.entryPoint,a);w.setPipeline(t);let r=Tt(n.workgroupSize,e.maxElementsPerDispatch),i=n.perBatch&&m!==void 0?Array.from(m.counts,(e,t)=>({batch:t,elements:e,base:m.offsets[t]})):[{batch:0,elements:f,base:0}];for(let e of i){a!==void 0&&a.dispatches++;let i=new ArrayBuffer(n.uniformBytes),o=new Uint8Array(i),c=new Uint32Array(i,0,n.uniformBytes>=16?4:3);c[0]=e.elements,c[1]=n.seed>>>0,n.perBatch&&(c[3]=e.base),n.consts.length>0&&new Float32Array(i,16,n.consts.length).set(n.consts);let l=Math.ceil(e.elements/r);for(let i=0;i<l;i++){let a=h(n.uniformBytes,Q.UNIFORM|Q.COPY_DST);c[2]=i*r,s.queue.writeBuffer(a,0,o);let l=s.createBindGroup({layout:t.getBindGroupLayout(0),entries:[{binding:n.uniformsBinding,resource:{buffer:a}},...n.bindings.map(t=>({binding:t.binding,resource:{buffer:S(t.ref,e.batch)}}))]}),u=Math.min(r,e.elements-i*r);w.setBindGroup(0,l),w.dispatchWorkgroups(Math.ceil(u/n.workgroupSize))}}}d!==void 0&&performance.now()-T>d&&(await It(),p(),T=performance.now())}w.end();let E=[],D,O=n.materialize?n.written.reduce((e,t)=>e+n.slots[t.slot].bytes,0):0;if(O>0){D=h(O,Q.COPY_DST|Q.MAP_READ);let e=0;for(let t of n.written){let r=n.slots[t.slot].bytes;C.copyBufferToBuffer(o[t.slot],0,D,e,r),E.push(e),e+=r}}s.queue.submit([C.finish()]);let k;if(n.materialize){let e;if(D!==void 0){await D.mapAsync(_t.READ,0,O);try{e=D.getMappedRange(0,O).slice(0)}finally{D.unmap()}}p(),k=t(l);let r=k.attrs.point;for(let e of n.layoutOps)if(e.op===`replace`)r.replace(e.name,e.type,e.tupleSize);else{let e=r.get(`rot`);(!e||e.type!==`f32`||e.tupleSize!==4)&&(e&&r.remove(`rot`),r.add(`rot`,`f32`,4,[0,0,0,1]))}n.written.forEach((t,n)=>{let i=r.require(t.name),a=f*i.tupleSize;if(e===void 0)throw Error(`resident run: readback missing for a written attribute`);if(i.data instanceof Uint8Array){let t=new Uint32Array(e,E[n],a);for(let e=0;e<a;e++)i.data[e]=t[e]}else{let r=Ft[i.type];if(r===void 0)throw Error(`resident run: cannot materialize attribute "${t.name}" of type ${i.type}`);i.data.set(new r(e,E[n],a))}})}else p();let ee;if(n.instances!==null){let e=n.instances.colorBytes>0;if(m===void 0||b.length!==m.order.length||x.length!==(e?m.order.length:0))throw Error(`resident run: the plan declares an instances output but the acquired transform buffers do not match the grouping (library bug: plan.instances, the grouping, and the acquired buffers must agree)`);let t=(e,t,n)=>{let r=c.detach(e);g.add(e);try{return Ct(r,t,n)}catch(e){throw r.destroy(),e}},r=[];for(let n=0;n<m.order.length;n++){let i=m.order[n],a=m.counts[n],o=t(b[n],a*64,`${a} instances of "${i}"`);if(_.push(o),!e){r.push(te(i,a,o));continue}let s=t(x[n],a*Et,`${a} instance colours of "${i}"`);_.push(s),r.push(te(i,a,o,{color:{handle:s,type:`f32`,itemSize:3}}))}ee=r}a!==void 0&&(a.residentRuns++,a.fusedNodes+=n.members.length,a.readbacksSaved+=n.members.length-+!!n.materialize);let A={};return k!==void 0&&(A.geo=k),ee!==void 0&&(A.deviceBatches=ee),A}catch(e){for(let e of _)e.dispose();throw e instanceof o?e:Error(`GpuFieldEvaluator: resident run failed (${n.members.length} fused nodes [${n.members.map(e=>`"${e.id}"`).join(`, `)}], ${f} points): ${e instanceof Error?e.message:String(e)}`,{cause:e})}finally{for(let e of m)g.has(e)||c.release(e)}}var Rt=`gpu2`,zt=268435456,Bt=[`spawnInstances`],Vt={f32:Float32Array,i32:Int32Array,u32:Uint32Array},Ht={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function Ut(e){let t=e=>e!==void 0&&e!==``?e:`?`;return[Rt,t(e?.vendor),t(e?.architecture),t(e?.device),t(e?.description)].join(`|`)}function Wt(e,t){return e!==void 0&&(e.fallbacks[t]=(e.fallbacks[t]??0)+1),null}var Gt=class{cacheSalt;residentTerminals;acceptDerivedSpecs;device;kernels=new Map;pipelines=new Map;pool;maxElementsPerDispatch;maxResidentBytes;constructor(e,t={}){if(t.maxElementsPerDispatch!==void 0&&!Number.isFinite(t.maxElementsPerDispatch))throw Error(`GpuFieldEvaluator: maxElementsPerDispatch must be a finite number, got ${t.maxElementsPerDispatch}; leave it unset to use the device maximum`);this.device=e,this.cacheSalt=Ut(t.adapterInfo??e.adapterInfo),this.pool=new bt(e,t.maxPooledBytes??zt),this.maxElementsPerDispatch=t.maxElementsPerDispatch,this.maxResidentBytes=t.maxResidentBytes??536870912,this.residentTerminals=t.deviceInstances===!0?Bt:[],this.acceptDerivedSpecs=C(t)}get pipelineCacheSize(){return this.pipelines.size}get kernelCacheSize(){return this.kernels.size}get poolStats(){return this.pool.stats}dispose(){this.pool.dispose()}chunkElements(e){let t=wt*e.workgroupSize,n=Math.min(this.maxElementsPerDispatch??t,t);return Math.max(e.workgroupSize,Math.floor(n/e.workgroupSize)*e.workgroupSize)}resolveField(e,t,n){let r=g(e,this.acceptDerivedSpecs);if(r===void 0)return Wt(n,d(e));let i=t.geo.attrs[t.domain],a={},o=[];for(let e of i.names().sort()){let t=i.get(e);t!==void 0&&(a[e]={type:t.type,tupleSize:t.tupleSize},o.push(`${JSON.stringify(e)}:${t.type}x${t.tupleSize}`))}let s;try{s=ot(r,e.key)}catch{return Wt(n,`compile-error`)}let c=`${s.length}#${s}|${o.join(`,`)}`,l=this.kernels.get(c);if(l===void 0){try{l=gt(r,{attributes:a})}catch(e){l=e instanceof Error?e:Error(String(e))}this.kernels.set(c,l)}if(l instanceof Error)return Wt(n,`compile-error`);if(l.inputs.length+1>8)return Wt(n,`too-many-buffers`);let u=dt(r,l,i);if(`problem`in u)return Wt(n,`param-bindings`);let f=i.count;if(f===0)return Promise.resolve({data:new Ht[l.outType](0),tupleSize:l.outTupleSize});let p=this.getPipeline(l.key,l.wgsl,l.entryPoint,n);return n!==void 0&&n.dispatches++,this.dispatch(e,t,l,p,f,u.values)}getPipeline(e,t,n,r){let i=this.pipelines.get(e);if(i!==void 0)return r!==void 0&&r.pipelineCacheHits++,i;let a=this.device.createShaderModule({code:t}),o=this.device.createComputePipeline({layout:`auto`,compute:{module:a,entryPoint:n}});return this.pipelines.set(e,o),r!==void 0&&r.pipelinesCompiled++,o}planRun(e,t,n){let r=Pt(e,t,this.maxResidentBytes,this.acceptDerivedSpecs);return`plan`in r?r.plan:(n!==void 0&&(n.fallbacks[r.reason]=(n.fallbacks[r.reason]??0)+1),null)}executeRun(e,t,n){let r=Ot(e);return r===null?Promise.reject(Error(`GpuFieldEvaluator.executeRun: plan was not produced by this library's planRun; pass the object returned by planRun on the same resolver`)):Lt({device:this.device,pool:this.pool,maxElementsPerDispatch:this.maxElementsPerDispatch,getPipeline:(e,t,n,r)=>this.getPipeline(e,t,n,r)},r,t,n)}async dispatch(e,t,n,r,i,a){let o=this.device,s=[],c=(e,t)=>{let n=this.pool.acquire(e,t);return s.push(n),n};try{let e=this.chunkElements(n),s=Math.ceil(i/e),l=[],u=t.geo.attrs[t.domain];for(let e of n.inputs){let t=u.require(e.name),n=i*e.tupleSize,r;if(t.data instanceof Uint8Array){let e=new Uint32Array(n);for(let r=0;r<n;r++)e[r]=t.data[r];r=e}else r=t.data.subarray(0,n);let a=c(n*4,Q.STORAGE|Q.COPY_DST);o.queue.writeBuffer(a,0,r),l.push({binding:e.binding,resource:{buffer:a}})}let d=i*n.outTupleSize*4,f=c(d,Q.STORAGE|Q.COPY_SRC);l.push({binding:n.bindings.output,resource:{buffer:f}});let p=c(d,Q.COPY_DST|Q.MAP_READ),m=new ArrayBuffer(n.uniformBytes),h=new Uint8Array(m),g=new Uint32Array(m,0,3);g[0]=i,g[1]=t.seed>>>0,a.length>0&&new Float32Array(m,16,a.length).set(a);let _=[];for(let t=0;t<s;t++){let i=c(n.uniformBytes,Q.UNIFORM|Q.COPY_DST);g[2]=t*e,o.queue.writeBuffer(i,0,h),_.push(o.createBindGroup({layout:r.getBindGroupLayout(0),entries:[{binding:n.bindings.uniforms,resource:{buffer:i}},...l]}))}let v=o.createCommandEncoder(),y=v.beginComputePass();y.setPipeline(r);for(let t=0;t<s;t++){let r=Math.min(e,i-t*e);y.setBindGroup(0,_[t]),y.dispatchWorkgroups(Math.ceil(r/n.workgroupSize))}y.end(),v.copyBufferToBuffer(f,0,p,0,d),o.queue.submit([v.finish()]),await p.mapAsync(_t.READ,0,d);let b;try{b=p.getMappedRange(0,d).slice(0)}finally{p.unmap()}return{data:new Vt[n.outType](b),tupleSize:n.outTupleSize}}catch(n){throw Error(`GpuFieldEvaluator: dispatch failed for field ${e.key} (${i} elements on the ${t.domain} domain): ${n instanceof Error?n.message:String(n)}`,{cause:n})}finally{for(let e of s)this.pool.release(e)}}};export{Gt as t};