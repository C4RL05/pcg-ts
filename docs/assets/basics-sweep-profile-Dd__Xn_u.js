var e=`{
  ...
  "seed": 1045,
  "meta": {
    "title": "put a real surface on a curve",
  ...
  "nodes": [
    {
      "id": "curve",
      "type": "subgraph",
      "params": { "count": 64, "wander": 0.4, "frequency": 2, "size": [40, 1, 40] },
    ...
    },
    {
      ...
      "params": {
        ...
        "radius": {
          "fn": "remap",
          "args": [{ "fn": "attribute", "name": "curveU" }, 0, 1, 0.9, 0.15]
        },
        "frame": "upHint",
        "up": [0, 1, 0],
        "roll": 0,
  ...
  "connections": [{ "from": ["curve", "out"], "to": ["skin", "in"] }],
  "outputs": [
    { "id": "skin", "pin": "out", "name": "surface" },
    { "id": "curve", "pin": "out", "name": "path" }
  ]
}
`;export{e as default};