var e=`{
  ...
  "seed": 4139,
  "meta": {
    "title": "tile a repeated piece over three stretches of one lap, choosing the piece once per stretch",
  ...
  "nodes": [
    ...
    },
    {
      "id": "ranges",
      "type": "pointLine",
      "params": { "mode": "endpoints", "count": 3, "start": [0, 0, 0], "end": [4, 0, 0], "includeEnd": true }
    },
    {
      "id": "starts",
      "type": "setAttribute",
      "params": {
        ...
        "value": {
          "fn": "select",
          "args": [
            { "fn": "lt", "args": [{ "fn": "index" }, 0.5] },
            40,
            {
              "fn": "select",
              "args": [{ "fn": "lt", "args": [{ "fn": "index" }, 1.5] }, 130, 285]
            }
          ]
        }
      }
      ...
      "params": {
        ...
        "value": {
          ...
          "args": [
            ...
            {
              "fn": "select",
              "args": [{ "fn": "lt", "args": [{ "fn": "index" }, 1.5] }, 66, 55]
            }
          ]
        }
      }
    },
    {
      ...
      "params": {
        ...
        "value": {
          "fn": "floor",
          "args": [{ "fn": "mul", "args": [{ "fn": "randomField", "key": "piece" }, 3] }]
        }
      }
    },
    {
      ...
      "params": {
        "name": "asset",
        "type": "string",
        "values": ["rib", "arch", "gantry"],
        "value": { "fn": "attribute", "name": "pick" }
      }
    },
    {
      "id": "pieceLen",
      ...
      "params": {
        ...
        "value": {
          "fn": "select",
          "args": [
            { "fn": "lt", "args": [{ "fn": "attribute", "name": "pick" }, 0.5] },
            2,
            {
              "fn": "select",
              "args": [{ "fn": "lt", "args": [{ "fn": "attribute", "name": "pick" }, 1.5] }, 5, 8]
            }
          ]
        }
      }
    },
    {
      ...
      "params": {
        ...
        "value": {
          ...
          "args": [
            { "fn": "lt", "args": [{ "fn": "attribute", "name": "pick" }, 0.5] },
            { "fn": "vec", "args": [0.95, 0.5, 0.15] },
            {
              "fn": "select",
              "args": [
                { "fn": "lt", "args": [{ "fn": "attribute", "name": "pick" }, 1.5] },
                { "fn": "vec", "args": [0.2, 0.6, 0.95] },
                { "fn": "vec", "args": [0.45, 0.85, 0.3] }
              ]
            }
          ]
        }
    ...
    },
    {
      ...
      "params": {
        "startAttr": "runStart",
        "lengthAttr": "runSpan",
        "spacing": { "fn": "attribute", "name": "pieceLen" },
        "flare": 6,
        "taper": 1.6,
        "axis": "+z",
        "rangeNames": ["asset", "rangeColor"]
      }
    },
    {
      "id": "spawn",
      "type": "spawnInstances",
      "params": { "assetId": "rib", "assetAttr": "asset", "colorAttr": "rangeColor" }
    }
  ],
  "connections": [
    { "from": ["ranges", "out"], "to": ["starts", "in"] },
    { "from": ["starts", "out"], "to": ["spans", "in"] },
    { "from": ["spans", "out"], "to": ["pick", "in"] },
    { "from": ["pick", "out"], "to": ["asset", "in"] },
    { "from": ["asset", "out"], "to": ["pieceLen", "in"] },
    { "from": ["pieceLen", "out"], "to": ["hue", "in"] },
    { "from": ["loop", "out"], "to": ["cover", "path"] },
    { "from": ["hue", "out"], "to": ["cover", "ranges"] },
    { "from": ["cover", "out"], "to": ["spawn", "in"] }
  ],
  "outputs": [
    { "id": "loop", "pin": "out", "name": "road" },
    { "id": "spawn", "pin": "instances", "name": "cover" }
  ]
}
`;export{e as default};