...
`)}
  ...
  return ${F(`internal PERLIN_SCALE`)(o)} * pcg_mix(
  ...
  let t = ${F(`internal simplex R2`)(_)} - x * x - y * y - z * z;
  if (t <= 0f) {
    return 0f;
  }
  ...
  let s = (p.x + p.y + p.z) * ${F(`internal simplex F3`)(c)};
