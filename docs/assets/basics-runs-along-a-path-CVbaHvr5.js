var e=`{
  ...
  "seed": 2207,
  "meta": {
    "title": "measure distance since the last gate, and to the next one, around a closed lap",
  ...
  "nodes": [
    ...
    },
    {
      "id": "curve",
      "type": "pathResample",
      "params": { "mode": "count", "count": 240, "lengthAttr": "lapLength" }
    },
    {
      "id": "len",
    ...
    },
    {
      ...
      "params": {
        ...
        "value": {
          "fn": "div",
          "args": [{ "fn": "attribute", "name": "lapLength" }, 240]
        }
      }
    },
    {
      ...
      "params": {
        ...
        "value": {
          ...
          "args": [
            {
              "fn": "mod",
              "args": [{ "fn": "add", "args": [{ "fn": "index" }, 30] }, 60]
            },
            0.5
          ]
        }
          ...
          "args": [
            {
              "fn": "div",
              "args": [
                { "fn": "attribute", "name": "since" },
                { "fn": "div", "args": [{ "fn": "attribute", "name": "lapLength" }, 4] }
              ]
            },
            0.25,
            {
    ...
    },
    {
      ...
      "params": { "attribute": "gate", "comparison": "gt", "value": 0.5 }
    }
  ],
  "connections": [
    { "from": ["ring", "out"], "to": ["path", "in"] },
    { "from": ["path", "out"], "to": ["curve", "in"] },
    { "from": ["curve", "out"], "to": ["len", "in"] },
    { "from": ["len", "out"], "to": ["seg", "in"] },
    { "from": ["seg", "out"], "to": ["gate", "in"] },
    { "from": ["gate", "out"], "to": ["since", "in"] },
    { "from": ["since", "out"], "to": ["ahead", "in"] },
    { "from": ["ahead", "out"], "to": ["tint", "in"] },
    { "from": ["tint", "out"], "to": ["gates", "in"] }
  ],
  "outputs": [
    { "id": "tint", "pin": "out", "name": "lap" },
    { "id": "gates", "pin": "out", "name": "gates" }
  ]
}
`;export{e as default};