...
`)}
  ...
  let t = f32(i + j + k) * ${P(`internal simplex G3`)(m)};
  let x0 = p.x - (f32(i) - t);
  let y0 = p.y - (f32(j) - t);
  let z0 = p.z - (f32(k) - t);
  var i1: i32;
  ...
  let x1 = x0 - f32(i1) + ${P(`internal simplex G3`)(m)};
  let y1 = y0 - f32(j1) + ${P(`internal simplex G3`)(m)};
  let z1 = z0 - f32(k1) + ${P(`internal simplex G3`)(m)};
  let x2 = x0 - f32(i2) + ${P(`internal simplex 2*G3`)(2*m)};
  let y2 = y0 - f32(j2) + ${P(`internal simplex 2*G3`)(2*m)};
  let z2 = z0 - f32(k2) + ${P(`internal simplex 2*G3`)(2*m)};
  let x3 = x0 - 1f + ${P(`internal simplex 3*G3`)(3*m)};
  let y3 = y0 - 1f + ${P(`internal simplex 3*G3`)(3*m)};
  let z3 = z0 - 1f + ${P(`internal simplex 3*G3`)(3*m)};
