  ...
  "nodes": [\r
    ...
    {\r
      ...
      "params": {\r
        "mode": "count",\r
        "count": 360,\r
        "resampledLengthAttr": "lapLength",\r
        "sampleArcAttr": "station"\r
      }\r
    },\r
    {\r
      "id": "len",\r
    ...
    {\r
      ...
      "params": {\r
        ...
        "value": {\r
          "fn": "mod",\r
          "args": [{ "fn": "add", "args": [{ "fn": "index" }, 10] }, 72]\r
        }\r
      }\r
    },\r
    {\r
        ...
        "value": {\r
          ...
          "args": [\r
            {\r
              "fn": "floor",\r
              "args": [\r
                { "fn": "div", "args": [{ "fn": "add", "args": [{ "fn": "index" }, 10] }, 72] }\r
              ]\r
            },\r
            5\r
          ]\r
    ...
    {\r
      ...
      "params": {\r
        ...
        "value": {\r
          "fn": "select",\r
          "args": [\r
            { "fn": "lt", "args": [{ "fn": "attribute", "name": "c" }, 0.5] },\r
            { "fn": "mul", "args": [0.3, { "fn": "attribute", "name": "u" }] },\r
            {\r
              "fn": "select",\r
              "args": [\r
                { "fn": "lt", "args": [{ "fn": "attribute", "name": "c" }, 1.5] },\r
                3,\r
                {\r
                  "fn": "select",\r
                  "args": [\r
                    { "fn": "lt", "args": [{ "fn": "attribute", "name": "c" }, 2.5] },\r
                    {\r
                      "fn": "add",\r
                      "args": [\r
                        3,\r
                        {\r
                          ...
                          "args": [\r
                            ...
                            {\r
                              "fn": "sin",\r
                              "args": [\r
                                { "fn": "mul", "args": [2.4, { "fn": "attribute", "name": "u" }] }\r
                              ]\r
                            }\r
                          ]\r
                        }\r
                    ...
                    {\r
                      "fn": "select",\r
                      "args": [\r
                        { "fn": "lt", "args": [{ "fn": "attribute", "name": "c" }, 3.5] },\r
                        {\r
                          "fn": "add",\r
                          "args": [\r
                            { "fn": "mul", "args": [0.25, { "fn": "attribute", "name": "u" }] },\r
                            {\r
                              "fn": "mul",\r
                              "args": [\r
                                4,\r
                                {\r
                                  ...
                                  "args": [\r
                                    {\r
                                      "fn": "abs",\r
                                      "args": [\r
                                        { "fn": "sub", "args": [{ "fn": "attribute", "name": "u" }, 12] }\r
                                      ]\r
                                    },\r
                                    0.5\r
                                  ]\r
                        ...
                        { "fn": "mul", "args": [6, { "fn": "attribute", "name": "u" }] }\r
                      ]\r
                    }\r
                  ]\r
                }\r
          ...
          "args": [\r
            ...
            {\r
              ...
              "args": [\r
                ...
                {\r
                  "fn": "mul",\r
                  "args": [18, { "fn": "gt", "args": [{ "fn": "attribute", "name": "c" }, 3.5] }]\r
                }\r
              ]\r
            }\r
          ]\r
    ...
    {\r
      ...
      "params": {\r
        "translate": {\r
          "fn": "mul",\r
          "args": [\r
            { "fn": "normalize", "args": [{ "fn": "position" }] },\r
            { "fn": "attribute", "name": "off" }\r
          ]\r
        }\r
      }\r
    },\r
    ...
    {\r
      "id": "lapLen",\r
      "type": "promoteAttribute",\r
      "params": { "name": "lapLength", "from": "point", "to": "primitive", "mode": "average" }\r
    },\r
    {\r
      "id": "fit",\r
      "type": "runFit",\r
      "params": {\r
        ...
        "valueAttr": "off",\r
        "gap": 5,\r
        "period": { "fn": "attribute", "name": "lapLength" },\r
        "wrap": true,\r
        "slopeAttr": "runSlope",\r
        "residualAttr": "runResidual",\r
        "spanAttr": "runSpan",\r
        "idAttr": "runId",\r
        "indexAttr": "runIndex",\r
        "countAttr": "runCount",\r
        ...
        "value": {\r
          ...
          "args": [\r
            {\r
              ...
              "args": [\r
                1,\r
                { "fn": "lt", "args": [{ "fn": "attribute", "name": "runResidual" }, 1] }\r
              ]\r
            },\r
            {\r
              "fn": "mul",\r
              "args": [\r
                { "fn": "lt", "args": [{ "fn": "attribute", "name": "runResidual" }, 1] },\r
                { "fn": "gt", "args": [{ "fn": "attribute", "name": "runCount" }, 2.5] }\r
              ]\r
            },\r
            {\r
              "fn": "mul",\r
    ...
    {\r
      "id": "rows",\r
      "type": "pointsToPath",\r
      "params": { "closed": false, "groupAttr": "runId", "orderAttr": "runIndex" }\r
    }\r
  ],\r
  "connections": [\r
    { "from": ["loop", "out"], "to": ["lap", "in"] },\r
    { "from": ["lap", "out"], "to": ["len", "in"] },\r
    { "from": ["len", "out"], "to": ["u", "in"] },\r
    { "from": ["u", "out"], "to": ["c", "in"] },\r
    { "from": ["c", "out"], "to": ["off", "in"] },\r
    { "from": ["off", "out"], "to": ["keep", "in"] },\r
    { "from": ["keep", "out"], "to": ["shift", "in"] },\r
    { "from": ["shift", "out"], "to": ["props", "in"] },\r
    { "from": ["props", "out"], "to": ["lapLen", "in"] },\r
    { "from": ["lapLen", "out"], "to": ["fit", "in"] },\r
    { "from": ["fit", "out"], "to": ["tint", "in"] },\r
    { "from": ["tint", "out"], "to": ["rows", "in"] }\r
  ],\r
  "outputs": [\r
    { "id": "lap", "pin": "out", "name": "road" },\r
    { "id": "rows", "pin": "out", "name": "rows" }\r
  ]\r
}\r
`;export{e as default};