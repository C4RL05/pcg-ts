import{$ as e,A as t,At as n,B as r,C as i,Dt as a,J as o,Mt as s,N as c,Nt as l,O as u,Ot as d,Q as f,R as p,S as m,St as h,T as g,W as ee,Y as _,Yt as v,Z as y,_ as b,_t as x,a as S,bt as C,c as w,ct as T,d as E,et as D,g as O,gt as k,h as A,ht as te,i as j,it as M,jt as ne,k as N,kt as re,l as P,lt as F,mt as I,nt as L,ot as R,p as ie,pt as z,q as B,rn as V,rt as H,s as ae,st as U,tt as oe,ut as W,vt as G,w as K,wt as q,x as J,xt as Y,yt as X,z as se}from"./wordmark-DFP1ySJV.js";var Z=!1;function ce(){if(Z)return;Z=!0;let e=document.createElement(`style`);e.textContent=`
.pcg-overlay {
...
`,document.head.appendChild(e)}function le(e){ce();let t=document.createElement(`div`);t.className=`pcg-overlay`;let n=document.createElement(`h1`);n.textContent=e.title;let r=document.createElement(`span`);r.className=`pcg-chevron`,r.textContent=`▾`,n.appendChild(r),t.appendChild(n),n.setAttribute(`role`,`button`),n.tabIndex=0;let i=()=>{n.setAttribute(`aria-expanded`,String(!t.classList.contains(`pcg-collapsed`)))},a=()=>{t.classList.toggle(`pcg-collapsed`),i()};n.addEventListener(`click`,a),n.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),a())});let o=S();if(o.matches&&t.classList.add(`pcg-collapsed`),o.addEventListener(`change`,e=>{t.classList.toggle(`pcg-collapsed`,e.matches),i()}),i(),e.info){let n=document.createElement(`p`);n.className=`pcg-info`,n.textContent=e.info,t.appendChild(n)}let s=document.createElement(`div`);t.appendChild(s);let c=document.createElement(`div`);c.className=`pcg-stats`,t.appendChild(c),document.body.appendChild(t);function l(e){let t=document.createElement(`div`);t.className=`pcg-row`;let n=document.createElement(`label`);return n.textContent=e,t.appendChild(n),s.appendChild(t),t}function u(e,t){let n=document.createElement(`span`);n.className=`pcg-numbox`,n.appendChild(e);let r=document.createElement(`span`);r.className=`pcg-steps`;for(let[n,i,a]of[[-1,`−`,`decrease`],[1,`+`,`increase`]]){let o=document.createElement(`button`);o.type=`button`,o.tabIndex=-1,o.textContent=i,o.setAttribute(`aria-label`,a);let s,c,l=()=>{n>0?e.stepUp():e.stepDown(),t()},u=()=>{clearTimeout(s),clearInterval(c)};o.addEventListener(`pointerdown`,e=>{e.preventDefault(),l(),s=setTimeout(()=>{c=setInterval(l,60)},400)});for(let e of[`pointerup`,`pointerleave`,`pointercancel`])o.addEventListener(e,u);r.appendChild(o)}return n.appendChild(r),n}return{el:t,addSeed(e,t){let n=l(`seed`),r=document.createElement(`input`);r.type=`number`,r.step=`1`,r.min=`0`,r.value=String(e);let i=()=>{let e=Math.floor(r.valueAsNumber);Number.isFinite(e)&&t(e>>>0)};r.addEventListener(`change`,i),n.appendChild(u(r,i))},addSlider(e,t,n){let r=l(e),i=document.createElement(`input`);i.type=`range`,i.min=String(t.min),i.max=String(t.max),i.step=String(t.step),i.value=String(t.value);let a=document.createElement(`span`);a.className=`pcg-val`;let o=t.format??(e=>String(e));a.textContent=o(t.value);let s=e=>{let n=t.max-t.min,r=n>0?(e-t.min)/n:0;i.style.setProperty(`--p`,`${Math.min(1,Math.max(0,r))*100}%`)};s(t.value),i.addEventListener(`input`,()=>{let e=Number(i.value);a.textContent=o(e),s(e),n(e)}),r.appendChild(i),r.appendChild(a)},addSelect(e,t,n,r){let i=l(e),a=document.createElement(`select`);for(let e of t){let t=document.createElement(`option`);t.value=e.value,t.textContent=e.label,a.appendChild(t)}a.value=n,a.addEventListener(`change`,()=>r(a.value)),i.appendChild(a)},addCheckbox(e,t,n){let r=l(e),i=document.createElement(`input`);i.type=`checkbox`,i.checked=t,i.addEventListener(`change`,()=>n(i.checked)),r.appendChild(i)},addStat(e){let t=document.createElement(`div`);t.className=`pcg-stat`;let n=document.createElement(`span`);n.textContent=e;let r=document.createElement(`span`);return r.textContent=`–`,t.appendChild(n),t.appendChild(r),c.appendChild(t),e=>{r.textContent=String(e)}},addCollapsible(e,n=!1){let r=document.createElement(`details`);r.open=n;let i=document.createElement(`summary`);i.textContent=e,r.appendChild(i);let a=document.createElement(`pre`);return r.appendChild(a),t.appendChild(r),a},addNote(e){let n=document.createElement(`p`);n.className=`pcg-note`,n.textContent=e,t.appendChild(n)},addSlot(){let e=document.createElement(`div`);return e.className=`pcg-slot`,t.appendChild(e),e}}}Q[l]=`shared/graph/GraphView.svelte`;var ue=F(H(`<path class="edge-casing svelte-v559t8"></path><path></path>`,1),Q[l],[[193,8],[194,8]]),de=F(H(`<svg role="img"><g><!><!></g></svg>`),Q[l],[[171,0,[[185,2]]]]);function Q(e,r){o(new.target),re(r,!0,Q);let i=N(r,`previews`,19,()=>new Map),l=N(r,`interactive`,3,!0),u=N(r,`label`,3,`node graph`),f=n(h(void 0),`svgEl`),m=n(h(C({x:0,y:0,z:1})),`view`),g=null,v=n(q(()=>new Map([...i()].map(([e,t])=>[e,t.length]))),`rowCounts`),y=n(q(()=>new Map(r.nodes.map(e=>[e.id,e]))),`byId`);function S(e,t){return r.floor??O(e,t)}function j(){if(!W(f))return;let e=W(f).getBoundingClientRect();if(X(e.width,0)||X(e.height,0))return;let t=E(r.nodes,W(v));Y(m,ie(t,e,{floor:S(t,e),preferActual:l()}),!0)}function M(){if(!W(f))return;let e=E(r.nodes,W(v));Y(m,X(e,null)?{x:0,y:0,z:1}:P(1,e,W(f).getBoundingClientRect()),!0)}I(()=>{r.nodes,r.floor,l(),j()}),I(()=>{let e=W(f);if(!e)return;let t=new ResizeObserver(()=>j());return t.observe(e),()=>t.disconnect()});function ne(e){if(!l()||!W(f))return;e.preventDefault();let t=W(f).getBoundingClientRect(),n=S(E(r.nodes,W(v)),t);Y(m,A(W(m),t,e.clientX,e.clientY,e.deltaY,n),!0)}function F(e){!l()||X(e.button,0,!1)||(g={px:e.clientX,py:e.clientY,ox:W(m).x,oy:W(m).y},W(f)?.setPointerCapture(e.pointerId))}function L(e){g&&Y(m,{...W(m),x:g.ox+(e.clientX-g.px),y:g.oy+(e.clientY-g.py)},!0)}function R(){g=null}function V(){l()&&j()}var H={..._(),get fit(){return j},get actualSize(){return M}},K=de();T(`pointermove`,te,L),T(`pointerup`,te,R);let J;var Z=k(K),ce=k(Z);a(()=>ee(ce,17,()=>r.edges,e=>`${e.from}.${e.fromPin}->${e.to}.${e.toPin}`,(e,t)=>{let r=n(q(()=>w(W(y),W(t))),`d`);W(r);var i=oe(),o=x(i),s=e=>{var n=ue(),i=x(n),a=G(i);z(e=>{c(i,`d`,W(r)),se(a,0,`edge-line k-${e??``}`,`svelte-v559t8`),c(a,`d`,W(r))},[()=>ae(W(y),W(t))]),D(e,n)};a(()=>B(o,e=>{W(r)&&e(s)}),`if`,Q,191,6),D(e,i)}),`each`,Q,189,4);var le=G(ce);return a(()=>ee(le,17,()=>r.nodes,e=>e.id,(e,t)=>{{let n=q(()=>i().get(W(t).id));a(()=>b(e,{get node(){return W(t)},get params(){return W(n)}}),`component`,Q,198,6,{componentTag:`NodeBox`})}}),`each`,Q,197,4),s(Z),s(K),t(K,e=>Y(f,e),()=>W(f)),z(e=>{J=se(K,0,`view svelte-v559t8`,null,J,{interactive:l()}),c(K,`aria-label`,u()),c(Z,`transform`,`translate(${W(m).x??``} ${W(m).y??``}) scale(${W(m).z??``})`),p(Z,`--hairline: ${e??``}`)},[()=>Math.max(1,1/W(m).z)]),T(`wheel`,K,ne),U(`pointerdown`,K,F),U(`dblclick`,K,V),D(e,K),d(H)}R([`pointerdown`,`dblclick`]);function fe(e){let t=e.parentNode;return document.body.appendChild(e),{destroy(){t&&e.parentNode===document.body&&t.appendChild(e),e.remove()}}}function pe(e){return typeof e==`object`&&!!e&&!Array.isArray(e)&&`fn`in e}function me(e){if(pe(e))try{return`ƒ ${V(e).replace(/\s+/g,` `)}`}catch{return`ƒ`}return typeof e==`number`?J(e):typeof e==`boolean`?String(e):typeof e==`string`?e===``?`–`:e:Array.isArray(e)?e.length===0?`–`:e.map(e=>typeof e==`number`?J(e):String(e)).join(`, `):e==null?`–`:`…`}function he(e,t){try{return i(e.type)}catch{let n=e=>[...e??[]].map(e=>({name:e,kind:`any`,multi:!1}));return{inputs:n(t.inputs.get(e.id)),outputs:n(t.outputs.get(e.id))}}}function ge(e){let t=new Map,n=new Map,r=(e,t,n)=>{let r=e.get(t);r||e.set(t,r=new Set),r.add(n)};for(let i of e.connections??[])r(n,i.from[0],i.from[1]),r(t,i.to[0],i.to[1]);for(let t of e.outputs??[])r(n,t.id,t.pin);return{inputs:t,outputs:n}}function _e(e){let t=ge(e),n=new Map,r=e.nodes.map(e=>{let r=he(e,t),i=m(e.type),a=Object.entries(e.params).map(([e,t])=>({key:e,value:me(t),field:pe(t)}));return n.set(e.id,K(a)),{id:e.id,type:e.type,...e.ref===void 0?{}:{label:e.ref.name},...i===void 0?{}:{category:i},x:0,y:0,inputs:r.inputs,outputs:r.outputs}}),i=(e.connections??[]).map(e=>({from:e.from[0],fromPin:e.from[1],to:e.to[0],toPin:e.to[1]}));return g(r,i,new Map([...n].map(([e,t])=>[e,t.length]))),{nodes:r,edges:i,previews:n}}$[l]=`shared/graph/GraphPanel.svelte`;var ve=F(L(`<button type="button" role="tab"> </button>`),$[l],[[187,14]]),ye=F(L(`<div class="tabs svelte-ul999b" role="tablist" aria-label="graphs"></div>`),$[l],[[185,10]]),be=F(L(`<span class="heading svelte-ul999b"> </span>`),$[l],[[197,10]]),xe=F(L(`<p class="empty svelte-ul999b">This graph could not be laid out.</p>`),$[l],[[215,10]]),Se=F(L(`<div class="backdrop svelte-ul999b" role="presentation"><div class="sheet svelte-ul999b" role="dialog" aria-modal="true"><header class="svelte-ul999b"><!> <span class="meta svelte-ul999b"><!></span> <button class="close svelte-ul999b" type="button" aria-label="close">✕</button></header> <div class="body svelte-ul999b"><!></div> <footer class="svelte-ul999b">scroll to zoom · drag to pan · double-click to fit · read-only</footer></div></div>`),$[l],[[176,2,[[182,4,[[183,6,[[199,8],[202,8]]],[206,6],[222,6]]]]]]),Ce=F(L(`<div class="pcg-graph-panel svelte-ul999b"><button class="thumb svelte-ul999b" type="button"><span class="cap svelte-ul999b"><span class="name svelte-ul999b"> </span> <span class="count svelte-ul999b"><!></span></span> <span class="frame svelte-ul999b"><!></span></button></div> <!>`,1),$[l],[[138,0,[[139,2,[[145,4,[[146,6],[147,6]]],[151,4]]]]]]);function $(e,t){o(new.target),re(t,!0,$);let i=N(t,`title`,3,`graph`),l=n(h(C(t.initial)),`graphs`),p=n(h(!1),`open`),m=n(h(0),`selected`);function g(e){Y(l,e,!0),W(m)>=e.length&&Y(m,0),S()}let v=n(h(C([])),`pictures`),y=n(q(()=>W(v)[Math.min(W(m),W(v).length-1)]??null),`current`),b=n(q(()=>W(l)[Math.min(W(m),W(l).length-1)]?.name??``),`currentName`);function S(){Y(v,W(l).map(e=>{try{return _e(e.json)}catch{return null}}),!0)}u(S);function w(e){X(e.key,`Escape`)&&W(p)&&(e.preventDefault(),Y(p,!1))}var E={..._(),get setGraphs(){return g}},O=Ce();T(`keydown`,te,w);var A=x(O),j=k(A),P=k(j),F=k(P),I=k(F,!0);s(F);var L=G(F,2),R=k(L),ie=e=>{var t=M();z(()=>f(t,`${W(y).nodes.length??``} nodes`)),D(e,t)},V=e=>{var t=M(`…`);D(e,t)};a(()=>B(R,e=>{W(y)?e(ie):e(V,-1)}),`if`,$,148,8),s(L),s(P);var H=G(P,2),ae=k(H),oe=e=>{a(()=>Q(e,{get nodes(){return W(y).nodes},get edges(){return W(y).edges},get previews(){return W(y).previews},interactive:!1,floor:.09,get label(){return`${W(b)??``} graph, thumbnail`}}),`component`,$,153,8,{componentTag:`GraphView`})};a(()=>B(ae,e=>{W(y)&&e(oe)}),`if`,$,152,6),s(H),s(j),s(A);var K=G(A,2),J=e=>{var t=Se(),n=k(t),i=k(n),o=k(i),u=e=>{var t=ye();a(()=>ee(t,23,()=>W(l),e=>e.name,(e,t,n)=>{var r=ve();let i;var a=k(r,!0);s(r),z(()=>{c(r,`aria-selected`,X(W(n),W(m))),i=se(r,1,`svelte-ul999b`,null,i,{on:X(W(n),W(m))}),f(a,W(t).name)}),U(`click`,r,function(){return Y(m,W(n),!0)}),D(e,r)}),`each`,$,186,12),s(t),D(e,t)},d=e=>{var t=be(),n=k(t,!0);s(t),z(()=>f(n,W(b))),D(e,t)};a(()=>B(o,e=>{W(l).length>1?e(u):e(d,-1)}),`if`,$,184,8);var h=G(o,2),g=k(h),_=e=>{var t=M();z(()=>f(t,`${W(y).nodes.length??``} nodes · ${W(y).edges.length??``} connections`)),D(e,t)};a(()=>B(g,e=>{W(y)&&e(_)}),`if`,$,200,10),s(h);var v=G(h,2);s(i);var x=G(i,2),S=k(x),C=e=>{a(()=>Q(e,{get nodes(){return W(y).nodes},get edges(){return W(y).edges},get previews(){return W(y).previews},get label(){return`${W(b)??``} graph`}}),`component`,$,208,10,{componentTag:`GraphView`})},w=e=>{var t=xe();D(e,t)};a(()=>B(S,e=>{W(y)?e(C):e(w,-1)}),`if`,$,207,8),s(x),ne(2),s(n),s(t),r(t,e=>fe?.(e)),z(()=>c(n,`aria-label`,`${W(b)??``} graph`)),U(`pointerdown`,t,function(e){return X(e.target,e.currentTarget)&&Y(p,!1)}),U(`click`,v,function(){return Y(p,!1)}),D(e,t)};return a(()=>B(K,e=>{W(p)&&e(J)}),`if`,$,166,0),z(()=>{c(j,`aria-label`,`show the ${(W(b)||i())??``} graph`),f(I,W(b)||i())}),U(`click`,j,function(){return Y(p,!0)}),D(e,O),d(E)}R([`click`,`pointerdown`]);function we(e){let t=[];for(let n of e)try{t.push({name:n.name,json:v(n.graph)})}catch(e){console.warn(`graph panel: "${n.name}" could not be serialized, so it is not shown`,e)}return t}function Te(t,n){let r=document.createElement(`div`);n.into.appendChild(r);let i=y($,{target:r,props:{initial:we(t),title:n.title??`graph`}}),a=i;return{set(e){a.setGraphs(we(e))},destroy(){e(i),r.remove()}}}export{le as n,Te as t};