import{Ct as e,G as t,Hi as n,Hr as r,Ht as i,K as a,Mi as ee,Mt as o,N as s,Qi as te,Ri as ne,Si as re,Vr as c,Y as l,Yi as u,Zi as ie,ci as ae,di as oe,ea as se,fi as ce,ni as le,pa as d,pi as f,qi as ue,r as p,ri as de,va as fe,zi as m}from"./mobile-9TAkFC0f.js";import{t as h}from"./scene-DB3FpgwF.js";import{a as g}from"./debug-BEdbxq75.js";import{t as pe}from"./worldBinding-B_vzRCi4.js";import{t as me}from"./overlay-D8kWA_95.js";var he=.35,ge=777;function _e(){let e=new ne,t=e.add(le,{count:170,boundsMin:[-800,0,-800],boundsMax:[800,0,800]}),n=e.add(f,{name:`scale`,tupleSize:3,value:(()=>{let e=u(se(`mega`),0,1,5,13);return ie(e,ue(e,1.6),e)})()}),i=e.add(r,{assetId:`megarock`});return e.connect(t,`out`,n,`in`),e.connect(n,`out`,i,`in`),e.output(i,`instances`,`instances`),{name:`landmarks`,cellSize:`unbounded`,generationRadius:1/0,graph:e,bind(e,r){e.setParam(t,`seed`,r.seed),e.setParam(n,`seed`,d(r.seed,9))}}}function ve(e){let{cellSize:t,generationRadius:i,anchored:a}=e,o=e.halo?4:0,s=new ne,c=a?s.add(de,{density:he,cellSize:7,latticeMode:`xz`,height:0}):s.add(le,{count:Math.round(he*(t+2*o)**2)}),l=s.add(f,{name:`density`,tupleSize:1,value:u(re(ee,{seed:ge,frequency:.02,octaves:3}),-1,1,0,1)}),p=s.add(ce,{mode:`probabilistic`}),fe=s.add(ae,{radius:4,countAttr:`nbrCount`}),m=s.add(oe,{mode:`inside`}),h=s.add(f,{name:`scale`,tupleSize:3,value:(()=>{let e=u(n(te(`nbrCount`),2,16),2,16,.4,1.35),t=ue(e,u(se(`rock`),0,1,.85,1.15));return ie(t,t,t)})()}),g=s.add(r,{assetId:`rock`});return s.connect(c,`out`,l,`in`),s.connect(l,`out`,p,`in`),s.connect(p,`out`,fe,`in`),s.connect(fe,`out`,m,`in`),s.connect(m,`out`,h,`in`),s.connect(h,`out`,g,`in`),s.output(g,`instances`,`instances`),{name:`rocks`,cellSize:t,generationRadius:i,graph:s,bind(e,t){e.setParam(c,`boundsMin`,[t.min[0]-o,0,t.min[1]-o]),e.setParam(c,`boundsMax`,[t.max[0]+o,0,t.max[1]+o]);let n=a?t.worldSeed:t.seed;e.setParam(c,`seed`,n),e.setParam(p,`seed`,d(n,1)),e.setParam(h,`seed`,d(n,2)),e.setParam(m,`boundsMin`,[t.min[0],-1,t.min[1]]),e.setParam(m,`boundsMax`,[t.max[0],1,t.max[1]])}}}function ye(e){return e instanceof Error?e.message:String(e)}function be(e){let t=(e?.description??``)===``?e?.device:e?.description;return[e?.vendor,e?.architecture,t].filter(e=>typeof e==`string`&&e!==``).join(` · `)||`adapter (no info exposed)`}async function xe(e){let t=navigator.gpu;if(t===void 0)return{error:`navigator.gpu is missing — this browser has no WebGPU.`};try{let n=await t.requestAdapter();if(n===null)return{error:`navigator.gpu.requestAdapter() returned null — no compatible GPU adapter.`};let r=n.info,i=await n.requestDevice(),a=i.lost;return a!==void 0&&a.then(t=>{e(`${t?.reason??`unknown`}: ${t?.message??`no detail`}`)}),{device:i,info:r,label:be(r)}}catch(e){return{error:`requestDevice() failed: ${ye(e)}`}}}function Se(e){let t=e.info===void 0?{}:{adapterInfo:e.info};return{derived:new g(e.device,{...t,acceptDerivedSpecs:!0}),strict:new g(e.device,t)}}var Ce=class{cacheSalt;residentTerminals;acceptDerivedSpecs;base;seen=new Set;constructor(e){this.base=e,this.cacheSalt=e.cacheSalt,this.residentTerminals=e.residentTerminals,this.acceptDerivedSpecs=e.acceptDerivedSpecs}resolveField(e,t,n){return n!==void 0&&this.seen.add(n),this.base.resolveField(e,t,n)}planRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.planRun(e,t,n)}executeRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.executeRun(e,t,n)}drain(){if(this.seen.size===0)return;let e=m();for(let t of this.seen){e.dispatches+=t.dispatches,e.pipelinesCompiled+=t.pipelinesCompiled,e.pipelineCacheHits+=t.pipelineCacheHits,e.residentRuns+=t.residentRuns,e.fusedNodes+=t.fusedNodes,e.readbacksSaved+=t.readbacksSaved;for(let[n,r]of Object.entries(t.fallbacks))e.fallbacks[n]=(e.fallbacks[n]??0)+r}return this.seen.clear(),e}};function we(e){let t=Object.entries(e).sort(([e],[t])=>e.localeCompare(t));return t.length===0?`none`:t.map(([e,t])=>`${e} ×${t}`).join(`, `)}var Te=1,_=18,v=140,y=`gpu`,b=!0,x=20,S=!0,C=!0,w=!0,Ee=7,De=12,Oe=8,ke=5e3;function Ae(e){return e instanceof Error?e.message:String(e)}var{scene:T,camera:E,start:je}=h({cameraPosition:[0,26,0],orbit:!1,fog:{near:140,far:640},far:1600}),D=new e(new i(4e3,4e3),new o({color:1449515,roughness:1}));D.rotation.x=-Math.PI/2,D.position.y=-.03,T.add(D);var Me=40,O;function Ne(){O&&(T.remove(O),O.geometry.dispose(),O.material.dispose());let e=new t(x*Me,Me,4158656,2903936),n=e.material;n.transparent=!0,n.opacity=.45,n.depthWrite=!1,e.position.y=.02,e.visible=w,T.add(e),O=e}function Pe(){!O||!O.visible||(O.position.x=Math.round(E.position.x/x)*x,O.position.z=Math.round(E.position.z/x)*x)}var Fe=new o({color:8028816,roughness:.95,flatShading:!0}),Ie=new o({color:6121077,roughness:1,flatShading:!0}),Le={megarock:{geometry:new s(1).translate(0,.62,0),material:Ie},rock:{geometry:new l(.55).translate(0,.33,0),material:Fe}},Re,ze,k=`requesting…`,A,j=!1,Be=``,M;function N(){return Re!==void 0&&!j}function Ve(){if(!(y===`cpu`||!N()))return b?Re:ze}function He(e,t){let n=e*1.25/t+1.5;return Math.max(256,Math.ceil(Math.PI*n*n))}function Ue(e){let t=0;for(let n of Object.keys(e))for(let r of e[n])if(r.kind===`instances`)for(let e of r.batches)t+=e.count;return t}var P,F=0,I,We=0,L=!1,Ge=0;function R(){P&&(P.disposed=!0,P.abort.abort(),P.binding.dispose(),T.remove(P.group));let e=new a;T.add(e);let t=new pe({group:e,assets:Le}),n=new Map,r=Ve(),i={world:void 0,group:e,binding:t,cellInstances:n,tap:r===void 0?void 0:new Ce(r),abort:new AbortController,disposed:!1};i.world=new c({seed:Te,levels:[_e(),ve({cellSize:x,generationRadius:v,anchored:S,halo:C})],maxCellsPerLevel:He(v,x),...i.tap===void 0?{}:{gpu:i.tap},onCellReady:(e,r,a)=>{i.disposed||(t.cellReady(e,r,a),n.set(`${e}|${r[0]},${r[1]}`,Ue(a)))},onCellEvicted:(e,r)=>{i.disposed||(t.cellEvicted(e,r),n.delete(`${e}|${r[0]},${r[1]}`))}}),P=i,F=0,M=void 0,I=void 0,dt(),Ke(i,De)}function Ke(e,t){let n=++Ge;$=!0,We=performance.now(),e.world.update([E.position.x,0,E.position.z],{budgetMs:t,maxCooksPerUpdate:Oe,signal:e.abort.signal,...e.tap===void 0?{}:{gpu:e.tap}}).then(t=>{if(e.disposed)return;F=t.pending,I=t.elapsedMs;let n=e.tap?.drain();n!==void 0&&(M=n),dt(),L&&(L=!1,Z(ut()))}).catch(t=>{t instanceof fe||(console.error(t),e.disposed||Z(`update failed: ${Ae(t)}`))}).finally(()=>{n===Ge&&($=!1)})}var z=0,qe=0,B=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(t===`g`){J(y===`gpu`?`cpu`:`gpu`);return}B.add(t)}),window.addEventListener(`keyup`,e=>B.delete(e.key.toLowerCase())),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&(We=performance.now())});var V=me({title:`02 · infinite world`,info:`Unbounded landmark level + world-anchored rock cells streamed around a flying camera. Steer with A/D or arrow keys.`}),Je=document.createElement(`style`);Je.textContent=`
