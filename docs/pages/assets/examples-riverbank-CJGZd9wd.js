  ...
  "nodes": [\r
    ...
    {\r
      ...
      "params": {\r
        ...
        "domain": "point",\r
        "type": "string",\r
        "values": ["tree_pine", "tree_birch", "tree_willow"],\r
        "weights": [5, 3, 2],\r
    ...
    {\r
      ...
      "params": { "assetId": "tree_pine", "assetAttr": "asset" }\r
    },\r
    {\r
      "id": "driftSeeds",\r
      "type": "splineSample",\r
                ...
                {\r
                  ...
                  "args": [\r
                    {\r
                      "fn": "mul",\r
                      "args": [\r
                        { "fn": "component", "args": [{ "fn": "attribute", "name": "tangent", "tupleSize": 3 }], "index": 2 },\r
                        -1\r
                      ]\r
                    },\r
                    0,\r
                    { "fn": "component", "args": [{ "fn": "attribute", "name": "tangent", "tupleSize": 3 }], "index": 0 }\r
                  ]\r
                },\r
                {\r
                  "fn": "mul",\r
    ...
    {\r
      "id": "driftwood",\r
      "type": "spawnInstances",\r
      "params": { "assetId": "driftwood_log" }\r
    }\r
  ],\r
  "connections": [\r
