var e=`{
  ...
  "seed": 1027,
  "meta": {
    "title": "cut one cloud into several separate paths",
  ...
  "nodes": [
    ...
    },
    {
      ...
      "params": {
        ...
        "value": {
          "fn": "div",
          "args": [{ "fn": "component", "args": [{ "fn": "position" }], "index": 2 }, 8]
        }
      }
    },
    {
      "id": "paths",
      "type": "pointsToPath",
      "params": { "groupAttr": "row" }
    }
  ],
  "connections": [
    { "from": ["grid", "out"], "to": ["row", "in"] },
    { "from": ["row", "out"], "to": ["paths", "in"] }
  ],
  "outputs": [{ "id": "paths", "pin": "out", "name": "paths" }]
}
`;export{e as default};