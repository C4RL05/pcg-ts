import{Ca as e,Ct as t,Fi as n,G as r,Gi as i,Hi as a,Hr as ee,Ht as o,K as s,Mt as c,N as te,Qi as l,Ti as ne,Vi as re,Vr as u,Xi as ie,Y as d,ea as ae,fi as oe,ii as se,li as ce,mi as f,pi as le,r as p,ra as ue,ri as de,ta as fe,va as m}from"./mobile-DbcKCZBB.js";import{t as h}from"./scene-CEdz67Dp.js";import{a as g}from"./debug--zxcmcn7.js";import{t as pe}from"./worldBinding-CYNY3OWP.js";import{t as me}from"./overlay-CEhUWslS.js";var he=.35,ge=777;function _e(){let e=new re,t=e.add(de,{count:170,boundsMin:[-800,0,-800],boundsMax:[800,0,800]}),n=e.add(f,{name:`scale`,tupleSize:3,value:(()=>{let e=l(ue(`mega`),0,1,5,13);return ae(e,ie(e,1.6),e)})()}),r=e.add(ee,{assetId:`megarock`});return e.connect(t,`out`,n,`in`),e.connect(n,`out`,r,`in`),e.output(r,`instances`,`instances`),{name:`landmarks`,cellSize:`unbounded`,generationRadius:1/0,graph:e,bind(e,r){e.setParam(t,`seed`,r.seed),e.setParam(n,`seed`,m(r.seed,9))}}}function ve(e){let{cellSize:t,generationRadius:r,anchored:a}=e,o=e.halo?4:0,s=new re,c=a?s.add(se,{density:he,cellSize:7,latticeMode:`xz`,height:0}):s.add(de,{count:Math.round(he*(t+2*o)**2)}),te=s.add(f,{name:`density`,tupleSize:1,value:l(ne(n,{seed:ge,frequency:.02,octaves:3}),-1,1,0,1)}),u=s.add(le,{mode:`probabilistic`}),d=s.add(ce,{radius:4,countAttr:`nbrCount`}),p=s.add(oe,{mode:`inside`}),h=s.add(f,{name:`scale`,tupleSize:3,value:(()=>{let e=l(i(fe(`nbrCount`),2,16),2,16,.4,1.35),t=ie(e,l(ue(`rock`),0,1,.85,1.15));return ae(t,t,t)})()}),g=s.add(ee,{assetId:`rock`});return s.connect(c,`out`,te,`in`),s.connect(te,`out`,u,`in`),s.connect(u,`out`,d,`in`),s.connect(d,`out`,p,`in`),s.connect(p,`out`,h,`in`),s.connect(h,`out`,g,`in`),s.output(g,`instances`,`instances`),{name:`rocks`,cellSize:t,generationRadius:r,graph:s,bind(e,t){e.setParam(c,`boundsMin`,[t.min[0]-o,0,t.min[1]-o]),e.setParam(c,`boundsMax`,[t.max[0]+o,0,t.max[1]+o]);let n=a?t.worldSeed:t.seed;e.setParam(c,`seed`,n),e.setParam(u,`seed`,m(n,1)),e.setParam(h,`seed`,m(n,2)),e.setParam(p,`boundsMin`,[t.min[0],-1,t.min[1]]),e.setParam(p,`boundsMax`,[t.max[0],1,t.max[1]])}}}function ye(e){return e instanceof Error?e.message:String(e)}function be(e){let t=(e?.description??``)===``?e?.device:e?.description;return[e?.vendor,e?.architecture,t].filter(e=>typeof e==`string`&&e!==``).join(` · `)||`adapter (no info exposed)`}async function xe(e){let t=navigator.gpu;if(t===void 0)return{error:`navigator.gpu is missing — this browser has no WebGPU.`};try{let n=await t.requestAdapter();if(n===null)return{error:`navigator.gpu.requestAdapter() returned null — no compatible GPU adapter.`};let r=n.info,i=await n.requestDevice(),a=i.lost;return a!==void 0&&a.then(t=>{e(`${t?.reason??`unknown`}: ${t?.message??`no detail`}`)}),{device:i,info:r,label:be(r)}}catch(e){return{error:`requestDevice() failed: ${ye(e)}`}}}function Se(e){let t=e.info===void 0?{}:{adapterInfo:e.info};return{derived:new g(e.device,{...t,acceptDerivedSpecs:!0}),strict:new g(e.device,t)}}var Ce=class{cacheSalt;residentTerminals;acceptDerivedSpecs;base;seen=new Set;constructor(e){this.base=e,this.cacheSalt=e.cacheSalt,this.residentTerminals=e.residentTerminals,this.acceptDerivedSpecs=e.acceptDerivedSpecs}resolveField(e,t,n){return n!==void 0&&this.seen.add(n),this.base.resolveField(e,t,n)}planRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.planRun(e,t,n)}executeRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.executeRun(e,t,n)}drain(){if(this.seen.size===0)return;let e=a();for(let t of this.seen){e.dispatches+=t.dispatches,e.pipelinesCompiled+=t.pipelinesCompiled,e.pipelineCacheHits+=t.pipelineCacheHits,e.residentRuns+=t.residentRuns,e.fusedNodes+=t.fusedNodes,e.readbacksSaved+=t.readbacksSaved;for(let[n,r]of Object.entries(t.fallbacks))e.fallbacks[n]=(e.fallbacks[n]??0)+r}return this.seen.clear(),e}};function we(e){let t=Object.entries(e).sort(([e],[t])=>e.localeCompare(t));return t.length===0?`none`:t.map(([e,t])=>`${e} ×${t}`).join(`, `)}var Te=1,_=18,v=140,y=`gpu`,b=!0,x=20,S=!0,C=!0,w=!0,Ee=7,De=12,Oe=8,ke=5e3;function Ae(e){return e instanceof Error?e.message:String(e)}var{scene:T,camera:E,start:je}=h({cameraPosition:[0,26,0],orbit:!1,fog:{near:140,far:640},far:1600}),D=new t(new o(4e3,4e3),new c({color:1449515,roughness:1}));D.rotation.x=-Math.PI/2,D.position.y=-.03,T.add(D);var Me=40,O;function Ne(){O&&(T.remove(O),O.geometry.dispose(),O.material.dispose());let e=new r(x*Me,Me,4158656,2903936),t=e.material;t.transparent=!0,t.opacity=.45,t.depthWrite=!1,e.position.y=.02,e.visible=w,T.add(e),O=e}function Pe(){!O||!O.visible||(O.position.x=Math.round(E.position.x/x)*x,O.position.z=Math.round(E.position.z/x)*x)}var Fe=new c({color:8028816,roughness:.95,flatShading:!0}),Ie=new c({color:6121077,roughness:1,flatShading:!0}),Le={megarock:{geometry:new te(1).translate(0,.62,0),material:Ie},rock:{geometry:new d(.55).translate(0,.33,0),material:Fe}},Re,ze,k=`requesting…`,A,j=!1,Be=``,M;function N(){return Re!==void 0&&!j}function Ve(){if(!(y===`cpu`||!N()))return b?Re:ze}function He(e,t){let n=e*1.25/t+1.5;return Math.max(256,Math.ceil(Math.PI*n*n))}function Ue(e){let t=0;for(let n of Object.keys(e))for(let r of e[n])if(r.kind===`instances`)for(let e of r.batches)t+=e.count;return t}var P,F=0,I,We=0,L=!1,Ge=0;function R(){P&&(P.disposed=!0,P.abort.abort(),P.binding.dispose(),T.remove(P.group));let e=new s;T.add(e);let t=new pe({group:e,assets:Le}),n=new Map,r=Ve(),i={world:void 0,group:e,binding:t,cellInstances:n,tap:r===void 0?void 0:new Ce(r),abort:new AbortController,disposed:!1};i.world=new u({seed:Te,levels:[_e(),ve({cellSize:x,generationRadius:v,anchored:S,halo:C})],maxCellsPerLevel:He(v,x),...i.tap===void 0?{}:{gpu:i.tap},onCellReady:(e,r,a)=>{i.disposed||(t.cellReady(e,r,a),n.set(`${e}|${r[0]},${r[1]}`,Ue(a)))},onCellEvicted:(e,r)=>{i.disposed||(t.cellEvicted(e,r),n.delete(`${e}|${r[0]},${r[1]}`))}}),P=i,F=0,M=void 0,I=void 0,dt(),Ke(i,De)}function Ke(t,n){let r=++Ge;$=!0,We=performance.now(),t.world.update([E.position.x,0,E.position.z],{budgetMs:n,maxCooksPerUpdate:Oe,signal:t.abort.signal,...t.tap===void 0?{}:{gpu:t.tap}}).then(e=>{if(t.disposed)return;F=e.pending,I=e.elapsedMs;let n=t.tap?.drain();n!==void 0&&(M=n),dt(),L&&(L=!1,Z(ut()))}).catch(n=>{n instanceof e||(console.error(n),t.disposed||Z(`update failed: ${Ae(n)}`))}).finally(()=>{r===Ge&&($=!1)})}var z=0,qe=0,B=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(t===`g`){J(y===`gpu`?`cpu`:`gpu`);return}B.add(t)}),window.addEventListener(`keyup`,e=>B.delete(e.key.toLowerCase())),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&(We=performance.now())});var V=me({title:`infinite world`,info:`Unbounded landmark level + world-anchored rock cells streamed around a flying camera. Steer with A/D or arrow keys.`}),Je=document.createElement(`style`);Je.textContent=`
