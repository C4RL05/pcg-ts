import{Ai as e,Ca as t,Di as n,Ei as r,Gr as i,Gt as a,Ii as o,Kr as s,Li as c,Ni as l,Oi as u,Pi as d,Q as f,Ri as p,Wr as m,Wt as h,_a as g,aa as _,ba as v,ca as y,da as b,et as x,fa as S,ga as C,ha as ee,ia as w,ji as T,ki as E,l as D,la as O,ma as te,pa as ne,sa as re,u as ie,ua as ae,va as oe,xa as se,xi as ce,ya as le,zi as ue}from"./mobile-DbcKCZBB.js";var k=class extends Error{constructor(e){super(e),this.name=`GpuCompileError`}};function A(e,t){let n=Math.fround(e);if(!Number.isFinite(n))throw new k(`${t}: value ${e} is not representable as a finite f32 (WGSL kernels compute in f32; keep magnitudes within ~3.4e38)`);return Object.is(n,-0)?`-0f`:`${String(n)}f`}function de(e){return`${e>>>0}u`}function j(e){return`0x${(e>>>0).toString(16).padStart(8,`0`)}u`}var M=j,fe=A(34028234663852886e22,`internal f32 max`);function pe(e,t){let n=M(e);for(let e of t)n=`pcg_hash_mix(${n}, ${e})`;return`pcg_hash_finalize(${n})`}function me(){let e=[];for(let t=0;t<12;t++){let n=e=>A(o[t*3+e],`internal GRAD3`);e.push(`  vec3<f32>(${n(0)}, ${n(1)}, ${n(2)}),`)}return`var<private> PCG_GRAD3: array<vec3<f32>, 12> = array<vec3<f32>, 12>(
${e.join(`
`)}
  ...
  return f32(h >> 8u) * ${A(te,`internal hashFloat scale`)};
  ...
  let t = f32(i + j + k) * ${N(`internal simplex G3`)(E)};
  let x0 = p.x - (f32(i) - t);
  let y0 = p.y - (f32(j) - t);
  let z0 = p.z - (f32(k) - t);
  var i1: i32;
  ...
  let x1 = x0 - f32(i1) + ${N(`internal simplex G3`)(E)};
  let y1 = y0 - f32(j1) + ${N(`internal simplex G3`)(E)};
  let z1 = z0 - f32(k1) + ${N(`internal simplex G3`)(E)};
  let x2 = x0 - f32(i2) + ${N(`internal simplex 2*G3`)(2*E)};
  let y2 = y0 - f32(j2) + ${N(`internal simplex 2*G3`)(2*E)};
  let z2 = z0 - f32(k2) + ${N(`internal simplex 2*G3`)(2*E)};
  let x3 = x0 - 1f + ${N(`internal simplex 3*G3`)(3*E)};
  let y3 = y0 - 1f + ${N(`internal simplex 3*G3`)(3*E)};
  let z3 = z0 - 1f + ${N(`internal simplex 3*G3`)(3*E)};
