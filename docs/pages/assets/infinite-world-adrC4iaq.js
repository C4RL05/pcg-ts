import{Aa as e,Ai as t,Ba as n,Di as r,Ei as i,Fa as a,Gr as ee,K as o,Ka as te,Ki as s,N as c,Pt as l,Si as ne,Tt as u,Ur as d,Va as re,Wt as f,X as p,co as m,di as ie,la as ae,na as oe,pa as se,q as h,r as g,ua as _,ui as ce,zi as le}from"./mobile-CJx-ChGw.js";import{n as v}from"./scene-COrvxCGr.js";import{a as y}from"./debug-B0fV84SN.js";import{t as ue}from"./worldBinding-CWRUVBAr.js";import{t as de}from"./overlay-JAkDFRNX.js";var fe=.35,pe=777;function me(){let r=new le,i=r.add(ce,{count:170,boundsMin:[-800,0,-800],boundsMax:[800,0,800]}),o=r.add(t,{name:`scale`,tupleSize:3,value:(()=>{let t=a(te(`mega`),0,1,5,13);return n(t,e(t,1.6),t)})()}),s=r.add(ee,{assetId:`megarock`});return r.connect(i,`out`,o,`in`),r.connect(o,`out`,s,`in`),r.output(s,`instances`,`instances`),{name:`landmarks`,cellSize:`unbounded`,generationRadius:1/0,graph:r,bind(e,t){e.setParam(i,`seed`,t.seed),e.setParam(o,`seed`,m(t.seed,9))}}}function he(o){let{cellSize:c,generationRadius:l,anchored:u}=o,d=o.halo?4:0,f=new le,p=u?f.add(ie,{density:fe,cellSize:7,latticeMode:`xz`,height:0}):f.add(ce,{count:Math.round(fe*(c+2*d)**2)}),ae=f.add(t,{name:`density`,tupleSize:1,value:a(s(oe,{seed:pe,frequency:.02,octaves:3}),-1,1,0,1)}),h=f.add(r,{mode:`probabilistic`}),g=f.add(ne,{radius:4,countAttr:`nbrCount`}),_=f.add(i,{mode:`inside`}),v=f.add(t,{name:`scale`,tupleSize:3,value:(()=>{let t=a(se(re(`nbrCount`),2,16),2,16,.4,1.35),r=e(t,a(te(`rock`),0,1,.85,1.15));return n(r,r,r)})()}),y=f.add(ee,{assetId:`rock`});return f.connect(p,`out`,ae,`in`),f.connect(ae,`out`,h,`in`),f.connect(h,`out`,g,`in`),f.connect(g,`out`,_,`in`),f.connect(_,`out`,v,`in`),f.connect(v,`out`,y,`in`),f.output(y,`instances`,`instances`),{name:`rocks`,cellSize:c,generationRadius:l,graph:f,bind(e,t){e.setParam(p,`boundsMin`,[t.min[0]-d,0,t.min[1]-d]),e.setParam(p,`boundsMax`,[t.max[0]+d,0,t.max[1]+d]);let n=u?t.worldSeed:t.seed;e.setParam(p,`seed`,n),e.setParam(h,`seed`,m(n,1)),e.setParam(v,`seed`,m(n,2)),e.setParam(_,`boundsMin`,[t.min[0],-1,t.min[1]]),e.setParam(_,`boundsMax`,[t.max[0],1,t.max[1]])}}}function ge(e){return e instanceof Error?e.message:String(e)}function _e(e){let t=(e?.description??``)===``?e?.device:e?.description;return[e?.vendor,e?.architecture,t].filter(e=>typeof e==`string`&&e!==``).join(` · `)||`adapter (no info exposed)`}async function ve(e){let t=navigator.gpu;if(t===void 0)return{error:`navigator.gpu is missing — this browser has no WebGPU.`};try{let n=await t.requestAdapter();if(n===null)return{error:`navigator.gpu.requestAdapter() returned null — no compatible GPU adapter.`};let r=n.info,i=await n.requestDevice(),a=i.lost;return a!==void 0&&a.then(t=>{e(`${t?.reason??`unknown`}: ${t?.message??`no detail`}`)}),{device:i,info:r,label:_e(r)}}catch(e){return{error:`requestDevice() failed: ${ge(e)}`}}}function ye(e){let t=e.info===void 0?{}:{adapterInfo:e.info};return{derived:new y(e.device,{...t,acceptDerivedSpecs:!0}),strict:new y(e.device,t)}}var be=class{cacheSalt;residentTerminals;acceptDerivedSpecs;base;seen=new Set;constructor(e){this.base=e,this.cacheSalt=e.cacheSalt,this.residentTerminals=e.residentTerminals,this.acceptDerivedSpecs=e.acceptDerivedSpecs}resolveField(e,t,n){return n!==void 0&&this.seen.add(n),this.base.resolveField(e,t,n)}planRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.planRun(e,t,n)}executeRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.executeRun(e,t,n)}drain(){if(this.seen.size===0)return;let e=_();for(let t of this.seen){e.dispatches+=t.dispatches,e.pipelinesCompiled+=t.pipelinesCompiled,e.pipelineCacheHits+=t.pipelineCacheHits,e.residentRuns+=t.residentRuns,e.fusedNodes+=t.fusedNodes,e.readbacksSaved+=t.readbacksSaved;for(let[n,r]of Object.entries(t.fallbacks))e.fallbacks[n]=(e.fallbacks[n]??0)+r}return this.seen.clear(),e}};function xe(e){let t=Object.entries(e).sort(([e],[t])=>e.localeCompare(t));return t.length===0?`none`:t.map(([e,t])=>`${e} ×${t}`).join(`, `)}var Se=1,b=18,x=140,S=`gpu`,C=!0,w=20,T=!0,E=!0,Ce=!0,we=7,Te=12,Ee=8,De=5e3;function Oe(e){return e instanceof Error?e.message:String(e)}var{scene:D,camera:O,start:ke}=v({cameraPosition:[0,26,0],orbit:!1,fog:{near:140,far:640},far:1600}),Ae=new u(new f(4e3,4e3),new l({color:1449515,roughness:1}));Ae.rotation.x=-Math.PI/2,Ae.position.y=-.03,D.add(Ae);var je=40,k;function Me(){k&&(D.remove(k),k.geometry.dispose(),k.material.dispose());let e=new o(w*je,je,4158656,2903936),t=e.material;t.transparent=!0,t.opacity=.45,t.depthWrite=!1,e.position.y=.02,e.visible=Ce,D.add(e),k=e}function Ne(){!k||!k.visible||(k.position.x=Math.round(O.position.x/w)*w,k.position.z=Math.round(O.position.z/w)*w)}var Pe=new l({color:8028816,roughness:.95,flatShading:!0}),Fe=new l({color:6121077,roughness:1,flatShading:!0}),Ie={megarock:{geometry:new c(1).translate(0,.62,0),material:Fe},rock:{geometry:new p(.55).translate(0,.33,0),material:Pe}},A,Le,j=`requesting…`,M,N=!1,Re=``,P;function F(){return A!==void 0&&!N}function ze(){if(!(S===`cpu`||!F()))return C?A:Le}function Be(e,t){let n=e*1.25/t+1.5;return Math.max(256,Math.ceil(Math.PI*n*n))}function Ve(e){let t=0;for(let n of Object.keys(e))for(let r of e[n])if(r.kind===`instances`)for(let e of r.batches)t+=e.count;return t}var I,He=0,L,Ue=0,R=!1,We=0;function z(){I&&(I.disposed=!0,I.abort.abort(),I.binding.dispose(),D.remove(I.group));let e=new h;D.add(e);let t=new ue({group:e,assets:Ie}),n=new Map,r=ze(),i={world:void 0,group:e,binding:t,cellInstances:n,tap:r===void 0?void 0:new be(r),abort:new AbortController,disposed:!1};i.world=new d({seed:Se,levels:[me(),he({cellSize:w,generationRadius:x,anchored:T,halo:E})],maxCellsPerLevel:Be(x,w),...i.tap===void 0?{}:{gpu:i.tap},onCellReady:(e,r,a)=>{i.disposed||(t.cellReady(e,r,a),n.set(`${e}|${r[0]},${r[1]}`,Ve(a)))},onCellEvicted:(e,r)=>{i.disposed||(t.cellEvicted(e,r),n.delete(`${e}|${r[0]},${r[1]}`))}}),I=i,He=0,P=void 0,L=void 0,dt(),Ge(i,Te)}function Ge(e,t){let n=++We;$=!0,Ue=performance.now(),e.world.update([O.position.x,0,O.position.z],{budgetMs:t,maxCooksPerUpdate:Ee,signal:e.abort.signal,...e.tap===void 0?{}:{gpu:e.tap}}).then(t=>{if(e.disposed)return;He=t.pending,L=t.elapsedMs;let n=e.tap?.drain();n!==void 0&&(P=n),dt(),R&&(R=!1,Z(ut()))}).catch(t=>{t instanceof ae||(console.error(t),e.disposed||Z(`update failed: ${Oe(t)}`))}).finally(()=>{n===We&&($=!1)})}var B=0,Ke=0,V=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(t===`g`){Xe(S===`gpu`?`cpu`:`gpu`);return}V.add(t)}),window.addEventListener(`keyup`,e=>V.delete(e.key.toLowerCase())),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&(Ue=performance.now())});var H=de({title:`infinite world`,info:`Unbounded landmark level + world-anchored rock cells streamed around a flying camera. Steer with A/D or arrow keys.`}),qe=document.createElement(`style`);qe.textContent=`
