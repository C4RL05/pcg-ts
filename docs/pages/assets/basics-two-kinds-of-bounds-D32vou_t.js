var e=`{
  ...
  "seed": 1061,
  "meta": {
    "title": "two things called bounds, and they are not the same thing",
  ...
  "nodes": [
    {
      ...
      "params": { "count": 300, "boundsMin": [-24, 0, -24], "boundsMax": [24, 0, 24] }
    },
    {
      "id": "net",
      "type": "connectPoints",
      "params": { "mode": "radius", "radius": 6, "degreeAttr": "degree", "lengthAttr": "edgeLength" }
    },
    {
      "id": "keep",
    ...
    },
    {
      "id": "extent",
      "type": "setBounds",
      "params": { "boundsMin": [-0.4, 0, -0.4], "boundsMax": [0.4, 2.2, 0.4] }
    }
  ],
  "connections": [
    { "from": ["camps", "out"], "to": ["net", "in"] },
    { "from": ["net", "out"], "to": ["keep", "in"] },
    { "from": ["keep", "out"], "to": ["extent", "in"] }
  ],
  "outputs": [{ "id": "extent", "pin": "out", "name": "network" }]
}
`;export{e as default};