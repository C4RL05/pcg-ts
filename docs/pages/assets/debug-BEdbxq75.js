...
`,entryPoint:`main`,workgroupSize:64,bindings:s,constSlots:t,uniformBytes:he(t,a),key:`${me}|${e}`}}var z=e=>e.kind===`column`?`${e.type}x${e.tupleSize}`:`constx${e.tupleSize}@${e.slot}`;function Se(e,t,n){let r=e.kind===`const`?`f32`:e.type,i=t===`f32`&&e.kind===`column`&&e.type===`f32`,a=i?`u32`:r,o=t===`bool`||i?`u32`:t,s=new L,c=e.kind===`column`?s.add(`value`,`read`,a,`value column ${z(e)}`):``,l=e.kind===`column`?{...e,type:a}:e,u=s.add(`target`,`read_write`,o,`target attribute ${t} tupleSize ${n}`),d=(e,n)=>{switch(t){case`f32`:return i?e:n;case`i32`:return r===`f32`?`i32(${e})`:r===`i32`?e:`bitcast<i32>(${e})`;case`u32`:return r===`f32`?`u32(${e})`:r===`u32`?e:`bitcast<u32>(${e})`;default:return`select(0u, 1u, ${e} != ${r===`f32`?`0f`:r===`i32`?`0i`:`0u`})`}},f=[];for(let e=0;e<n;e++){let t=_e(c,l,e);f.push(`  ${be(u,n,e)} = ${d(t,I(c,l,e))};`)}return R(`setAttribute|val=${z(e)}|out=${t}x${n}`,xe([e]),s.items,[],f.join(`
...
`)}var Ve={valueNoise:oe,perlinNoise:e,simplexNoise:u,worleyNoise:t},He={valueNoise:`pcg_value_noise`,perlinNoise:`pcg_perlin_noise`,simplexNoise:`pcg_simplex_noise`};function Ue(e){return e.opts??{}}function We(e,t,n,r){let i=Ue(t),a=i.position===void 0?n:`${n}.opts.position`,o=i.position===void 0?Ie(r,n,`P`,3,`${e} position reads `):q(i.position,a,r);if(o.size!==3)throw new j(`${a}: ${e}: position field must have tupleSize 3, got ${o.size}`);let s=M(i.frequency??1,`${n}.opts.frequency`),[c,l,u]=i.offset??[0,0,0],d=`vec3<f32>(${M(c,`${n}.opts.offset`)}, ${M(l,`${n}.opts.offset`)}, ${M(u,`${n}.opts.offset`)})`;return r.emit(`${o.ref} * ${s} + ${d}`,3)}function Ge(e,t){return i(Ve[e],(t??0)>>>0)}function Ke(e,t,n,r){let[i,a]=n,o=a-i;return e.emit(`(${t.ref} - ${M(i,r)}) / ${M(o,r)}`,1)}for(let e of[`valueNoise`,`perlinNoise`,`simplexNoise`])K.set(e,(t,n,r)=>{let i=Ue(t),a=We(e,t,n,r);r.libRoots.add(He[e]);let o=r.emit(`${He[e]}(${N(Ge(e,i.seed))}, ${a.ref})`,1);return i.normalized===!0?Ke(r,o,d[e],`${n}.opts.normalized`):o});K.set(`worleyNoise`,(e,t,n)=>{let r=Ue(e),i=r.output??`f1`,a=r.exact===!0,o=We(`worleyNoise`,e,t,n);n.libRoots.add(`pcg_worley`);let s=i!==`f1`,c=n.emit(`pcg_worley(${N(Ge(`worleyNoise`,r.seed))}, ${o.ref}, ${a}, ${s})`,2),l=i===`f1`?n.emit(`${c.ref}.x`,1):i===`f2`?n.emit(`${c.ref}.y`,1):n.emit(`${c.ref}.y - ${c.ref}.x`,1);return r.normalized===!0?Ke(n,l,d.worleyNoise[i],`${t}.opts.normalized`):l});function qe(e){return e===`worleyNoise`?d.worleyNoise.f1:d[e]}function Je(e,t,n){return e===`worleyNoise`?`pcg_worley(${t}, ${n}, false, false).x`:`${He[e]}(${t}, ${n})`}K.set(`fbm`,(e,t,n)=>{let r=e.base,i=Ue(e),a=i.octaves??4,o=i.lacunarity??2,s=i.gain??.5,c=i.seed??0,l=i.frequency??1,[u,d,f]=i.offset??[0,0,0],p=i.position===void 0?t:`${t}.opts.position`,m=i.position===void 0?Ie(n,t,`P`,3,`fbm position reads `):q(i.position,p,n);if(m.size!==3)throw new j(`${p}: fbm: position field must have tupleSize 3, got ${m.size}`);let h=qe(r),g=[],_=[],v=[],y=1,b=l,x=0,S=0;for(let e=0;e<a;e++)g.push(N(Ge(r,A(c,e)))),_.push(M(b,`${t}.opts.frequency`)),v.push(M(y,`${t}.opts.gain`)),x+=y>=0?y*h[0]:y*h[1],S+=y>=0?y*h[1]:y*h[0],y*=s,b*=o;n.libRoots.add(r===`worleyNoise`?`pcg_worley`:He[r]);let C=`vec3<f32>(${M(u,`${t}.opts.offset`)}, ${M(d,`${t}.opts.offset`)}, ${M(f,`${t}.opts.offset`)})`,w=`fn @NAME@(p: vec3<f32>) -> f32 {
  ...
  return sum;
}`,T=n.helper(`fbm`,w),E=n.emit(`${T}(${m.ref})`,1);if(i.normalized!==!0)return E;if(!(S>x))throw new j(`${t}: fbm: normalized: true needs a non-degenerate output range, got [${x}, ${S}] for this octaves/gain configuration`);return Ke(n,E,[x,S],`${t}.opts.normalized`)});var Ye=new Set([`valueNoise`,`perlinNoise`,`simplexNoise`,`worleyNoise`,`fbm`]);function Xe(e,t){if(!V(e))return;let n=e.fn;if(n===`param`){let n=C(e);n!==void 0&&Xe(n,t);return}if(n===`attribute`){typeof e.name==`string`&&t.add(e.name);return}if(n===`position`){t.add(`P`);return}if(n===`randomField`){t.add(`P`),t.add(`seed`);return}if(typeof n==`string`&&Ye.has(n)){let n=e.opts;V(n)&&n.position!==void 0?Xe(n.position,t):t.add(`P`);return}let r=e.args;if(Array.isArray(r))for(let e of r)Xe(e,t)}var Ze=16,Qe={names:[],slots:new Map,arities:[]};function $e(e){return typeof e==`number`?1:e.length}function X(e,t){if(!V(e))return;if(t(e),e.fn===`param`){let n=C(e);n!==void 0&&X(n,t);return}let n=e.args;if(Array.isArray(n))for(let e of n)X(e,t);let r=e.opts;V(r)&&X(r.position,t)}function et(e){let t=nt.get(e);if(t!==void 0)return t;let n=rt.get(e);if(n!==void 0)throw n;try{let t=tt(e);return nt.set(e,t),t}catch(t){throw t instanceof j&&rt.set(e,t),t}}function tt(e){let t=new Map,n=new Set;if(X(e,e=>{if(e.fn!==`param`||typeof e.name!=`string`||e.name===``)return;let r=e.name;if(C(e)!==void 0)return;if(ee(e))throw new j(`param ${JSON.stringify(r)} is bound to a Field that carries no spec (a makeField closure, or something composed over one), so there is nothing to compile in its place; this expression evaluates on the CPU — build the bound field with the grammar constructors or fieldFromJson if it should lower`);n.add(r);let i=g(e);if(i===void 0)return;let a=$e(i);if(a>4)throw new j(`param ${JSON.stringify(r)} is bound to a ${a}-tuple, but a uniform slot holds 4 components; bind a tuple of 1 to 4, or evaluate this field on the CPU`);let o=t.get(r);if(o!==void 0&&o!==a)throw new j(`param ${JSON.stringify(r)} is bound to a ${o}-tuple in one place and a ${a}-tuple in another within the same expression; one uniform slot serves the name, so both references must have the same arity`);t.set(r,a)}),n.size===0)return Qe;let r=[...n].sort();if(r.length>Ze)throw new j(`this field references ${r.length} distinct params, but a kernel carries at most ${Ze} uniform constant slots (raise MAX_FIELD_CONST_SLOTS in compile.ts if an expression legitimately needs more)`);return{names:r,slots:new Map(r.map((e,t)=>[e,t])),arities:r.map(e=>t.get(e)??1)}}var nt=new WeakMap,rt=new WeakMap,it=new WeakMap;function at(e){return e.names.length===0?``:`|params=[${e.names.map((t,n)=>`${JSON.stringify(t)}:${e.arities[n]}`).join(`,`)}]`}function ot(e,t){let n=et(e);if(n.names.length===0)return t;let r=it.get(e);if(r!==void 0)return r;let i=`${se(e).key}${at(n)}`;return it.set(e,i),i}function st(e,t){return e.length===t.length&&e.every((e,n)=>Object.is(e,t[n]))}function ct(e,t){if(t.constSlots===0)return{values:[]};let n=new Map,r;if(X(e,e=>{if(e.fn!==`param`||typeof e.name!=`string`||e.name===``)return;let t=e.name;if(C(e)!==void 0)return;let i=g(e);if(i===void 0){r??=`param ${JSON.stringify(t)} has no bound value`;return}let a=typeof i==`number`?[i]:[...i],o=n.get(t);o===void 0?n.set(t,a):st(o,a)||(r??=`param ${JSON.stringify(t)} is bound to two different values in one expression`)}),r!==void 0)return{problem:r};let i=[];for(let e of t.paramNames){let t=n.get(e);if(t===void 0)return{problem:`param ${JSON.stringify(e)} is not referenced by this spec`};for(let e=0;e<4;e++)i.push(e<t.length?t[e]:0)}return{values:i}}var lt=new Set([`f32`,`i32`,`u32`,`bool`,`string`]);function ut(e){if(!V(e)||!V(e.attributes))throw new j(`compileFieldSpec: layout must be { attributes: { name: { type, tupleSize } } }`);for(let[t,n]of Object.entries(e.attributes)){if(!V(n)||!lt.has(n.type))throw new j(`kernel layout attribute ${JSON.stringify(t)}: unknown type ${JSON.stringify(n?.type)}; valid types: "f32", "i32", "u32", "bool" ("string" is accepted but CPU-only)`);let e=n.tupleSize;if(typeof e!=`number`||!Number.isInteger(e)||e<1)throw new j(`kernel layout attribute ${JSON.stringify(t)}: tupleSize must be a positive integer, got ${String(e)}`)}}function dt(e){return typeof e==`number`?{fn:`constant`,value:e}:Array.isArray(e)?{fn:`constant`,value:[...e]}:e}function ft(e){return e.type===`bool`?`u32`:e.type}function pt(e,t){ut(t);let n=dt(e),r=se(n),i=new Set;Xe(n,i);let a=[...i].filter(e=>Object.hasOwn(t.attributes,e)&&t.attributes[e].type!==`string`).sort(),o=et(n),s=new Ne(t,a,o),c=`f32`,l=0,u=[],d=e=>{if(l=e.size,e.size===1)u.push(`  outBuf[i] = ${e.ref};`);else for(let t=0;t<e.size;t++)u.push(`  outBuf[${G(e.size,t)}] = ${e.ref}.${Ae[t]};`)},f=n.fn===`attribute`?n.name:n.fn===`position`?`P`:void 0;if(n.fn===`index`)c=`u32`,l=1,u.push(`  outBuf[i] = i;`);else if(f!==void 0){let e=Fe(s,`$`,f,n.fn===`position`?3:n.tupleSize,n.fn===`position`?`position reads `:``);if(e.type===`i32`||e.type===`u32`){c=e.type,l=e.tupleSize;let t=s.binding(f);for(let n=0;n<e.tupleSize;n++)u.push(`  outBuf[${G(e.tupleSize,n)}] = ${t.varName}[${G(e.tupleSize,n)}];`)}else d(Re(n,`$`,s))}else d(Re(n,`$`,s));let p=s.boundAttrs(),m=p.map(e=>({name:e.name,type:ft(e.attr),tupleSize:e.attr.tupleSize,binding:e.binding})),h=p.length+1,g=[`@group(0) @binding(0) var<uniform> params: PcgParams;`];for(let e of p)g.push(`@group(0) @binding(${e.binding}) var<storage, read> ${e.varName}: array<${ft(e.attr)}>; // attribute ${JSON.stringify(e.name)}: ${e.attr.type} tupleSize ${e.attr.tupleSize}`);g.push(`@group(0) @binding(${h}) var<storage, read_write> outBuf: array<${c}>;`);let _=[`// Generated by pcg-ts compileFieldSpec (WGSL field kernel).
// Dispatch: 1D, chunked; each chunk runs ceil(chunkElements / ${B}) workgroups of ${B}
// with element index i = chunkOffset + gid.x; one invocation per element.

struct PcgParams {
  count: u32,
  seed: u32,
  chunkOffset: u32,${o.names.length===0?``:`\n  _pad0: u32,\n  consts: array<vec4<f32>, ${o.names.length}>,`}
}

${g.join(`
`)}`,...pe(s.libRoots),...s.helperBlocks(),`@compute @workgroup_size(${B})
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
  let i = gid.x + params.chunkOffset;
  if (i >= params.count) {
    return;
...
${[...s.lines,...u].join(`
`)}
}`],v=p.map(e=>`${JSON.stringify(e.name)}:${e.attr.type}x${e.attr.tupleSize}`).join(`,`),y=`${r.key}${at(o)}`;return it.set(n,y),{wgsl:`${_.join(`

`)}\n`,entryPoint:`main`,workgroupSize:B,outTupleSize:l,outType:c,inputs:m,bindings:{uniforms:0,output:h},constSlots:o.names.length,paramNames:o.names,uniformBytes:he(o.names.length),usesSeed:s.usesSeed,key:`${ke}|spec=${y}|layout=[${v}]`}}var Z={MAP_READ:1,COPY_SRC:4,COPY_DST:8,VERTEX:32,UNIFORM:64,STORAGE:128},mt={READ:1},ht=256;function gt(e){let t=ht;for(;t<e;)t*=2;return t}var _t=class{device;maxPooledBytes;free=new Map;meta=new Map;detachedSet=new WeakSet;idleBytes=0;idleCount=0;created=0;reused=0;destroyed=0;detachedTotal=0;detachedLive=0;detachedLiveBytes=0;constructor(e,t){this.device=e,this.maxPooledBytes=t}acquire(e,t){let n=gt(e),r=`${t}|${n}`,i=this.free.get(r)?.pop();if(i!==void 0)return this.idleBytes-=n,this.idleCount--,this.reused++,i;let a=this.device.createBuffer({size:n,usage:t});return this.meta.set(a,{key:r,bytes:n}),this.created++,a}release(e){let t=this.meta.get(e);if(t===void 0)throw this.detachedSet.has(e)?Error(`BufferPool.release: buffer was detached from this pool, so the pool no longer owns it and cannot reclaim it; destroy it through the DetachedBuffer that detach() returned (or the handle wrapping it) and stop releasing it`):Error(`BufferPool.release: buffer was not acquired from this pool`);if(this.idleBytes+t.bytes>this.maxPooledBytes){this.meta.delete(e),e.destroy(),this.destroyed++;return}let n=this.free.get(t.key);n===void 0&&(n=[],this.free.set(t.key,n)),n.push(e),this.idleBytes+=t.bytes,this.idleCount++}detach(e){let t=this.meta.get(e);if(t===void 0)throw Error(this.detachedSet.has(e)?`BufferPool.detach: buffer was already detached from this pool; ownership can only leave once — reuse the DetachedBuffer the first detach() returned`:`BufferPool.detach: buffer was not acquired from this pool`);this.meta.delete(e),this.detachedSet.add(e),this.detachedTotal++,this.detachedLive++,this.detachedLiveBytes+=t.bytes;let n=!1,r=this;return{buffer:e,bytes:t.bytes,get destroyed(){return n},destroy(){n||(n=!0,r.detachedLive--,r.detachedLiveBytes-=t.bytes,r.destroyed++,e.destroy())}}}get stats(){return{buffersCreated:this.created,buffersReused:this.reused,buffersDestroyed:this.destroyed,pooledBuffers:this.idleCount,pooledBytes:this.idleBytes,buffersDetached:this.detachedTotal,detachedBuffers:this.detachedLive,detachedBytes:this.detachedLiveBytes}}dispose(){for(let e of this.free.values())for(let t of e)this.meta.delete(t),t.destroy(),this.destroyed++;this.free.clear(),this.idleBytes=0,this.idleCount=0}},vt=`webgpu`,yt=class{backend=vt;byteLength;detached;label;constructor(e,t,n){this.detached=e,this.byteLength=t,this.label=n}get disposed(){return this.detached.destroyed}get resource(){if(this.detached.destroyed)throw Error(`device transforms handle (${this.label}) was disposed; its GPU buffer is destroyed and cannot be bound. Dispose a handle only after the last frame that reads it, and re-cook to obtain a fresh one (device-resident outputs are never memoized, so every cook produces a new handle)`);return this.detached.buffer}dispose(){this.detached.destroy()}};function bt(e,t,n){return new yt(e,t,n)}var xt=65535;function St(e,t){let n=xt*e;return Math.max(e,Math.floor(Math.min(t??n,n)/e)*e)}var Ct=16,wt=`pcg-resident-run/5`;function Tt(e){return e.format===wt?e:null}var Et={reason:`run-plan-failed`},Dt=[`+x`,`-x`,`+y`,`-y`,`+z`,`-z`];function Ot(e){if(typeof e!=`object`||!e||Array.isArray(e))return!1;let t=e;if(t.fn===`randomField`)return!0;let n=t.args;if(Array.isArray(n)){for(let e of n)if(Ot(e))return!0}let r=t.opts;return!!(typeof r==`object`&&r&&Ot(r.position))}function kt(e){return Array.isArray(e)&&e.length===3&&e.every(e=>typeof e==`number`&&Number.isFinite(e))}var Q=class extends Error{};function At(e,t,n,r,i){let a=[...e].map(([e,t])=>({name:e,slot:t})),o=i||r===null,s=t.reduce((e,t)=>e+t.bytes,0),c=n.reduce((e,t)=>e+t,0),l=o?a.reduce((e,n)=>e+t[n.slot].bytes,0):0;return{writtenList:a,materialize:o,totalBytes:s+c+l+(r?.bytes??0)+(r?.colorBytes??0)+(r?.permBytes??0)}}function jt(e,t,n,r){let i=t.count,a=new Map(Object.entries(t.attributes)),o=[],s=new Map,c=[],l=new Map,u=[],d=[],f=null,p=()=>Object.fromEntries(a),m=e=>{let t=s.get(e);if(t!==void 0)return t;let n=a.get(e);if(n===void 0||n.type===`string`)throw new Q(e);let r=o.length;return o.push({bytes:i*n.tupleSize*4,init:`attr`,name:e}),s.set(e,r),r},h=(e,t,n)=>{let r=o.length;return o.push({bytes:i*t*4,init:n,name:e}),s.set(e,r),r},g=(e,t,n)=>{let r=a.get(e);if(r===void 0||r.type!==t||r.tupleSize!==n)throw new Q(e)},_=(e,t,n)=>{let r=t.length/4;if(r>=4)throw Error(`resident run: "${n}" needs more than 4 uniform constant slots for its constant params; raise MAX_APPLY_CONST_SLOTS in applyKernels.ts (each slot costs 16 bytes of the per-chunk uniform and nothing else)`);for(let n=0;n<4;n++)t.push(n<e.length?e[n]:0);return{kind:`const`,tupleSize:e.length,slot:r}},v=(e,t,n,a,o,s)=>{let u;if(x(e)){let t=O(e,r);if(t===void 0)throw new Q(`no spec`);if(l.has(`P`)&&Ot(t))throw new Q(`identity after P write`);u=t}else if(typeof e==`number`||Array.isArray(e)&&e.every(e=>typeof e==`number`)){let t=typeof e==`number`?[e]:e;if(t.length<1||t.length>4||a!==null&&!a.includes(t.length))throw new Q(`tuple`);for(let e of t)if(!Number.isFinite(Math.fround(e)))throw new Q(`f32 range`);return{param:_(t,o,s),ref:null}}else throw new Q(`bad param value`);let d;try{d=pt(u,{attributes:p()})}catch{throw new Q(`compile`)}if(d.inputs.length+1>8)throw new Q(`buffers`);if(a!==null&&!a.includes(d.outTupleSize))throw new Q(`tuple`);let f=ct(u,d);if(`problem`in f)throw new Q(`param bindings`);let h=c.length;return c.push(i*d.outTupleSize*4),n.push({key:d.key,wgsl:d.wgsl,entryPoint:d.entryPoint,workgroupSize:d.workgroupSize,seed:t,uniformsBinding:d.bindings.uniforms,uniformBytes:d.uniformBytes,consts:f.values,perBatch:!1,bindings:[...d.inputs.map(e=>({binding:e.binding,ref:{kind:`slot`,index:m(e.name)}})),{binding:d.bindings.output,ref:{kind:`col`,index:h}}]}),{param:{kind:`column`,type:d.outType,tupleSize:d.outTupleSize},ref:{kind:`col`,index:h}}},y=(e,t,n,r,i=!1)=>{if(e.constSlots*4!==r.length)throw Error(`resident run: apply kernel "${e.key}" declares ${e.constSlots} constant slots but the planner allocated ${r.length/4}`);return{key:e.key,wgsl:e.wgsl,entryPoint:e.entryPoint,workgroupSize:e.workgroupSize,seed:t,uniformsBinding:0,uniformBytes:e.uniformBytes,consts:r,perBatch:i,bindings:e.bindings.map(e=>{let t=n[e.role];if(t===void 0)throw new Q(`unmapped role ${e.role}`);return{binding:e.binding,ref:t}})}};try{for(let t of e){let n=t===e[e.length-1],r=[],o=[],s=t.params;switch(t.kind){case`setAttribute`:{let e=s.name,n=s.type,i=s.tupleSize;if(typeof e!=`string`)throw new Q(`name`);if(n!==`f32`&&n!==`i32`&&n!==`u32`&&n!==`bool`)throw new Q(`type`);if(typeof i!=`number`||!Number.isInteger(i)||i<1||i>4)throw new Q(`tupleSize`);let c=typeof s.seed==`number`?s.seed:NaN,d=c===0?t.seed:A(t.seed,c),{param:f,ref:p}=v(s.value,d,r,i===1?[1]:[1,i],o,t.kind),m=h(e,i,`none`);a.set(e,{type:n,tupleSize:i}),l.set(e,m),u.push({op:`replace`,name:e,type:n,tupleSize:i});let g={target:{kind:`slot`,index:m}};p!==null&&(g.value=p),r.push(y(Se(f,n,i),0,g,o));break}case`transformPoints`:{g(`P`,`f32`,3);let e=v(s.translate,t.seed,r,[1,3],o,t.kind),n=v(s.rotateEuler,t.seed,r,[1,3],o,t.kind),i=v(s.scale,t.seed,r,[1,3],o,t.kind),c=a.get(`rot`),u=c!==void 0&&c.type===`f32`&&c.tupleSize===4,d=a.get(`scale`),f=d!==void 0&&d.type===`f32`&&d.tupleSize===3,p=m(`P`);l.set(`P`,p);let h={P:{kind:`slot`,index:p}};if(e.ref!==null&&(h.translate=e.ref),n.ref!==null&&(h.rotateEuler=n.ref),i.ref!==null&&(h.scale=i.ref),u){let e=m(`rot`);l.set(`rot`,e),h.rot={kind:`slot`,index:e}}if(f){let e=m(`scale`);l.set(`scale`,e),h.scaleAttr={kind:`slot`,index:e}}r.push(y(we(e.param,n.param,i.param,u,f),0,h,o));break}case`jitterPoints`:{if(g(`P`,`f32`,3),l.has(`P`))throw new Q(`identity after P write`);let e=typeof s.seed==`number`?s.seed:NaN,n=A(t.seed,e),i=v(s.amount,n,r,[1,3],o,t.kind),c=a.get(`seed`),u=c!==void 0;if(u&&(c.type!==`u32`||c.tupleSize!==1))throw new Q(`seed attribute shape`);let d=m(`P`);l.set(`P`,d);let f={P:{kind:`slot`,index:d}};i.ref!==null&&(f.amount=i.ref),u&&(f.seed={kind:`slot`,index:m(`seed`)}),r.push(y(Te(i.param,u),n,f,o));break}case`orientAlongVector`:{let e=s.axis;if(!Dt.includes(e))throw new Q(`axis`);if(!kt(s.up))throw new Q(`up`);let n=v(s.direction,t.seed,r,[1,3],o,t.kind),i=s.up,c=i[0]*i[0]+i[1]*i[1]+i[2]*i[2],d=c>0?1/Math.sqrt(c):0,f=[i[0]*d,i[1]*d,i[2]*d];for(let e of f)if(!Number.isFinite(Math.fround(e)))throw new Q(`up range`);let p=_(f,o,t.kind),g=a.get(`rot`),b=g!==void 0&&g.type===`f32`&&g.tupleSize===4?m(`rot`):h(`rot`,4,`quat-default`);a.set(`rot`,{type:`f32`,tupleSize:4}),l.set(`rot`,b),u.push({op:`ensure-rot`});let x={rot:{kind:`slot`,index:b}};n.ref!==null&&(x.direction=n.ref),r.push(y(De(n.param,e,p),0,x,o));break}case`spawnInstances`:{if(!n)throw new Q(`spawnInstances must be the run's last member`);let e=s.assetId;if(typeof e!=`string`||e===``)throw new Q(`assetId`);if(g(`P`,`f32`,3),i>1048576)throw new Q(`${i} instances over MAX_INSTANCES`);let t=s.assetAttr;if(t!==void 0&&typeof t!=`string`)throw new Q(`assetAttr`);let c=t===void 0?``:t;if(c!==``){let e=a.get(c);if(e===void 0)throw new Q(`assetAttr "${c}" not on the point domain`);if(e.type!==`string`)throw new Q(`assetAttr "${c}" is ${e.type}, not string`)}let l=s.colorAttr;if(l!==void 0&&typeof l!=`string`)throw new Q(`colorAttr`);let u=l===void 0?``:l,d=0;if(u!==``){let e=a.get(u);if(e===void 0)throw new Q(`colorAttr "${u}" not on the point domain`);if(e.type!==`f32`||e.tupleSize<3)throw new Q(`colorAttr "${u}" is ${e.type}x${e.tupleSize}`);d=e.tupleSize}let p=a.get(`rot`),h=p!==void 0&&p.type===`f32`&&p.tupleSize===4,_=a.get(`scale`),v=_!==void 0&&_.type===`f32`&&_.tupleSize===3,b={P:{kind:`slot`,index:m(`P`)},transforms:{kind:`out`}};h&&(b.rot={kind:`slot`,index:m(`rot`)}),v&&(b.scaleAttr={kind:`slot`,index:m(`scale`)});let x=c!==``;x&&(b.perm={kind:`perm`}),d>0&&(b.color={kind:`slot`,index:m(u)},b.colors={kind:`colorOut`}),r.push(y(Oe(h,v,x,d),0,b,o,x)),f={assetId:e,assetAttr:c,colorAttr:u,colorTupleSize:d,count:i,bytes:i*64,colorBytes:d>0?i*Ct:0,permBytes:x?i*4:0};break}default:throw new Q(`unknown kind ${t.kind}`)}d.push({id:t.id,type:t.type,steps:r})}}catch(e){if(e instanceof Q)return Et;throw e}let{writtenList:b,materialize:S,totalBytes:C}=At(l,o,c,f,t.needsGeometry);return C>n?{reason:`run-too-large`}:{plan:{format:wt,count:i,members:d,slots:o,cols:c,written:b,layoutOps:u,materialize:S,instances:f,totalBytes:C}}}var Mt={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function Nt(){return new Promise(e=>setTimeout(e,0))}async function Pt(e,t,n,r){let{device:i,pool:a}=e,{geo:o,signal:c,budgetMs:l}=n,u=t.count;if(o.attrs.point.count!==u)throw Error(`resident run: plan was built for ${u} points but the input geometry has ${o.attrs.point.count}; plans are single-cook artifacts — re-plan for new inputs`);let d=()=>{if(c?.aborted)throw new ae},f=[],p=(e,t)=>{let n=a.acquire(e,t);return f.push(n),n},h=new Set,g=[];try{let n=o.attrs.point,c=t.slots.map(e=>{let t=p(e.bytes,Z.STORAGE|Z.COPY_DST|Z.COPY_SRC);if(e.init===`attr`){let r=n.require(e.name),a=e.bytes/4;if(r.data instanceof Uint8Array){let e=new Uint32Array(a);for(let t=0;t<a;t++)e[t]=r.data[t];i.queue.writeBuffer(t,0,e)}else i.queue.writeBuffer(t,0,r.data.subarray(0,a))}else if(e.init===`quat-default`){let n=new Float32Array(e.bytes/4);for(let e=3;e<n.length;e+=4)n[e]=1;i.queue.writeBuffer(t,0,n)}return t}),f=t.cols.map(e=>p(e,Z.STORAGE|Z.COPY_DST|Z.COPY_SRC)),_=t.instances===null?void 0:m(o,{defaultAssetId:t.instances.assetId,...t.instances.assetAttr===``?{}:{assetAttr:t.instances.assetAttr}}),v=t.instances!==null&&t.instances.permBytes>0?p(t.instances.permBytes,Z.STORAGE|Z.COPY_DST):void 0;v!==void 0&&_!==void 0&&i.queue.writeBuffer(v,0,_.perm);let y=Z.STORAGE|Z.COPY_DST|Z.COPY_SRC|Z.VERTEX,b=_===void 0?[]:Array.from(_.counts,e=>p(e*64,y)),x=_===void 0||t.instances===null||t.instances.colorBytes===0?[]:Array.from(_.counts,e=>p(e*Ct,y)),S=(e,t)=>{if(e.kind===`slot`)return c[e.index];if(e.kind===`col`)return f[e.index];if(e.kind===`colorOut`){let e=x[t];if(e===void 0)throw Error(`resident run: a kernel binds a retained instance-colour buffer but the plan declares no colour output (plan and kernels disagree)`);return e}if(e.kind===`perm`){if(v===void 0)throw Error(`resident run: a kernel binds the grouping permutation but the plan declares no per-point asset attribute (plan and kernels disagree)`);return v}let n=b[t];if(n===void 0)throw Error(`resident run: a kernel binds a retained instance-transform buffer but the plan declares no instances output (plan and kernels disagree)`);return n},C=i.createCommandEncoder(),w=C.beginComputePass(),T=performance.now();for(let n of t.members){d();for(let t of n.steps){let n=e.getPipeline(t.key,t.wgsl,t.entryPoint,r);w.setPipeline(n);let a=St(t.workgroupSize,e.maxElementsPerDispatch),o=t.perBatch&&_!==void 0?Array.from(_.counts,(e,t)=>({batch:t,elements:e,base:_.offsets[t]})):[{batch:0,elements:u,base:0}];for(let e of o){r!==void 0&&r.dispatches++;let o=new ArrayBuffer(t.uniformBytes),s=new Uint8Array(o),c=new Uint32Array(o,0,t.uniformBytes>=16?4:3);c[0]=e.elements,c[1]=t.seed>>>0,t.perBatch&&(c[3]=e.base),t.consts.length>0&&new Float32Array(o,16,t.consts.length).set(t.consts);let l=Math.ceil(e.elements/a);for(let r=0;r<l;r++){let o=p(t.uniformBytes,Z.UNIFORM|Z.COPY_DST);c[2]=r*a,i.queue.writeBuffer(o,0,s);let l=i.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:t.uniformsBinding,resource:{buffer:o}},...t.bindings.map(t=>({binding:t.binding,resource:{buffer:S(t.ref,e.batch)}}))]}),u=Math.min(a,e.elements-r*a);w.setBindGroup(0,l),w.dispatchWorkgroups(Math.ceil(u/t.workgroupSize))}}}l!==void 0&&performance.now()-T>l&&(await Nt(),d(),T=performance.now())}w.end();let E=[],D,O=t.materialize?t.written.reduce((e,n)=>e+t.slots[n.slot].bytes,0):0;if(O>0){D=p(O,Z.COPY_DST|Z.MAP_READ);let e=0;for(let n of t.written){let r=t.slots[n.slot].bytes;C.copyBufferToBuffer(c[n.slot],0,D,e,r),E.push(e),e+=r}}i.queue.submit([C.finish()]);let k;if(t.materialize){let e;if(D!==void 0){await D.mapAsync(mt.READ,0,O);try{e=D.getMappedRange(0,O).slice(0)}finally{D.unmap()}}d(),k=s(o);let n=k.attrs.point;for(let e of t.layoutOps)if(e.op===`replace`)n.replace(e.name,e.type,e.tupleSize);else{let e=n.get(`rot`);(!e||e.type!==`f32`||e.tupleSize!==4)&&(e&&n.remove(`rot`),n.add(`rot`,`f32`,4,[0,0,0,1]))}t.written.forEach((t,r)=>{let i=n.require(t.name),a=u*i.tupleSize;if(e===void 0)throw Error(`resident run: readback missing for a written attribute`);if(i.data instanceof Uint8Array){let t=new Uint32Array(e,E[r],a);for(let e=0;e<a;e++)i.data[e]=t[e]}else{let n=Mt[i.type];if(n===void 0)throw Error(`resident run: cannot materialize attribute "${t.name}" of type ${i.type}`);i.data.set(new n(e,E[r],a))}})}else d();let A;if(t.instances!==null){let e=t.instances.colorBytes>0;if(_===void 0||b.length!==_.order.length||x.length!==(e?_.order.length:0))throw Error(`resident run: the plan declares an instances output but the acquired transform buffers do not match the grouping (library bug: plan.instances, the grouping, and the acquired buffers must agree)`);let n=(e,t,n)=>{let r=a.detach(e);h.add(e);try{return bt(r,t,n)}catch(e){throw r.destroy(),e}},r=[];for(let t=0;t<_.order.length;t++){let i=_.order[t],a=_.counts[t],o=n(b[t],a*64,`${a} instances of "${i}"`);if(g.push(o),!e){r.push({residency:`device`,assetId:i,count:a,transforms:o});continue}let s=n(x[t],a*Ct,`${a} instance colours of "${i}"`);g.push(s),r.push({residency:`device`,assetId:i,count:a,transforms:o,colors:s})}A=r}r!==void 0&&(r.residentRuns++,r.fusedNodes+=t.members.length,r.readbacksSaved+=t.members.length-+!!t.materialize);let ee={};return k!==void 0&&(ee.geo=k),A!==void 0&&(ee.deviceBatches=A),ee}catch(e){for(let e of g)e.dispose();throw e instanceof ae?e:Error(`GpuFieldEvaluator: resident run failed (${t.members.length} fused nodes [${t.members.map(e=>`"${e.id}"`).join(`, `)}], ${u} points): ${e instanceof Error?e.message:String(e)}`,{cause:e})}finally{for(let e of f)h.has(e)||a.release(e)}}var Ft=`gpu2`,It=268435456,Lt=[`spawnInstances`],Rt={f32:Float32Array,i32:Int32Array,u32:Uint32Array},zt={f32:Float32Array,i32:Int32Array,u32:Uint32Array};function Bt(e){let t=e=>e!==void 0&&e!==``?e:`?`;return[Ft,t(e?.vendor),t(e?.architecture),t(e?.device),t(e?.description)].join(`|`)}function $(e,t){return e!==void 0&&(e.fallbacks[t]=(e.fallbacks[t]??0)+1),null}var Vt=class{cacheSalt;residentTerminals;acceptDerivedSpecs;device;kernels=new Map;pipelines=new Map;pool;maxElementsPerDispatch;maxResidentBytes;constructor(e,t={}){if(t.maxElementsPerDispatch!==void 0&&!Number.isFinite(t.maxElementsPerDispatch))throw Error(`GpuFieldEvaluator: maxElementsPerDispatch must be a finite number, got ${t.maxElementsPerDispatch}; leave it unset to use the device maximum`);this.device=e,this.cacheSalt=Bt(t.adapterInfo??e.adapterInfo),this.pool=new _t(e,t.maxPooledBytes??It),this.maxElementsPerDispatch=t.maxElementsPerDispatch,this.maxResidentBytes=t.maxResidentBytes??536870912,this.residentTerminals=t.deviceInstances===!0?Lt:[],this.acceptDerivedSpecs=ne(t)}get pipelineCacheSize(){return this.pipelines.size}get kernelCacheSize(){return this.kernels.size}get poolStats(){return this.pool.stats}dispose(){this.pool.dispose()}chunkElements(e){let t=xt*e.workgroupSize,n=Math.min(this.maxElementsPerDispatch??t,t);return Math.max(e.workgroupSize,Math.floor(n/e.workgroupSize)*e.workgroupSize)}resolveField(e,t,n){let r=O(e,this.acceptDerivedSpecs);if(r===void 0)return $(n,k(e));let i=t.geo.attrs[t.domain],a={},o=[];for(let e of i.names().sort()){let t=i.get(e);t!==void 0&&(a[e]={type:t.type,tupleSize:t.tupleSize},o.push(`${JSON.stringify(e)}:${t.type}x${t.tupleSize}`))}let s;try{s=ot(r,e.key)}catch{return $(n,`compile-error`)}let c=`${s.length}#${s}|${o.join(`,`)}`,l=this.kernels.get(c);if(l===void 0){try{l=pt(r,{attributes:a})}catch(e){l=e instanceof Error?e:Error(String(e))}this.kernels.set(c,l)}if(l instanceof Error)return $(n,`compile-error`);if(l.inputs.length+1>8)return $(n,`too-many-buffers`);let u=ct(r,l);if(`problem`in u)return $(n,`param-bindings`);let d=i.count;if(d===0)return Promise.resolve({data:new zt[l.outType](0),tupleSize:l.outTupleSize});let f=this.getPipeline(l.key,l.wgsl,l.entryPoint,n);return n!==void 0&&n.dispatches++,this.dispatch(e,t,l,f,d,u.values)}getPipeline(e,t,n,r){let i=this.pipelines.get(e);if(i!==void 0)return r!==void 0&&r.pipelineCacheHits++,i;let a=this.device.createShaderModule({code:t}),o=this.device.createComputePipeline({layout:`auto`,compute:{module:a,entryPoint:n}});return this.pipelines.set(e,o),r!==void 0&&r.pipelinesCompiled++,o}planRun(e,t,n){let r=jt(e,t,this.maxResidentBytes,this.acceptDerivedSpecs);return`plan`in r?r.plan:(n!==void 0&&(n.fallbacks[r.reason]=(n.fallbacks[r.reason]??0)+1),null)}executeRun(e,t,n){let r=Tt(e);return r===null?Promise.reject(Error(`GpuFieldEvaluator.executeRun: plan was not produced by this library's planRun; pass the object returned by planRun on the same resolver`)):Pt({device:this.device,pool:this.pool,maxElementsPerDispatch:this.maxElementsPerDispatch,getPipeline:(e,t,n,r)=>this.getPipeline(e,t,n,r)},r,t,n)}async dispatch(e,t,n,r,i,a){let o=this.device,s=[],c=(e,t)=>{let n=this.pool.acquire(e,t);return s.push(n),n};try{let e=this.chunkElements(n),s=Math.ceil(i/e),l=[],u=t.geo.attrs[t.domain];for(let e of n.inputs){let t=u.require(e.name),n=i*e.tupleSize,r;if(t.data instanceof Uint8Array){let e=new Uint32Array(n);for(let r=0;r<n;r++)e[r]=t.data[r];r=e}else r=t.data.subarray(0,n);let a=c(n*4,Z.STORAGE|Z.COPY_DST);o.queue.writeBuffer(a,0,r),l.push({binding:e.binding,resource:{buffer:a}})}let d=i*n.outTupleSize*4,f=c(d,Z.STORAGE|Z.COPY_SRC);l.push({binding:n.bindings.output,resource:{buffer:f}});let p=c(d,Z.COPY_DST|Z.MAP_READ),m=new ArrayBuffer(n.uniformBytes),h=new Uint8Array(m),g=new Uint32Array(m,0,3);g[0]=i,g[1]=t.seed>>>0,a.length>0&&new Float32Array(m,16,a.length).set(a);let _=[];for(let t=0;t<s;t++){let i=c(n.uniformBytes,Z.UNIFORM|Z.COPY_DST);g[2]=t*e,o.queue.writeBuffer(i,0,h),_.push(o.createBindGroup({layout:r.getBindGroupLayout(0),entries:[{binding:n.bindings.uniforms,resource:{buffer:i}},...l]}))}let v=o.createCommandEncoder(),y=v.beginComputePass();y.setPipeline(r);for(let t=0;t<s;t++){let r=Math.min(e,i-t*e);y.setBindGroup(0,_[t]),y.dispatchWorkgroups(Math.ceil(r/n.workgroupSize))}y.end(),v.copyBufferToBuffer(f,0,p,0,d),o.queue.submit([v.finish()]),await p.mapAsync(mt.READ,0,d);let b;try{b=p.getMappedRange(0,d).slice(0)}finally{p.unmap()}return{data:new Rt[n.outType](b),tupleSize:n.outTupleSize}}catch(n){throw Error(`GpuFieldEvaluator: dispatch failed for field ${e.key} (${i} elements on the ${t.domain} domain): ${n instanceof Error?n.message:String(n)}`,{cause:n})}finally{for(let e of s)this.pool.release(e)}}};function Ht(e){return Array.isArray(e)?e.map(e=>e.clone()):e.clone()}function Ut(e){return Array.isArray(e)?e:[e]}function Wt(e,t){let n=[];try{for(let r of e){let e=t[r.assetId];if(!e){let e=Object.keys(t).sort().join(`, `);throw Error(`toInstancedMeshes: unknown assetId "${r.assetId}"; known assets: `+(e===``?`(none)`:e))}if(r.transforms.length!==r.count*16)throw Error(`toInstancedMeshes: batch "${r.assetId}" has ${r.transforms.length} transform floats, expected count * 16 = ${r.count*16}`);if(r.colors&&r.colors.length!==r.count*3)throw Error(`toInstancedMeshes: batch "${r.assetId}" has ${r.colors.length} colour floats, expected count * 3 = ${r.count*3} (rgb per instance; alpha is dropped at the spawner)`);let i=new y(e.geometry,Ht(e.material),r.count);i.instanceMatrix.array.set(r.transforms),i.instanceMatrix.needsUpdate=!0,r.colors&&(i.instanceColor=new f(r.colors.slice(),3),i.instanceColor.needsUpdate=!0),i.name=r.assetId,i.computeBoundingSphere(),n.push(i)}}catch(e){for(let e of n){e.dispose();for(let t of Ut(e.material))t.dispose()}throw e}return n}function Gt(e,t={}){let n=e.attrs.point,r=n.get(`P`);if(!r||r.type!==`f32`||r.tupleSize!==3)throw Error(`toPointsObject: geometry needs a point attribute "P" (f32, tupleSize 3)`);let i=n.count,s=new re;s.setAttribute(`position`,new T(r.data.slice(0,i*3),3));let l=!1,u=t.useColor===!1?void 0:c(n.get(`color`));if(u){let e=new Float32Array(i*3);for(let t=0;t<i;t++)a(e,t*3,u,t);s.setAttribute(`color`,new T(e,3)),l=!0}let d=new o({size:t.size??.1,sizeAttenuation:!0,vertexColors:l});return new h(s,d)}export{Vt as a,Wt as i,Ht as n,Ut as r,Gt as t};