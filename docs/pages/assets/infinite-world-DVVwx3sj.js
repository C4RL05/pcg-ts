import{$i as e,Ct as t,Ei as n,G as r,Hi as i,Hr as a,Ht as o,Ii as ee,K as te,Ki as ne,Mt as s,N as c,Ui as l,Vr as u,Y as d,Zi as re,ci as ie,di as ae,fi as oe,ia as se,na as ce,ni as le,pi as f,r as ue,ri as de,ta as fe,wa as p,ya as m}from"./mobile-C1CS7oXL.js";import{t as h}from"./scene-B2KqzPf9.js";import{a as g}from"./debug-BmYCyifD.js";import{t as pe}from"./worldBinding-EEDjJX-g.js";import{t as me}from"./overlay-JHRPXKOM.js";var he=.35,ge=777;function _e(){let t=new i,n=t.add(le,{count:170,boundsMin:[-800,0,-800],boundsMax:[800,0,800]}),r=t.add(f,{name:`scale`,tupleSize:3,value:(()=>{let t=e(se(`mega`),0,1,5,13);return fe(t,re(t,1.6),t)})()}),o=t.add(a,{assetId:`megarock`});return t.connect(n,`out`,r,`in`),t.connect(r,`out`,o,`in`),t.output(o,`instances`,`instances`),{name:`landmarks`,cellSize:`unbounded`,generationRadius:1/0,graph:t,bind(e,t){e.setParam(n,`seed`,t.seed),e.setParam(r,`seed`,m(t.seed,9))}}}function ve(t){let{cellSize:r,generationRadius:o,anchored:te}=t,s=t.halo?4:0,c=new i,l=te?c.add(de,{density:he,cellSize:7,latticeMode:`xz`,height:0}):c.add(le,{count:Math.round(he*(r+2*s)**2)}),u=c.add(f,{name:`density`,tupleSize:1,value:e(n(ee,{seed:ge,frequency:.02,octaves:3}),-1,1,0,1)}),d=c.add(oe,{mode:`probabilistic`}),ue=c.add(ie,{radius:4,countAttr:`nbrCount`}),p=c.add(ae,{mode:`inside`}),h=c.add(f,{name:`scale`,tupleSize:3,value:(()=>{let t=e(ne(ce(`nbrCount`),2,16),2,16,.4,1.35),n=re(t,e(se(`rock`),0,1,.85,1.15));return fe(n,n,n)})()}),g=c.add(a,{assetId:`rock`});return c.connect(l,`out`,u,`in`),c.connect(u,`out`,d,`in`),c.connect(d,`out`,ue,`in`),c.connect(ue,`out`,p,`in`),c.connect(p,`out`,h,`in`),c.connect(h,`out`,g,`in`),c.output(g,`instances`,`instances`),{name:`rocks`,cellSize:r,generationRadius:o,graph:c,bind(e,t){e.setParam(l,`boundsMin`,[t.min[0]-s,0,t.min[1]-s]),e.setParam(l,`boundsMax`,[t.max[0]+s,0,t.max[1]+s]);let n=te?t.worldSeed:t.seed;e.setParam(l,`seed`,n),e.setParam(d,`seed`,m(n,1)),e.setParam(h,`seed`,m(n,2)),e.setParam(p,`boundsMin`,[t.min[0],-1,t.min[1]]),e.setParam(p,`boundsMax`,[t.max[0],1,t.max[1]])}}}function ye(e){return e instanceof Error?e.message:String(e)}function be(e){let t=(e?.description??``)===``?e?.device:e?.description;return[e?.vendor,e?.architecture,t].filter(e=>typeof e==`string`&&e!==``).join(` · `)||`adapter (no info exposed)`}async function xe(e){let t=navigator.gpu;if(t===void 0)return{error:`navigator.gpu is missing — this browser has no WebGPU.`};try{let n=await t.requestAdapter();if(n===null)return{error:`navigator.gpu.requestAdapter() returned null — no compatible GPU adapter.`};let r=n.info,i=await n.requestDevice(),a=i.lost;return a!==void 0&&a.then(t=>{e(`${t?.reason??`unknown`}: ${t?.message??`no detail`}`)}),{device:i,info:r,label:be(r)}}catch(e){return{error:`requestDevice() failed: ${ye(e)}`}}}function Se(e){let t=e.info===void 0?{}:{adapterInfo:e.info};return{derived:new g(e.device,{...t,acceptDerivedSpecs:!0}),strict:new g(e.device,t)}}var Ce=class{cacheSalt;residentTerminals;acceptDerivedSpecs;base;seen=new Set;constructor(e){this.base=e,this.cacheSalt=e.cacheSalt,this.residentTerminals=e.residentTerminals,this.acceptDerivedSpecs=e.acceptDerivedSpecs}resolveField(e,t,n){return n!==void 0&&this.seen.add(n),this.base.resolveField(e,t,n)}planRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.planRun(e,t,n)}executeRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.executeRun(e,t,n)}drain(){if(this.seen.size===0)return;let e=l();for(let t of this.seen){e.dispatches+=t.dispatches,e.pipelinesCompiled+=t.pipelinesCompiled,e.pipelineCacheHits+=t.pipelineCacheHits,e.residentRuns+=t.residentRuns,e.fusedNodes+=t.fusedNodes,e.readbacksSaved+=t.readbacksSaved;for(let[n,r]of Object.entries(t.fallbacks))e.fallbacks[n]=(e.fallbacks[n]??0)+r}return this.seen.clear(),e}};function we(e){let t=Object.entries(e).sort(([e],[t])=>e.localeCompare(t));return t.length===0?`none`:t.map(([e,t])=>`${e} ×${t}`).join(`, `)}var _=1,v=18,y=140,b=`gpu`,x=!0,S=20,C=!0,w=!0,T=!0,Te=7,Ee=12,De=8,Oe=5e3;function ke(e){return e instanceof Error?e.message:String(e)}var{scene:E,camera:D,start:Ae}=h({cameraPosition:[0,26,0],orbit:!1,fog:{near:140,far:640},far:1600}),je=new t(new o(4e3,4e3),new s({color:1449515,roughness:1}));je.rotation.x=-Math.PI/2,je.position.y=-.03,E.add(je);var Me=40,O;function Ne(){O&&(E.remove(O),O.geometry.dispose(),O.material.dispose());let e=new r(S*Me,Me,4158656,2903936),t=e.material;t.transparent=!0,t.opacity=.45,t.depthWrite=!1,e.position.y=.02,e.visible=T,E.add(e),O=e}function Pe(){!O||!O.visible||(O.position.x=Math.round(D.position.x/S)*S,O.position.z=Math.round(D.position.z/S)*S)}var Fe=new s({color:8028816,roughness:.95,flatShading:!0}),Ie=new s({color:6121077,roughness:1,flatShading:!0}),Le={megarock:{geometry:new c(1).translate(0,.62,0),material:Ie},rock:{geometry:new d(.55).translate(0,.33,0),material:Fe}},k,Re,A=`requesting…`,j,M=!1,ze=``,N;function P(){return k!==void 0&&!M}function Be(){if(!(b===`cpu`||!P()))return x?k:Re}function Ve(e,t){let n=e*1.25/t+1.5;return Math.max(256,Math.ceil(Math.PI*n*n))}function He(e){let t=0;for(let n of Object.keys(e))for(let r of e[n])if(r.kind===`instances`)for(let e of r.batches)t+=e.count;return t}var F,Ue=0,I,We=0,L=!1,Ge=0;function R(){F&&(F.disposed=!0,F.abort.abort(),F.binding.dispose(),E.remove(F.group));let e=new te;E.add(e);let t=new pe({group:e,assets:Le}),n=new Map,r=Be(),i={world:void 0,group:e,binding:t,cellInstances:n,tap:r===void 0?void 0:new Ce(r),abort:new AbortController,disposed:!1};i.world=new u({seed:_,levels:[_e(),ve({cellSize:S,generationRadius:y,anchored:C,halo:w})],maxCellsPerLevel:Ve(y,S),...i.tap===void 0?{}:{gpu:i.tap},onCellReady:(e,r,a)=>{i.disposed||(t.cellReady(e,r,a),n.set(`${e}|${r[0]},${r[1]}`,He(a)))},onCellEvicted:(e,r)=>{i.disposed||(t.cellEvicted(e,r),n.delete(`${e}|${r[0]},${r[1]}`))}}),F=i,Ue=0,N=void 0,I=void 0,dt(),Ke(i,Ee)}function Ke(e,t){let n=++Ge;$=!0,We=performance.now(),e.world.update([D.position.x,0,D.position.z],{budgetMs:t,maxCooksPerUpdate:De,signal:e.abort.signal,...e.tap===void 0?{}:{gpu:e.tap}}).then(t=>{if(e.disposed)return;Ue=t.pending,I=t.elapsedMs;let n=e.tap?.drain();n!==void 0&&(N=n),dt(),L&&(L=!1,Z(ut()))}).catch(t=>{t instanceof p||(console.error(t),e.disposed||Z(`update failed: ${ke(t)}`))}).finally(()=>{n===Ge&&($=!1)})}var z=0,qe=0,B=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(t===`g`){J(b===`gpu`?`cpu`:`gpu`);return}B.add(t)}),window.addEventListener(`keyup`,e=>B.delete(e.key.toLowerCase())),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&(We=performance.now())});var V=me({title:`infinite world`,info:`Unbounded landmark level + world-anchored rock cells streamed around a flying camera. Steer with A/D or arrow keys.`}),Je=document.createElement(`style`);Je.textContent=`
