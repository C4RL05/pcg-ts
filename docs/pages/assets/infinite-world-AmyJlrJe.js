import{$i as e,Ca as t,Ct as n,Ei as r,G as i,Hi as a,Hr as ee,Ht as te,Ii as ne,K as o,Ki as re,Mt as s,N as c,Ui as l,Vr as u,Y as d,Zi as ie,ci as ae,di as oe,fi as se,ia as ce,na as le,ni as ue,pi as f,r as p,ri as de,ta as fe,va as pe}from"./mobile-BR5gfqEP.js";import{t as m}from"./scene-B8pyYmwf.js";import{a as h}from"./debug-Cq0r9lhL.js";import{t as me}from"./worldBinding-B-lrqdUM.js";import{t as he}from"./overlay-xxv-vXu2.js";var ge=.35,_e=777;function ve(){let t=new a,n=t.add(ue,{count:170,boundsMin:[-800,0,-800],boundsMax:[800,0,800]}),r=t.add(f,{name:`scale`,tupleSize:3,value:(()=>{let t=e(ce(`mega`),0,1,5,13);return fe(t,ie(t,1.6),t)})()}),i=t.add(ee,{assetId:`megarock`});return t.connect(n,`out`,r,`in`),t.connect(r,`out`,i,`in`),t.output(i,`instances`,`instances`),{name:`landmarks`,cellSize:`unbounded`,generationRadius:1/0,graph:t,bind(e,t){e.setParam(n,`seed`,t.seed),e.setParam(r,`seed`,pe(t.seed,9))}}}function ye(t){let{cellSize:n,generationRadius:i,anchored:te}=t,o=t.halo?4:0,s=new a,c=te?s.add(de,{density:ge,cellSize:7,latticeMode:`xz`,height:0}):s.add(ue,{count:Math.round(ge*(n+2*o)**2)}),l=s.add(f,{name:`density`,tupleSize:1,value:e(r(ne,{seed:_e,frequency:.02,octaves:3}),-1,1,0,1)}),u=s.add(se,{mode:`probabilistic`}),d=s.add(ae,{radius:4,countAttr:`nbrCount`}),p=s.add(oe,{mode:`inside`}),m=s.add(f,{name:`scale`,tupleSize:3,value:(()=>{let t=e(re(le(`nbrCount`),2,16),2,16,.4,1.35),n=ie(t,e(ce(`rock`),0,1,.85,1.15));return fe(n,n,n)})()}),h=s.add(ee,{assetId:`rock`});return s.connect(c,`out`,l,`in`),s.connect(l,`out`,u,`in`),s.connect(u,`out`,d,`in`),s.connect(d,`out`,p,`in`),s.connect(p,`out`,m,`in`),s.connect(m,`out`,h,`in`),s.output(h,`instances`,`instances`),{name:`rocks`,cellSize:n,generationRadius:i,graph:s,bind(e,t){e.setParam(c,`boundsMin`,[t.min[0]-o,0,t.min[1]-o]),e.setParam(c,`boundsMax`,[t.max[0]+o,0,t.max[1]+o]);let n=te?t.worldSeed:t.seed;e.setParam(c,`seed`,n),e.setParam(u,`seed`,pe(n,1)),e.setParam(m,`seed`,pe(n,2)),e.setParam(p,`boundsMin`,[t.min[0],-1,t.min[1]]),e.setParam(p,`boundsMax`,[t.max[0],1,t.max[1]])}}}function be(e){return e instanceof Error?e.message:String(e)}function xe(e){let t=(e?.description??``)===``?e?.device:e?.description;return[e?.vendor,e?.architecture,t].filter(e=>typeof e==`string`&&e!==``).join(` · `)||`adapter (no info exposed)`}async function Se(e){let t=navigator.gpu;if(t===void 0)return{error:`navigator.gpu is missing — this browser has no WebGPU.`};try{let n=await t.requestAdapter();if(n===null)return{error:`navigator.gpu.requestAdapter() returned null — no compatible GPU adapter.`};let r=n.info,i=await n.requestDevice(),a=i.lost;return a!==void 0&&a.then(t=>{e(`${t?.reason??`unknown`}: ${t?.message??`no detail`}`)}),{device:i,info:r,label:xe(r)}}catch(e){return{error:`requestDevice() failed: ${be(e)}`}}}function Ce(e){let t=e.info===void 0?{}:{adapterInfo:e.info};return{derived:new h(e.device,{...t,acceptDerivedSpecs:!0}),strict:new h(e.device,t)}}var we=class{cacheSalt;residentTerminals;acceptDerivedSpecs;base;seen=new Set;constructor(e){this.base=e,this.cacheSalt=e.cacheSalt,this.residentTerminals=e.residentTerminals,this.acceptDerivedSpecs=e.acceptDerivedSpecs}resolveField(e,t,n){return n!==void 0&&this.seen.add(n),this.base.resolveField(e,t,n)}planRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.planRun(e,t,n)}executeRun(e,t,n){return n!==void 0&&this.seen.add(n),this.base.executeRun(e,t,n)}drain(){if(this.seen.size===0)return;let e=l();for(let t of this.seen){e.dispatches+=t.dispatches,e.pipelinesCompiled+=t.pipelinesCompiled,e.pipelineCacheHits+=t.pipelineCacheHits,e.residentRuns+=t.residentRuns,e.fusedNodes+=t.fusedNodes,e.readbacksSaved+=t.readbacksSaved;for(let[n,r]of Object.entries(t.fallbacks))e.fallbacks[n]=(e.fallbacks[n]??0)+r}return this.seen.clear(),e}};function Te(e){let t=Object.entries(e).sort(([e],[t])=>e.localeCompare(t));return t.length===0?`none`:t.map(([e,t])=>`${e} ×${t}`).join(`, `)}var g=1,_=18,v=140,y=`gpu`,b=!0,x=20,S=!0,C=!0,w=!0,Ee=7,De=12,Oe=8,ke=5e3;function Ae(e){return e instanceof Error?e.message:String(e)}var{scene:T,camera:E,start:je}=m({cameraPosition:[0,26,0],orbit:!1,fog:{near:140,far:640},far:1600}),Me=new n(new te(4e3,4e3),new s({color:1449515,roughness:1}));Me.rotation.x=-Math.PI/2,Me.position.y=-.03,T.add(Me);var Ne=40,D;function Pe(){D&&(T.remove(D),D.geometry.dispose(),D.material.dispose());let e=new i(x*Ne,Ne,4158656,2903936),t=e.material;t.transparent=!0,t.opacity=.45,t.depthWrite=!1,e.position.y=.02,e.visible=w,T.add(e),D=e}function Fe(){!D||!D.visible||(D.position.x=Math.round(E.position.x/x)*x,D.position.z=Math.round(E.position.z/x)*x)}var Ie=new s({color:8028816,roughness:.95,flatShading:!0}),Le=new s({color:6121077,roughness:1,flatShading:!0}),Re={megarock:{geometry:new c(1).translate(0,.62,0),material:Le},rock:{geometry:new d(.55).translate(0,.33,0),material:Ie}},O,ze,k=`requesting…`,A,j=!1,Be=``,M;function N(){return O!==void 0&&!j}function Ve(){if(!(y===`cpu`||!N()))return b?O:ze}function He(e,t){let n=e*1.25/t+1.5;return Math.max(256,Math.ceil(Math.PI*n*n))}function Ue(e){let t=0;for(let n of Object.keys(e))for(let r of e[n])if(r.kind===`instances`)for(let e of r.batches)t+=e.count;return t}var P,F=0,I,We=0,L=!1,Ge=0;function R(){P&&(P.disposed=!0,P.abort.abort(),P.binding.dispose(),T.remove(P.group));let e=new o;T.add(e);let t=new me({group:e,assets:Re}),n=new Map,r=Ve(),i={world:void 0,group:e,binding:t,cellInstances:n,tap:r===void 0?void 0:new we(r),abort:new AbortController,disposed:!1};i.world=new u({seed:g,levels:[ve(),ye({cellSize:x,generationRadius:v,anchored:S,halo:C})],maxCellsPerLevel:He(v,x),...i.tap===void 0?{}:{gpu:i.tap},onCellReady:(e,r,a)=>{i.disposed||(t.cellReady(e,r,a),n.set(`${e}|${r[0]},${r[1]}`,Ue(a)))},onCellEvicted:(e,r)=>{i.disposed||(t.cellEvicted(e,r),n.delete(`${e}|${r[0]},${r[1]}`))}}),P=i,F=0,M=void 0,I=void 0,dt(),Ke(i,De)}function Ke(e,n){let r=++Ge;$=!0,We=performance.now(),e.world.update([E.position.x,0,E.position.z],{budgetMs:n,maxCooksPerUpdate:Oe,signal:e.abort.signal,...e.tap===void 0?{}:{gpu:e.tap}}).then(t=>{if(e.disposed)return;F=t.pending,I=t.elapsedMs;let n=e.tap?.drain();n!==void 0&&(M=n),dt(),L&&(L=!1,Z(ut()))}).catch(n=>{n instanceof t||(console.error(n),e.disposed||Z(`update failed: ${Ae(n)}`))}).finally(()=>{r===Ge&&($=!1)})}var z=0,qe=0,B=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(t===`g`){J(y===`gpu`?`cpu`:`gpu`);return}B.add(t)}),window.addEventListener(`keyup`,e=>B.delete(e.key.toLowerCase())),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&(We=performance.now())});var V=he({title:`infinite world`,info:`Unbounded landmark level + world-anchored rock cells streamed around a flying camera. Steer with A/D or arrow keys.`}),Je=document.createElement(`style`);Je.textContent=`
