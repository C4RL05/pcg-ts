 ...
 * a scattered cloud by exactly ONE ulp and re-evaluating the gpu-fields
 ...
 * the gpu-fields chain plans as a two-member run on its own — and a
 ...
 * the gpu-fields chain (setAttribute → jitterPoints → transformPoints
 ...
 * run. The gpu-fields chain narrows three times and fuses [tint,
 ...
 *     measured on this adapter the gpu-fields `wobble` field
