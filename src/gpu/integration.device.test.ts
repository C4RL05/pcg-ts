 ...
 * World, and captureAsync: bundles device.testsupport.ts with esbuild (a
...
function runScenario(): ScenarioOutput {
  ...
  try {
    buildSync({
      entryPoints: [join(here, "device.testsupport.ts")],
      bundle: true,
      platform: "node",
      format: "esm",
      target: "node18",
...
describe.skipIf(testDevice === null)(deviceSuiteName("evaluator + cook integration"), () => {
  ...
  it("evaluator resolves a spec'd field bit-exactly and caches the pipeline", () => {
    ...
    expect(b.stats1).toEqual({ dispatches: 1, pipelinesCompiled: 1, pipelineCacheHits: 0, residentRuns: 0, fusedNodes: 0, readbacksSaved: 0, fallbacks: {}, nonFinite: { counts: {}, unchecked: {} } });
    expect(b.stats2).toEqual({ dispatches: 1, pipelinesCompiled: 0, pipelineCacheHits: 1, residentRuns: 0, fusedNodes: 0, readbacksSaved: 0, fallbacks: {}, nonFinite: { counts: {}, unchecked: {} } });
