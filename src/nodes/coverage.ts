 ...
 * 32.3% figure was simply wrong: it came from a single object near a
 * hairpin claiming 78 half-widths of lap for 6 half-widths of geometry,
 * because A BOUNDS PROJECTION ONTO A FOLDED CENTRELINE CANNOT TELL
 * "ABOVE THE PATH HERE" FROM "NEAR THE PATH TWICE". Two stations tens
