...
<style>
  ...
  :root {
    color-scheme: dark;
    /* The thumb, which color-scheme leaves as the platform's mid-grey:
       a bright bar down a page whose ground is #000. The standard pair,
       inherited, so the whole page is covered here. */
