...
const ROOT_SURFACE = [
  ...
  "createTriangleMesh", "dataInput", "defineNode", "describeGraphParams", "describeSubgraphParams",
  ...
  "spawnInstances", "splineSample", "standardNode", "strandedGraphParamValues", "sub",
  "subgraphContentHash",
